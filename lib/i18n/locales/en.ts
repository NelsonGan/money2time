const en = {
  ...
  transactions: {
    ...
    reimbursements: {
      ...
      recovered_label: 'Paid back',
      empty_title: 'Nothing to claim',
      empty_subtitle: 'Mark an expense as claimable and it waits here until you get paid back.',
      empty_reimbursed_title: 'Nothing cleared yet',
      empty_reimbursed_subtitle:
        'Claims you mark as paid back land here, in case you need to undo one.',
      claims_one: '1 claim',
      claims_other: '{{count}} claims',
      unassigned_payer: 'Unassigned',
      claim_button: 'Claim',
      claim_sheet_title: 'Claim this expense',
      claim_sheet_subtitle: 'Track it until someone pays you back.',
      payer_label: 'Paid back by',
      payer_placeholder: 'Work, a client, an insurer',
      claim_amount_label: 'Claim amount',
      claim_all_label: 'Claim the full amount',
      claim_all_hint: 'Turn this off to claim only part of the expense.',
      save_claim: 'Save claim',
      remove_claim: 'Remove claim',
      remove_claim_title: 'Remove this claim?',
      ...
      open_days_other: 'Open {{count}} days',
    },
    settleUp: {
      title: 'Who owes you',
  ...
  pro: {
    ...
    limit_reimbursements:
      'You can have up to {{count}} open reimbursement claims on the free plan. Clear one or upgrade to Pro for unlimited.',
    limit_goals:
