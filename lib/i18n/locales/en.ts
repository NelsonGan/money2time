const en = {
  ...
  reimbursements: {
    ...
    count_as_expense_hint:
      'Off, reimbursable expenses and their refunds stay out of spending totals.',
    ...
    empty_message: 'Tick "To be reimbursed" on an expense to see it here.',
    ...
    editor_hint: 'Claim it back later.',
    editor_reimbursed_hint: 'Already paid back.',
