const en = {
  ...
  widgets: {
    ...
    live: {
      ...
      headline: "You've earned this much today",
      badge_on: 'On',
      rate: '{{amount}}/hr',
      ends_at: 'Ends {{time}}',
      ...
      start_sheet_title: 'Start the clock',
      start_confirm: 'Start',
      stop: 'Stop the clock',
  ...
  transactions: {
    ...
    settleUp: {
      ...
      history_empty_title: 'No paybacks yet',
      history_empty_subtitle: 'Bills that friends and family pay back will appear here.',
      bills_one: '1 bill',
    ...
    editor: {
      ...
      receipt: {
        ...
        save_success: 'Receipt saved to photos.',
        save_failed: "Couldn't save this receipt. Check photo access and try again.",
        crop: 'Crop',
  ...
  insights: {
    ...
    review: 'Review Spending',
    review_description:
      'Look back on a completed week, month or year: what went out, what you kept, and how it felt.',
  ...
  category_icon: {
    ...
    upload_pro_hint: 'Upload your own image with Pro.',
    group_money: 'Money',
    ...
    group_health: 'Health',
    group_leisure: 'Leisure',
    group_work: 'Work',
    group_family: 'Family',
    group_other: 'Other',
    group_smileys: 'Smileys',
    group_people: 'People',
    group_animals: 'Animals and nature',
  ...
  accounts: {
    ...
    loan: {
      ...
      paid_periods_error: 'Must be fewer than the loan period.',
      start_date_label: 'Start date',
      start_date_info:
        'When the loan was taken out. The first instalment falls one month later, and its day of month becomes your payment day.',
      collect_account_label: 'Collect from',
      ...
      collect_account_external: 'This repayment is set up in Recurring. Edit it there.',
      ...
      first_instalment_label: 'First instalment',
      instalments_left_label: 'Instalments left',
      projection_with_date_one: 'Paid off around {{date}}, {{count}} payment left',
      projection_with_date_other: 'Paid off around {{date}}, {{count}} payments left',
      ...
      next_due_chip: 'Next due {{date}}',
      overdue_chip: 'Overdue since {{date}}',
      make_payment: 'Make a payment',
      payment_note: 'Loan repayment',
      due_amount: 'Amount due',
      archive_action: 'Archive loan',
      unarchive_action: 'Unarchive loan',
      archive_hint:
        'Hides it from your accounts list. History and totals are kept, and "Show archived" brings it back.',
      celebration_title: 'Loan paid off',
      celebration_message: '{{name}} is fully repaid. That debt is behind you.',
      celebration_message_with_amount: '{{name}} is fully repaid, all {{amount}} of it.',
      celebration_archive_cta: 'Archive it',
      celebration_keep_cta: 'Keep it visible',
    },
    ...
    show_archived_action: 'Show archived ({{count}})',
    hide_archived_action: 'Hide archived',
  ...
  pro: {
    ...
    limit_loans: 'You can track {{count}} loan on the free plan. Upgrade to Pro for unlimited.',
    badge: 'PRO',
  ...
  notifications: {
    ...
    weekly_review: {
      title: 'Weekly Review',
      label: 'Weekly review',
      description: 'A recap of the week that just closed, on the day it closes.',
    },
    monthly_review: {
      title: 'Monthly Review',
      label: 'Monthly review',
      description: 'A recap of the month that just closed, on the day it closes.',
    },
    review: {
      fires_on: 'Arrives',
      fires_on_hint: 'Set by your week and month start in Display settings.',
      every_week_on: 'Every {{day}}',
  ...
  auto_backup: {
    ...
    error: {
      ...
      timeout: 'The connection timed out. Try again on a faster network.',
      auth: 'Sign in to Google Drive again to continue backing up.',
      quota: 'Your Google Drive is full. Free up space and try again.',
      rate_limited: 'Google Drive is busy right now. Try again in a moment.',
      server: 'Google Drive is temporarily unavailable. Try again later.',
      client: 'Google Drive rejected the backup.',
  ...
  review: {
    ...
    trend: 'Trend',
    pace: 'Pace',
    pace_of_budget: '{{spent}} of {{target}}',
    pace_usual: 'Your usual is {{amount}}',
    pace_left: '{{amount}} left',
    pace_over: '{{amount}} over',
    goals: 'Goals',
    goal_of_target: '{{saved}} of {{target}}',
    categories: 'Categories',
    uncategorized: 'Uncategorized',
    other_entries: '{{count}} more',
    mood: 'How it felt',
    mood_happy: 'Felt good',
    mood_neutral: 'Neither way',
    mood_regret: "Wish you hadn't",
    standouts: 'Standouts',
  ...
  reimbursements: {
    ...
    subtitle: 'Expenses someone else pays back.',
    count_as_expense_label: 'Count as expense',
    count_as_expense_hint:
      'Off, reimbursable expenses and their refunds stay out of expense totals.',
    ...
    editor_label: 'Pending reimbursement',
    editor_tooltip:
      'An expense someone will pay you back for. Claim it on the Reimbursements page.',
    editor_reimbursed_label: 'Already paid back',
