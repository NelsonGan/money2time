const en = {
  ...
  settings: {
    ...
    center_add_button_ai_chat: 'Center add button opens AI Chat',
    center_add_button_ai_chat_subtitle:
      'Use the middle navigation button to open AI Chat instead of Add Transaction.',
  ...
  aiChat: {
    title: 'AI Chat',
    open_settings: 'Open AI chat settings',
    settings_title: 'AI Chat Settings',
    enable_chip_private: 'Private',
    enable_chip_local: 'On-device',
    enable_title: 'Private AI',
    enable_description_intro: 'Runs on your device for privacy.',
    enable_description_download_prefix: 'Download the AI Model',
    enable_description_once: 'once',
    enable_description_download_suffix: 'to start.',
    enable_stay_on_screen: 'Keep this screen open until it finishes.',
    download_local_ai: 'Download AI Model',
    ...
    default_account_helper: 'If the user does not specify an account, AI chat will use this one.',
    ...
    model_section_subtitle: 'Download or switch the on-device model used for parsing.',
