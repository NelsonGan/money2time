const en = {
  ...
  accounts: {
    ...
    loan: {
      principal_label: 'Amount borrowed',
      principal_hint: 'The original loan amount. Used to show how much you have paid off.',
      balance_owed_label: 'Balance owed',
      balance_owed_hint: 'What you still owe today. Repayments bring this down.',
      monthly_payment_label: 'Monthly repayment',
      payment_day_label: 'Payment day',
      interest_rate_label: 'Interest rate (% per year)',
      interest_rate_hint:
        'Optional, used to estimate your payoff date. Interest charges are not added automatically.',
      payment_below_interest_warning:
        'This repayment is smaller than the monthly interest, so the balance will grow instead of shrinking.',
      ...
      projection_remaining: '{{amount}} remaining',
      projection_interest: 'Around {{amount}} interest still to pay',
      ...
      archive_hint:
        'Hides it from your accounts. History and totals are kept, and you can bring it back from Accounts settings.',
