const en = {
  ...
  add_action: {
    ...
    manual_subtitle: 'Type it in yourself',
  },
  receiptScan: {
    reading: 'Reading receipt…',
    source_title: 'Scan receipt',
    source_camera: 'Take photo',
    source_library: 'Choose from library',
    review_title: 'Review {{count}} transactions',
    save_all: 'Save all ({{count}})',
    remove: 'Remove',
    all_removed: 'No transactions left to save.',
    note_placeholder: 'Note',
    empty_title: 'No transactions found',
    empty_body: "We couldn't read any transactions from that receipt. Try another photo.",
    busy_title: 'Scanner busy',
    busy_body: 'The scanner is busy right now. Please try again in a moment.',
  ...
  pro: {
    limit_receipt_scans:
      'Free plan includes {{count}} receipt scans per month. Upgrade to Pro for unlimited scanning.',
