const en = {
  ...
  items: {
    ...
    mark_inactive_hint: 'Stop counting days — for items you no longer use, sold, or that broke.',
    ...
    owned_for: 'Owned {{count}} days',
    daily_cost: 'Cost per day',
    final_daily_cost: 'Final cost per day',
    per_day: '/ day',
    work_per_day: '{{time}} of work / day',
    ...
    summary_work_per_day: 'Work / day',
    summary_counts: 'Items',
    counts_value: '{{active}} active · {{inactive}} inactive',
    icon: {
