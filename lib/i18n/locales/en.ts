const en = {
  ...
  onboarding: {
    ...
    flow: {
      ...
      skip_setup_message:
        "We'll set you up with starter accounts and categories. You can customize them anytime in Settings.",
      stay: 'Stay',
      skip: 'Skip',
  ...
  settings: {
    ...
    auto_log: {
      ...
      usage_exhausted: 'Free auto-logs used up. Upgrade to Pro for unlimited.',
      setup_title: 'Setup',
      automation_row: 'Apple Pay auto-log',
      automation_row_hint: 'One automation per card',
      backtap_row: 'Back Tap',
      backtap_row_hint: 'Double-tap the back of your iPhone',
      backtap_action_label: 'Back Tap opens',
      step_counter: '%{current} of %{total}',
      tutorial_step_1: 'Open Shortcuts. Go to the Automation tab.',
      tutorial_step_2: 'Tap +, then choose Transaction.',
      tutorial_step_3: 'Pick your card. Choose Run Immediately and turn off Notify When Run.',
      tutorial_step_4: 'Add the "Log Transaction" action from Money2Time.',
      tutorial_step_5: 'Set Amount and Merchant to the Shortcut Input variables.',
      tutorial_step_6:
        "Pick this card's account. Leave Category as Ask Each Time to choose as you pay.",
      tutorial_step_7: 'Ignore the prompt and it still logs, using your default category.',
      backtap_step_1:
        'In Shortcuts, make a shortcut with one action: "Add Transaction" from Money2Time.',
      backtap_step_2: 'Open Settings > Accessibility > Touch > Back Tap.',
      backtap_step_3: 'Choose Double Tap or Triple Tap, then pick your shortcut.',
  ...
  tutorial: {
    ...
    prompt_message: 'A quick walkthrough of Add, Insights, and Settings.',
