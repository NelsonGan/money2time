const en = {
  ...
  onboarding: {
    ...
    wage: {
      skip_title: 'Set up your hourly value?',
      skip_message:
        'Seeing money as time needs your hourly wage. Without it, we can switch you to the normal expense tracker instead. You can change this anytime in Settings.',
      set_now: 'Set Up Now',
      use_normal_mode: 'Use normal tracker',
    ...
    backup: {
      ...
      subtitle:
        'money2time is a fully offline app: no account, no login, no servers. Everything you track lives only on this phone, so back up to {{provider}} to keep it safe.',
    ...
    features: {
      ...
      subtitle: 'A few things money2time can do that others cannot.',
