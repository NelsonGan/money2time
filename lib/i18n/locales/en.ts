const en = {
  ...
  review: {
    ...
    spent_label: {
      week: 'Spent that week',
      month: 'Spent that month',
      year: 'Spent that year',
    },
    previous_period: {
    ...
    delta_flat: 'Level',
    delta_note_up: 'heavier than {{previous}}',
    delta_note_down: 'lighter than {{previous}}',
    delta_note_flat: 'in line with {{previous}}',
    ...
    pace_budget_title: 'Against your budget',
    pace_title: {
      week: 'vs your usual week',
      month: 'vs your usual month',
      year: 'vs your usual year',
    },
    pace_of_budget: '{{spent}} of {{target}}',
    pace_average: {
      week: 'Average of your last {{count}} weeks: {{amount}}',
      month: 'Average of your last {{count}} months: {{amount}}',
      year: 'Average of your last {{count}} years: {{amount}}',
    },
    pace_left: '{{amount}} left',
    pace_over: '{{amount}} over',
    categories_title: {
      week: 'Biggest categories that week',
      month: 'Biggest categories that month',
      year: 'Biggest categories that year',
    },
    uncategorized: 'Uncategorized',
    other_entries: '{{count}} more',
    mood_title: {
      week: 'How the week felt',
      month: 'How the month felt',
      year: 'How the year felt',
    },
    mood_happy: 'Felt good',
    mood_neutral: 'Neither way',
    mood_regret: "Wish you hadn't",
    standouts_title: {
      week: 'Standouts that week',
      month: 'Standouts that month',
      year: 'Standouts that year',
    },
    biggest_expense: 'Biggest expense',
    busiest_day: 'Busiest day',
    entries_count: '{{count}} entries',
    quiet_days: 'Quiet days',
    quiet_days_sub: 'Nothing logged',
    of_total: '{{count}} of {{total}}',
    entries_logged: 'Entries logged',
    entries_logged_sub: {
      week: 'Across the week',
      month: 'Across the month',
