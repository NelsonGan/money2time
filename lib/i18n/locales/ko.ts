const ko = {
  ...
  transactions: {
    ...
    settleUp: {
      ...
      history_empty_title: '아직 상환 내역이 없습니다',
      history_empty_subtitle: '친구와 가족이 갚은 청구 내역이 여기에 표시됩니다.',
    ...
    editor: {
      ...
      receipt: {
        ...
        save_success: '영수증을 사진에 저장했습니다.',
        save_failed: '영수증을 저장하지 못했습니다. 사진 접근 권한을 확인하고 다시 시도하세요.',
        crop: 'Crop',
  ...
  insights: {
    ...
    review: '지출 리뷰',
    review_description:
      '끝난 주, 달, 해를 돌아보세요. 얼마가 나갔고 얼마가 남았으며 어떤 기분이었는지 확인할 수 있어요.',
  ...
  accounts: {
    ...
    loan: {
      interest_model_label: '이자',
      interest_model_reducing: '잔액 기준',
      interest_model_flat: '정액 금리',
      interest_model_info:
        '잔액 기준: 이자가 매달 남은 원금에 붙으므로 더 내거나 일찍 갚으면 이자가 줄어듭니다. 대부분의 주택담보대출이 이 방식입니다. 정액 금리: 이자를 빌린 원금 전체에 한 번 계산해 처음에 더하므로, 일찍 갚으면 빚은 빨리 없어지지만 이자는 줄지 않습니다. 대부분의 자동차 대출과 신용대출이 이 방식입니다.',
      ...
      paid_periods_error: '대출 기간보다 적어야 합니다.',
      start_date_label: '시작일',
      start_date_info: '대출을 받은 날입니다. 첫 상환은 한 달 뒤이며, 그 날짜가 상환일이 됩니다.',
      collect_account_label: '출금 계좌',
      ...
      payment_category_label: '상환 카테고리',
      ...
      payment_below_interest_short: '상환액이 이자를 못 갚습니다',
      payoff_by_label: '완납 시점',
      first_instalment_label: '첫 상환',
      instalments_left_label: '남은 횟수',
      projection_with_date_one: '{{date}} 무렵 완납, {{count}}회 남음',
      projection_with_date_other: '{{date}} 무렵 완납, {{count}}회 남음',
      ...
      next_due_chip: '다음 상환일 {{date}}',
      overdue_chip: '{{date}}부터 연체',
      make_payment: '상환하기',
      payment_note: '대출 상환',
      due_amount: '납부 금액',
      archive_action: '대출 보관',
      unarchive_action: '보관 해제',
      archive_hint:
        '계좌 목록에서 숨깁니다. 내역과 합계는 유지되며 "보관함 보기"로 다시 꺼낼 수 있습니다.',
      celebration_title: '대출 완납',
      celebration_message: '{{name}} 상환을 마쳤습니다. 그 빚은 이제 끝입니다.',
      celebration_message_with_amount: '{{name}} 상환을 마쳤습니다. {{amount}} 전부입니다.',
      celebration_archive_cta: '보관하기',
      celebration_keep_cta: '계속 표시',
    },
    new_account: '새 계좌',
    edit_account: '계좌 편집',
    account_name: '계좌 이름',
    ...
    show_archived_action: '보관함 보기 ({{count}})',
    hide_archived_action: '보관함 숨기기',
    show_balances: '잔액 표시',
    type: '유형',
    statement_day: '결제일',
    due_day: '납부일',
  ...
  pro: {
    ...
    trial_duration_day_many: '{{count}}일',
    trial_duration_week_one: '{{count}}주',
    trial_duration_week_other: '{{count}}주',
    trial_duration_week_few: '{{count}}주',
    trial_duration_week_many: '{{count}}주',
    trial_duration_month_one: '{{count}}개월',
    trial_duration_month_other: '{{count}}개월',
    trial_duration_month_few: '{{count}}개월',
    trial_duration_month_many: '{{count}}개월',
    trial_duration_year_one: '{{count}}년',
    trial_duration_year_other: '{{count}}년',
    trial_duration_year_few: '{{count}}년',
    trial_duration_year_many: '{{count}}년',
    trial_free: '{{duration}} 무료',
    trial_cta: '무료 체험 시작',
    subscribe: '구독하기',
    buy_lifetime: '평생 이용권 구매',
    maybe_later: '나중에',
    trial_terms: '{{duration}} 동안 무료, 이후 {{price}}.',
    ...
    limit_loans:
      '무료 플랜에서는 대출 {{count}}건을 관리할 수 있습니다. Pro로 업그레이드하면 무제한입니다.',
    badge: 'PRO',
  ...
  notifications: {
    ...
    weekly_review: {
      title: '주간 리뷰',
      label: '주간 리뷰',
      description: '방금 끝난 한 주의 요약을 그 주가 마무리되는 날에 보내드려요.',
    },
    monthly_review: {
      title: '월간 리뷰',
      label: '월간 리뷰',
      description: '방금 끝난 한 달의 요약을 그 달이 마무리되는 날에 보내드려요.',
    },
    review: {
      fires_on: '도착 시점',
      fires_on_hint: '표시 설정의 주 시작일과 월 시작일에 따라 정해져요.',
      every_week_on: '매주 {{day}}',
  ...
  review: {
    ...
    trend: '흐름',
    pace: '속도',
    pace_of_budget: '{{target}} 중 {{spent}}',
    pace_usual: '평소에는 {{amount}}',
    pace_left: '{{amount}} 남음',
    pace_over: '{{amount}} 초과',
    goals: '목표',
    goal_of_target: '{{target}} 중 {{saved}}',
    categories: '카테고리',
    uncategorized: '미분류',
    other_entries: '{{count}}개 더',
    mood: '그때의 기분',
    mood_happy: '만족스러웠어요',
    mood_neutral: '그저 그랬어요',
    mood_regret: '아쉬웠어요',
    standouts: '하이라이트',
    biggest_expense: '가장 큰 지출',
    busiest_day: '가장 바빴던 날',
    entries_count: '{{count}}건',
    quiet_days: '조용한 날',
    of_total: '{{total}} 중 {{count}}',
    entries_logged: '기록한 건수',
  },
  budget: {
    title: '예산',
  ...
  reimbursements: {
    title: '환급',
    tile_label: '환급',
    subtitle: '다른 사람이 돌려주는 지출입니다.',
    count_as_expense_label: '지출로 계산',
    count_as_expense_hint: '끄면 환급 지출과 돌아온 돈이 지출 합계에서 빠집니다.',
    ...
    editor_label: '환급 대기',
    editor_tooltip: '다른 사람이 돌려줄 지출입니다. 환급 페이지에서 청구하세요.',
    editor_reimbursed_label: '이미 돌려받음',
    options_title: '거래 옵션',
    untitled: '지출',
