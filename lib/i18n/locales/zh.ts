const zh = {
  ...
  add_action: {
    ...
    manual_title: '手动录入',
    manual_subtitle: '自己输入',
  },
  receiptScan: {
    reading: '正在读取收据…',
    source_title: '扫描收据',
    source_camera: '拍照',
    source_library: '从相册选择',
    review_title: '查看 {{count}} 笔交易',
    save_all: '全部保存（{{count}}）',
    remove: '移除',
    all_removed: '没有可保存的交易。',
    note_placeholder: '备注',
    empty_title: '未找到交易',
    empty_body: '我们无法从该收据中读取任何交易。请尝试另一张照片。',
    busy_title: '扫描器忙碌',
    busy_body: '扫描器当前正忙。请稍后再试。',
    error_title: '扫描失败',
  ...
  pro: {
    limit_receipt_scans: '免费套餐每月包含 {{count}} 次收据扫描。升级到 Pro 即可无限扫描。',
