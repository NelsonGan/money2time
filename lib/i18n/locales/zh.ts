const zh = {
  ...
  shareEarn: {
    ...
    tier1_desc: '在 Instagram、小红书、Facebook 等平台的任何公开帖子都算。',
    tier2_badge: '100+ 赞',
  ...
  items: {
    ...
    mark_inactive: '标记为停用',
    mark_inactive_hint: '停止计算天数 — 适用于不再使用、已售出或损坏的物品。',
    end_date_label: '结束日期',
    sold_toggle: '我卖掉了',
    ...
    status_active: '使用中',
    status_inactive: '停用',
    owned_for: '已拥有 {{count}} 天',
    daily_cost: '每日成本',
    final_daily_cost: '最终每日成本',
    per_day: '/ 天',
    work_per_day: '每天 {{time}} 工作',
    paid_label: '已付 {{amount}}',
    delete_title: '删除物品？',
    delete_message: '这会将物品从你的追踪器中移除。',
    summary_total_spent: '总花费',
    summary_daily_cost: '成本 / 天',
    summary_work_per_day: '工作 / 天',
    summary_counts: '物品',
    counts_value: '{{active}} 使用中 · {{inactive}} 停用',
    icon: {
      choose_title: '选择图标',
