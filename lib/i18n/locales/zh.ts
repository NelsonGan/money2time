const zh = {
  ...
  home: {
    ...
    recurring: {
      ...
      more: '还有 {{count}} 项',
      none_title: '暂无固定支出',
      none_message: '在设置中添加固定支出规则，查看你的承诺负担',
    },
  },
  onboarding: {
  ...
  settings: {
    ...
    advertisement: '打赏',
    ads: '广告',
    ad_support_open_modal_button: '永久去除广告',
    ad_support_modal_title: '永久去除广告',
    ad_support_modal_body:
      '选择以下任一打赏选项来支持开发者并帮助应用持续发展。任意打赏金额都可去广告。感谢你，愿你始终掌控自己的时间和精力。',
