const zh = {
  ...
  pro: {
    ...
    hero_subtitle: '升级到无限版，解锁每一项 Pro 工具，从扫描小票到长期趋势。',
    ...
    testimonial_meta: 'Pro 会员',
    showcase_title: '你将解锁的一切',
    showcase_subtitle: '快速了解 Pro 为你的日常带来了什么。',
    feature_receipt_title: '扫描并拆分任意小票',
    feature_receipt_desc: '拍张照片，我们就为你逐项整理，几秒内即可和朋友拆分。',
    feature_trends_title: '查看长期趋势',
    feature_trends_desc: '随时间追踪支出、收入、心情、净资产以及你的时薪。',
    feature_albums_title: '把行程整理成相册',
    feature_albums_desc: '把一趟旅行整理成一个相册，配上封面照片、地图和支出明细。',
    feature_currency_title: '管理每一种货币',
    feature_currency_desc: '以任意货币记录支出，汇率会锁定在你付款的那一刻。',
    feature_budgets_title: '规划每月预算',
    feature_budgets_desc: '用可复用的模板设置分类预算，实时观察它们的消耗情况。',
    feature_widgets_title: '小组件、语音输入等更多功能',
    feature_widgets_desc: '八款主屏幕小组件、语音记账、应用锁，以及一切无限畅用。',
