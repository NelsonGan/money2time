const zh = {
  ...
  transactions: {
    ...
    reimbursements: {
      ...
      recovered_label: '已收回',
      empty_title: '没有待报销项目',
      empty_subtitle: '把一笔支出标记为可报销，它会留在这里，直到你收到款项。',
      empty_reimbursed_title: '还没有已完成的项目',
      empty_reimbursed_subtitle: '标记为已收款的报销会归到这里，方便你在需要时撤销。',
      claims_one: '1 笔报销',
      claims_other: '{{count}} 笔报销',
      unassigned_payer: '未指定',
      claim_button: '报销',
      claim_sheet_title: '申请报销这笔支出',
      claim_sheet_subtitle: '在收到款项之前一直跟踪它。',
      payer_label: '由谁报销',
      payer_placeholder: '公司、客户、保险公司',
      claim_amount_label: '报销金额',
      claim_all_label: '报销全部金额',
      claim_all_hint: '关闭后可只报销支出的一部分。',
      save_claim: '保存报销',
      remove_claim: '移除报销',
      remove_claim_title: '移除这笔报销？',
      remove_claim_message: '这笔支出会重新计入你自己的开销，不会有任何资金变动。',
      mark_reimbursed: '标记为已报销',
      mark_reimbursed_title: '收到款项了吗？',
      mark_reimbursed_message: '报销金额会从支出中扣除，因此不再计入你的开销。',
      received_into_label: '收款账户',
      received_on_label: '收款日期',
      confirm_reimbursed: '确认',
      undo_title: '撤销这笔报销？',
      undo_message: '金额会回到支出上，收款转账记录会被删除。',
      undo_action: '撤销',
      pending_badge: '报销',
      reimbursed_badge: '已报销',
      partial_claim: '{{total}} 中的 {{amount}}',
      reimbursed_on: '{{date}} 收回',
      select_all: '全选',
      selected_one: '已选 1 项',
      selected_other: '已选 {{count}} 项',
      mark_claimable: '标记为可报销',
      untitled_expense: '支出',
      open_days_one: '已等待 1 天',
      open_days_other: '已等待 {{count}} 天',
    },
    settleUp: {
      title: '谁欠你钱',
  ...
  pro: {
    ...
    limit_reimbursements:
      '免费版最多可同时有 {{count}} 笔待收报销。处理其中一笔，或升级到 Pro 以获得无限数量。',
  ...
  notifications: {
    ...
    content: {
      ...
      weekly_title: '本周回顾',
      weekly_body: '看看这一周你的钱和时间都去了哪里。',
      weekly_body_spend: '过去 7 天你花了 {{amount}}。点按查看都花在了哪里。',
      weekly_body_spend_hours:
        '过去 7 天你花了 {{amount}}，相当于你 {{hours}} 的工作。点按查看都花在了哪里。',
    },
  },
  exchange_rates: {
    title: '多币种',
