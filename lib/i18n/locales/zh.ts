const zh = {
  ...
  home: {
    ...
    last_30_days_spent: '近30天支出',
    recent_entries: '最近记录',
    no_recent_entries: '暂无记录',
    no_recent_entries_subtitle: '点击 + 记录你的第一笔交易',
    avg_per_day_transactions: '日均: {{value}} · {{count}} 笔交易',
    net: '净额',
    window_message: {
      no_spend_1: '30天几乎零支出，控制得很好。',
      no_spend_2: '30天内账目干净利落。',
      low_1: '这个月支出节奏很轻松。',
      low_2: '近30天稳定且平和。',
      moderate_1: '平衡的一个月，节奏不错。',
      moderate_2: '近30天支出模式正常。',
      high_1: '近30天支出较高，建议回顾大额项目。',
    ...
    converter: {
      ...
      no_rate_title: '请在设置中填写时薪',
      no_rate_subtitle: '输入价格，看看它真正花费你多少小时。',
      typing: '输入中...',
      tap_to_edit: '点击金额编辑',
      clear: '清除',
  ...
  onboarding: {
    ...
    flow: {
      ...
      skip_setup_message: '你可以稍后在设置中配置时薪和账户。',
      stay: '留下',
      skip: '跳过',
      invalid_file: '文件无效',
  ...
  insights: {
    ...
    calendar: {
      ...
      legend_expense: '支出日',
      legend_selected: '选中日',
      activity_days: '{{count}} 个活跃日',
      days_in_range: '范围内 {{count}} 天',
      future_day: '未来日期',
      day_details: '当日详情',
      drilldown_subtitle: '当日所有收支',
      transactions: '交易',
      view_all: '查看全部 ({{count}})',
  ...
  settings: {
    ...
    center_add_button_ai_chat: '中间加号按钮打开 AI 聊天',
    center_add_button_ai_chat_subtitle: '让底部导航中间按钮打开 AI 聊天，而不是新增交易。',
  ...
  tutorial: {
    ...
    prompt_message: '快速浏览首页、交易、添加、洞察和设置。',
    prompt_yes: '好的，开始教程',
    prompt_not_now: '暂不需要',
    coach_steps: {
      home_title: '显示模式',
      home_body: '使用此开关在金额视图和时间视图之间切换。',
