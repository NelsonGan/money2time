const zh = {
  ...
  widgets: {
    ...
    budget_days_left: '还剩 {{count}} 天',
    budget_more_categories: '还有 {{count}} 个分类',
  ...
  budget: {
    ...
    total_label: '预算总额',
    allocate_title: '分配到分类',
    allocate_hint: '将总额分配到各分类。点按分类即可设置金额。',
    allocated_summary: '已分配 {{allocated}} / {{total}}',
    allocated_left: '剩余 {{amount}}',
    allocated_over: '超出 {{amount}}',
