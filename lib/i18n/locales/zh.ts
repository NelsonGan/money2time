const zh = {
  ...
  reimbursements: {
    title: '报销',
    tile_label: '报销',
    subtitle: '别人之后会还给你的支出。',
    count_as_expense_label: '计入支出',
    count_as_expense_hint:
      '开启时，可报销的支出和其他支出一样。关闭时，它不进入任何支出合计，回来的钱也一样。',
    pending_title: '等待返还',
    settled_title: '已返还',
    pending_total_label: '别人欠你',
    empty_title: '没有要报销的',
    empty_message: '在支出上勾选“待报销”，它就会留在这里，直到钱回来。',
    mark_reimbursed: '标记为已返还',
    paid_into: '存入{{account}}',
    undo_title: '撤销这笔报销？',
    undo_message: '收入记录会被删除，这笔支出重新回到等待状态。',
    undo_action: '撤销',
    refund_note_prefix: '报销',
    editor_label: '待报销',
    editor_hint: '在这里跟进，直到钱回来。',
    editor_reimbursed_hint: '已经返还。可在报销页面管理。',
    options_title: '交易选项',
    untitled: '支出',
    no_account: '请先添加账户',
  },
