const zh = {
  ...
  settings: {
    ...
    auto_log: {
      ...
      usage_unlimited: '无限制',
      usage_exhausted: '免费自动记账已用完。升级到 Pro 即可无限使用。',
      setup_title: '设置',
      automation_row: 'Apple Pay 自动记账',
      automation_row_hint: '每张卡一个自动化',
      backtap_row: '轻点背面',
      backtap_row_hint: '连点两下 iPhone 背面',
      backtap_action_label: '轻点背面打开',
      step_counter: '第 %{current} 步，共 %{total} 步',
      tutorial_step_1: '打开「快捷指令」，切换到「自动化」标签页。',
      tutorial_step_2: '轻点 +，然后选择「交易」。',
      tutorial_step_3: '选择你的卡片。选择「立即运行」，并关闭「运行时通知」。',
      tutorial_step_4: '添加 Money2Time 的 "Log Transaction" 操作。',
      tutorial_step_5: '把 Amount 和 Merchant 设为「快捷指令输入」变量。',
      tutorial_step_6: '选择这张卡对应的账户。把 Category 保留为「每次询问」，即可在付款时挑选。',
      tutorial_step_7: '忽略通知也会记账，使用你的默认分类。',
      backtap_step_1:
        '在「快捷指令」中新建一个快捷指令，唯一操作是 Money2Time 的 "Add Transaction"。',
      backtap_step_2: '打开「设置」→「辅助功能」→「触控」→「轻点背面」。',
      backtap_step_3: '选择「轻点两下」或「轻点三下」，然后选中你的快捷指令。',
      defaults_title: '默认值',
