const zh = {
  ...
  settings: {
    ...
    replay_onboarding_subtitle: '再次浏览设置向导',
    replay_title: '重播引导？',
    replay_message: '下次启动时将再次显示设置向导。不会删除任何数据。',
    replay_action: '重播',
    rate_app: '评价 Money2Time',
    rate_app_subtitle: '喜欢这个应用？快速留下评分',
    danger_zone: '危险区域',
  ...
  widgets: {
    page_title: '主屏幕小组件',
    page_subtitle: '预览和自定义您的小组件',
    row_label: '小组件',
    row_subtitle: '预览和自定义主屏幕小组件',
    badge_free: '免费',
    badge_pro: 'Pro',
    badge_medium: '中',
    badge_small: '小',
    ...
    sample_data: '示例',
    my_data: '我的数据',
    customization_section: '自定义',
    show_time_equivalent: '显示时间换算',
    show_time_equivalent_subtitle: '在消费金额下方显示工作时长',
    savings_source_label: '储蓄分类',
    savings_source_subtitle: '与洞察标签页共享设置',
    how_to_add_title: '如何添加到主屏幕',
    how_to_add_body: '长按主屏幕空白区域 → 点击 + → 搜索 Money2Time',
    pro_required_title: '需要 Pro',
    pro_required_body: '升级到 Money2Time Pro 以解锁此小组件',
    unlock_customization: '升级以自定义',
    unlock_customization_subtitle: 'Pro 会员可以个性化每个小组件',
  },
};
