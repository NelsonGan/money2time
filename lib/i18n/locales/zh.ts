const zh = {
  ...
  accounts: {
    ...
    loan: {
      principal_label: '贷款本金',
      principal_hint: '用于计算还款进度。',
      balance_owed_label: '剩余欠款',
      balance_owed_hint: '你目前仍欠的金额。',
      monthly_payment_label: '每月还款',
      payment_day_label: '还款日',
      interest_rate_label: '年利率（%）',
      interest_rate_hint: '可选。用于估算还清日期；利息不会自动记入。',
      partly_paid_toggle: '我已经还了一部分',
      autopay_toggle: '自动还款',
      autopay_hint: '在还款日创建每月转账。',
      autopay_source_label: '还款账户',
      autopay_source_placeholder: '选择账户',
      autopay_no_source: '还没有可用于还款的 {{currency}} 账户。',
      autopay_rule_name: '{{name}} 还款',
      payment_below_interest_short: '还款不足以支付利息',
      payoff_by_label: '还清时间',
      payments_left_label: '剩余期数',
      est_interest_label: '预计利息',
      ...
      archive_hint: '将它从账户中隐藏。历史记录和总额都会保留。',
