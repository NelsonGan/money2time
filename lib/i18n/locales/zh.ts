const zh = {
  ...
  review: {
    ...
    delta_flat: '持平',
    delta_note_up: '比{{previous}}多',
    delta_note_down: '比{{previous}}少',
    delta_note_flat: '与{{previous}}持平',
    ...
    pace_label: '节奏',
    pace_budget_label: '预算',
    pace_budget_title: '对比你的预算',
    pace_title: {
      week: '对比你平时的一周',
      month: '对比你平时的一个月',
      year: '对比你平时的一年',
    ...
    pace_average: {
      week: '你最近 {{count}} 周的平均：{{amount}}',
      month: '你最近 {{count}} 个月的平均：{{amount}}',
      year: '你最近 {{count}} 年的平均：{{amount}}',
    },
    pace_left: '还剩 {{amount}}',
    pace_over: '超出 {{amount}}',
    categories_title: {
