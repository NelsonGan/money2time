const zh = {
  ...
  accounts: {
    ...
    loan: {
      ...
      projection_remaining: '剩余 {{amount}}',
      projection_interest: '还需支付约 {{amount}} 利息',
      ...
      archive_hint: '将它从账户中隐藏。历史记录和总额都会保留，可在账户设置中找回。',
