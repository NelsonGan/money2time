const zh = {
  ...
  onboarding: {
    ...
    value_prop: {
      ...
      title: '用时间的视角\n看待金钱。',
      body: '你花的每一分钱都是用真实时间换来的。这款应用将支出转换为时和分——让你在消费时更加珍惜自己的时间。',
      example: '示例',
      example_work: '= 1小时40分钟的工作',
      example_rate: '基于 {{symbol}}15/小时的真实时薪',
      money_mode: '金额模式',
      money_mode_subtitle: '显示原始金额',
      time_mode: '时间模式',
      time_mode_subtitle: '将一切转换为工作时间',
      language_label: '语言',
      currency_label: '货币',
      prefill_note: '默认值来自你的手机语言和地区。',
      get_started: '开始使用',
      skip_setup: '跳过设置',
    },
    flow: {
    ...
    wage: {
      ...
      skip_now: '稍后再说',
      set_title: '时薪已设置！',
      set_subtitle: '现在可以将每一分钱转换为赚取它所需的时间。',
      true_rate_title: '你的真实时薪',
      true_rate_based_on: '基于当前薪资设置',
      recalculate: '重新计算',
      worth_title: '你的时间值多少？',
      worth_body:
        '要将金额转换为时间，我们需要你的真实时薪——税后实际收入除以实际工作时间（包括通勤）。',
      why_matters: '为什么这很重要',
      why_matters_body:
        '{{symbol}}12 的 Netflix 订阅看似无害，但如果你时薪 {{symbol}}15，它就花费了你 48 分钟的生命。了解你的时薪会改变你看待每笔消费的方式。',
      setup_wage: '设置我的时薪',
      later_label: '稍后再说 →',
    ...
    bootstrap: {
      ...
      importing_subtitle: '正在解析账户、分类和交易...',
      import_complete_title: '导入完成！',
      import_complete_subtitle: '你的数据已成功导入。',
      accounts: '账户',
      categories: '分类',
      transactions: '交易',
      transfers: '转账',
    ...
    mode: {
      ...
      simple_title: '简单',
      simple_description: '单钱包记录收支，无需管理账户。',
      power_title: '专业',
      power_description: '完整功能：多账户、账户分组和转账。',
    },
  },
  transactions: {
    title: '交易',
  ...
  settings: {
    ...
    ad_support_modal_body:
      '选择以下任一打赏选项来支持开发者并帮助应用持续发展。任意选项均可永久去除广告。感谢你，愿你始终掌控自己的时间和精力。',
  ...
  tutorial: {
    ...
    coach_steps: {
      ...
      management_title: '分类',
      management_body: '在这里管理分类，让支出记录井然有序。',
