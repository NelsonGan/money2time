const fil = {
  ...
  widgets: {
    ...
    live: {
      ...
      start: 'Simulan nang manu-mano',
      start_sheet_title: 'Simulan ang orasan',
      start_confirm: 'Simulan',
  ...
  transactions: {
    ...
    settleUp: {
      ...
      history_empty_title: 'Wala pang bayad',
      history_empty_subtitle: 'Lalabas dito ang mga bill na binayaran ng mga kaibigan at pamilya.',
    ...
    editor: {
      ...
      receipt: {
        ...
        replace: 'Palitan',
        save_to_photos: 'I-save sa Photos',
        save_success: 'Na-save ang resibo sa Photos.',
        save_failed: 'Hindi ma-save ang resibo. Tingnan ang photo access at subukan ulit.',
        crop: 'Crop',
  ...
  pro: {
    ...
    trial_duration_day_many: '{{count}} araw',
    trial_duration_week_one: '{{count}} linggo',
    trial_duration_week_other: '{{count}} linggo',
    trial_duration_week_few: '{{count}} linggo',
    trial_duration_week_many: '{{count}} linggo',
    trial_duration_month_one: '{{count}} buwan',
    trial_duration_month_other: '{{count}} buwan',
    trial_duration_month_few: '{{count}} buwan',
    trial_duration_month_many: '{{count}} buwan',
    trial_duration_year_one: '{{count}} taon',
    trial_duration_year_other: '{{count}} taon',
    trial_duration_year_few: '{{count}} taon',
    trial_duration_year_many: '{{count}} taon',
    trial_free: '{{duration}} libre',
    trial_cta: 'Simulan ang libreng trial',
    subscribe: 'Mag-subscribe',
    buy_lifetime: 'Bilhin ang Lifetime',
    maybe_later: 'Siguro mamaya',
    trial_terms: 'Libre sa loob ng {{duration}}, pagkatapos ay {{price}}.',
  ...
  goals: {
    ...
    remove_cover: 'Alisin ang larawan',
