const fil = {
  ...
  settings: {
    ...
    auto_log: {
      ...
      usage_unlimited: 'Walang limitasyon',
      usage_exhausted: 'Naubos na ang libreng auto-log. Mag-upgrade sa Pro para walang limitasyon.',
      setup_title: 'Setup',
      automation_row: 'Apple Pay auto-log',
