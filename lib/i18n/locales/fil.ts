const fil = {
  ...
  reimbursements: {
    ...
    empty_message: 'Lagyan ng tsek ang "Ire-reimburse" sa isang gastos para makita ito rito.',
    ...
    editor_hint: 'Singilin pabalik mamaya.',
    editor_reimbursed_hint: 'Nabayaran na.',
