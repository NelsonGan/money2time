const fil = {
  ...
  accounts: {
    ...
    loan: {
      principal_label: 'Halagang hiniram',
      principal_hint:
        'Ang orihinal na halaga ng utang, ginagamit para ipakita kung magkano na ang nabayaran mo.',
      balance_owed_label: 'Natitirang utang',
      balance_owed_hint: 'Ang utang mo ngayon. Bumababa ito sa bawat bayad.',
      monthly_payment_label: 'Buwanang bayad',
      payment_day_label: 'Araw ng bayad',
      interest_rate_label: 'Interes (% kada taon)',
      interest_rate_hint:
        'Opsyonal, ginagamit para tantyahin ang petsa ng pagkabayad. Hindi awtomatikong naitatala ang interes.',
      payment_below_interest_warning:
        'Mas maliit ang bayad na ito kaysa sa buwanang interes, kaya lalaki ang utang sa halip na bumaba.',
      ...
      projection_remaining: '{{amount}} ang natitira',
      projection_interest: 'Mga {{amount}} pang interes ang babayaran',
      ...
      archive_hint:
        'Itinatago ito sa listahan ng account. Nananatili ang kasaysayan at kabuuan, at mababalik mo ito sa Account settings.',
