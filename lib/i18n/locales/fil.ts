const fil = {
  ...
  add_action: {
    ...
    manual_title: 'Manwal na paglagay',
    manual_subtitle: 'Ikaw mismo ang mag-type',
  },
  receiptScan: {
    reading: 'Binabasa ang resibo…',
    source_title: 'I-scan ang resibo',
    source_camera: 'Kumuha ng litrato',
    source_library: 'Pumili mula sa library',
    review_title: 'Suriin ang {{count}} na transaksyon',
    save_all: 'I-save lahat ({{count}})',
    remove: 'Alisin',
    all_removed: 'Wala nang transaksyong ise-save.',
    note_placeholder: 'Tala',
    empty_title: 'Walang natagpuang transaksyon',
    empty_body:
      'Hindi kami makabasa ng anumang transaksyon mula sa resibong iyon. Subukan ang ibang litrato.',
    busy_title: 'Abala ang scanner',
    busy_body: 'Abala ang scanner ngayon. Pakisubukang muli mamaya.',
  ...
  settings: {
    ...
    quick_entry: {
      ...
      add_button: {
        ...
        action_manual: 'Manual na pag-input',
  ...
  pro: {
    limit_receipt_scans:
      'Kasama sa libreng plano ang {{count}} pag-scan ng resibo bawat buwan. Mag-upgrade sa Pro para sa walang limitasyong pag-scan.',
