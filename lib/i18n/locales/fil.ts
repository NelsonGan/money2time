const fil = {
  ...
  transactions: {
    ...
    reimbursements: {
      ...
      recovered_label: 'Naibalik',
      empty_title: 'Walang ma-claim',
      empty_subtitle:
        'Markahan ang isang gastos bilang maaaring i-claim at mananatili ito rito hanggang mabayaran ka.',
      empty_reimbursed_title: 'Wala pang natatapos',
      empty_reimbursed_subtitle:
        'Ang mga claim na minarkahan mong bayad ay lalabas dito, sakaling kailanganin mong bawiin.',
      claims_one: '1 claim',
      claims_other: '{{count}} claim',
      unassigned_payer: 'Walang nakatalaga',
      claim_button: 'Claim',
      claim_sheet_title: 'I-claim ang gastos na ito',
      claim_sheet_subtitle: 'Subaybayan ito hanggang may magbayad sa iyo.',
      payer_label: 'Babayaran ka ni',
      payer_placeholder: 'Trabaho, kliyente, insurance',
      claim_amount_label: 'Halaga ng claim',
      claim_all_label: 'I-claim ang buong halaga',
      claim_all_hint: 'I-off ito para i-claim lang ang bahagi ng gastos.',
      save_claim: 'I-save ang claim',
      remove_claim: 'Alisin ang claim',
      ...
      open_days_other: 'Bukas nang {{count}} araw',
    },
    settleUp: {
  ...
  pro: {
    ...
    limit_reimbursements:
      'Puwede kang magkaroon ng hanggang {{count}} bukas na claim sa libreng plano. Tapusin ang isa o mag-upgrade sa Pro para walang limitasyon.',
    limit_goals:
