const fil = {
  ...
  pro: {
    ...
    trial_spotlight_title: 'Subukan ang lahat bago magbayad',
    trial_spotlight_body: 'I-unlock ang lahat ng Pro feature ngayon.',
    ...
    trial_cta: 'Simulan ang {{duration}} na libreng trial',
    trial_terms:
