const tr = {
  ...
  accounts: {
    ...
    loan: {
      principal_label: 'Çekilen tutar',
      principal_hint: 'Ödeme ilerlemenizi belirler.',
      balance_owed_label: 'Kalan borç',
      balance_owed_hint: 'Bugün hâlâ borçlu olduğunuz tutar.',
      monthly_payment_label: 'Aylık taksit',
      payment_day_label: 'Ödeme günü',
      interest_rate_label: 'Faiz oranı (yıllık %)',
      interest_rate_hint: 'İsteğe bağlı. Bitiş tarihini tahmin eder; faizler otomatik işlenmez.',
      partly_paid_toggle: 'Bir kısmını zaten ödedim',
      autopay_toggle: 'Otomatik öde',
      autopay_hint: 'Ödeme gününüzde aylık bir transfer oluşturur.',
      autopay_source_label: 'Şuradan öde',
      autopay_source_placeholder: 'Bir hesap seçin',
      autopay_no_source: 'Henüz ödeme yapılacak {{currency}} hesabı yok.',
      autopay_rule_name: '{{name}} ödemesi',
      payment_below_interest_short: 'Taksit faizi karşılamıyor',
      payoff_by_label: 'Bitiş',
      payments_left_label: 'Kalan taksit',
      est_interest_label: 'Tah. faiz',
      ...
      archive_hint: 'Hesaplarınızdan gizler. Geçmiş ve toplamlar korunur.',
