const tr = {
  ...
  add_action: {
    ...
    over_account_limit_message:
      '{{active}} etkin hesabınız var. Ücretsiz işlem eklemek için en fazla {{count}} etkin hesap tutun. Fazla hesapları kaldırın ya da Pro aboneliği alın. Diğer işlemler kullanılabilir.',
  ...
  widgets: {
    ...
    live: {
      ...
      headline: 'Bugün bu kadar kazandınız',
      badge_on: 'Açık',
      rate: '{{amount}}/sa',
      ends_at: '{{time}} biter',
      duration_title: 'Süre',
      ...
      start: 'Elle başlat',
      start_sheet_title: 'Sayacı başlat',
      start_confirm: 'Başlat',
      stop: 'Sayacı durdur',
  ...
  transactions: {
    ...
    settleUp: {
      ...
      history_empty_title: 'Henüz geri ödeme yok',
      history_empty_subtitle: 'Arkadaşlarınızın ve ailenizin geri ödediği hesaplar burada görünür.',
    ...
    editor: {
      ...
      receipt: {
        ...
        save_success: 'Makbuz Fotoğraflara kaydedildi.',
        save_failed: 'Makbuz kaydedilemedi. Fotoğraf erişimini kontrol edip tekrar deneyin.',
        crop: 'Crop',
  ...
  insights: {
    ...
    review: 'Harcamaları İncele',
    review_description:
      'Tamamlanmış bir haftaya, aya veya yıla geri bakın: ne çıktı, ne kaldı ve nasıl hissettirdi.',
  ...
  accounts: {
    ...
    loan: {
      ...
      paid_periods_error: 'Kredi vadesinden az olmalı.',
      start_date_label: 'Başlangıç tarihi',
      start_date_info:
        'Kredinin çekildiği tarih. İlk taksit bir ay sonra düşer ve o günü ödeme gününüz olur.',
      collect_account_label: 'Şu hesaptan çek',
      ...
      collect_account_external: 'Bu ödeme Yinelenen bölümünde ayarlı. Oradan düzenleyin.',
      ...
      payment_below_interest_short: 'Taksit faizi karşılamıyor',
      payoff_by_label: 'Bitiş',
      first_instalment_label: 'İlk taksit',
      instalments_left_label: 'Kalan taksit',
      projection_with_date_one: 'Yaklaşık {{date}} tarihinde biter, {{count}} taksit kaldı',
      projection_with_date_other: 'Yaklaşık {{date}} tarihinde biter, {{count}} taksit kaldı',
      ...
      next_due_chip: 'Sonraki ödeme {{date}}',
      overdue_chip: '{{date}} tarihinden beri gecikmiş',
      make_payment: 'Ödeme yap',
      payment_note: 'Kredi ödemesi',
      due_amount: 'Ödenecek tutar',
      archive_action: 'Krediyi arşivle',
      unarchive_action: 'Arşivden çıkar',
      archive_hint:
        'Hesap listenizden gizler. Geçmiş ve toplamlar korunur, "Arşivi göster" ile geri gelir.',
      celebration_title: 'Kredi kapandı',
      celebration_message: '{{name}} tamamen ödendi. O borç artık geride kaldı.',
      celebration_message_with_amount: '{{name}} tamamen ödendi, {{amount}} tutarının hepsi.',
      celebration_archive_cta: 'Arşivle',
      celebration_keep_cta: 'Görünür kalsın',
    },
    ...
    archived_section: 'Arşivlenenler',
    show_archived_action: 'Arşivi göster ({{count}})',
    hide_archived_action: 'Arşivi gizle',
  ...
  pro: {
    ...
    trial_duration_day_many: '{{count}} gün',
    trial_duration_week_one: '{{count}} hafta',
    trial_duration_week_other: '{{count}} hafta',
    trial_duration_week_few: '{{count}} hafta',
    trial_duration_week_many: '{{count}} hafta',
    trial_duration_month_one: '{{count}} ay',
    trial_duration_month_other: '{{count}} ay',
    trial_duration_month_few: '{{count}} ay',
    trial_duration_month_many: '{{count}} ay',
    trial_duration_year_one: '{{count}} yıl',
    trial_duration_year_other: '{{count}} yıl',
    trial_duration_year_few: '{{count}} yıl',
    trial_duration_year_many: '{{count}} yıl',
    trial_free: '{{duration}} ücretsiz',
    trial_cta: 'Ücretsiz denemeyi başlat',
    subscribe: 'Abone ol',
    buy_lifetime: 'Ömür boyu erişim satın al',
    maybe_later: 'Belki sonra',
    trial_terms: '{{duration}} ücretsiz, ardından {{price}}.',
    ...
    limit_loans: "Ücretsiz planda {{count}} kredi takip edebilirsiniz. Sınırsız için Pro'ya geçin.",
    badge: 'PRO',
  ...
  notifications: {
    ...
    weekly_review: {
      ...
      description: 'Yeni kapanan haftanın özeti, kapandığı gün.',
    },
    monthly_review: {
      title: 'Aylık İnceleme',
      label: 'Aylık inceleme',
      description: 'Yeni kapanan ayın özeti, kapandığı gün.',
    },
    review: {
      fires_on: 'Geliş zamanı',
      fires_on_hint: 'Görünüm ayarlarındaki hafta ve ay başlangıcınıza göre belirlenir.',
      every_week_on: 'Her {{day}}',
  ...
  review: {
    ...
    trend: 'Eğilim',
    pace: 'Tempo',
    pace_of_budget: '{{target}} üzerinden {{spent}}',
    pace_usual: 'Her zamanki temponuz {{amount}}',
    pace_left: '{{amount}} kaldı',
    pace_over: '{{amount}} aşıldı',
    goals: 'Hedefler',
    goal_of_target: '{{target}} üzerinden {{saved}}',
    categories: 'Kategoriler',
    uncategorized: 'Kategorisiz',
    other_entries: '{{count}} tane daha',
    mood: 'Nasıl hissettirdi',
    mood_happy: 'İyi hissettirdi',
    mood_neutral: 'Ne iyi ne kötü',
    mood_regret: 'Keşke yapmasaydım',
    standouts: 'Öne çıkanlar',
    biggest_expense: 'En büyük gider',
    busiest_day: 'En yoğun gün',
    entries_count: '{{count}} kayıt',
    quiet_days: 'Sakin günler',
    of_total: '{{total}} içinde {{count}}',
    entries_logged: 'Kaydedilen işlemler',
  },
  budget: {
    title: 'Bütçe',
