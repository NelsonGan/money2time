const tr = {
  ...
  accounts: {
    ...
    loan: {
      ...
      principal_hint: 'Kredinin ilk tutarı. Ne kadarını ödediğinizi göstermek için kullanılır.',
      balance_owed_label: 'Kalan borç',
      balance_owed_hint: 'Bugün hâlâ borçlu olduğunuz tutar. Ödemeler bunu düşürür.',
      monthly_payment_label: 'Aylık taksit',
      payment_day_label: 'Ödeme günü',
      interest_rate_label: 'Faiz oranı (yıllık %)',
      interest_rate_hint:
        'İsteğe bağlı, bitiş tarihini tahmin etmek için kullanılır. Faizler otomatik olarak işlenmez.',
      payment_below_interest_warning:
        'Bu taksit aylık faizden düşük, bu yüzden borç azalmak yerine artacak.',
      ...
      projection_remaining: '{{amount}} kaldı',
      projection_interest: 'Yaklaşık {{amount}} faiz ödenmeyi bekliyor',
      ...
      archive_hint:
        'Hesaplarınızdan gizler. Geçmiş ve toplamlar korunur, Hesap ayarlarından geri getirebilirsiniz.',
