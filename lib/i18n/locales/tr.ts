const tr = {
  ...
  transactions: {
    ...
    reimbursements: {
      ...
      recovered_label: 'Geri ödendi',
      empty_title: 'Talep edilecek bir şey yok',
      empty_subtitle:
        'Bir harcamayı iade edilebilir olarak işaretleyin, paranız gelene kadar burada bekler.',
      empty_reimbursed_title: 'Henüz kapanan yok',
      empty_reimbursed_subtitle:
        'Ödendi olarak işaretlediğiniz talepler buraya gelir, geri almanız gerekirse diye.',
      claims_one: '1 talep',
      claims_other: '{{count}} talep',
      unassigned_payer: 'Atanmamış',
      claim_button: 'Talep',
      claim_sheet_title: 'Bu harcamayı talep et',
      claim_sheet_subtitle: 'Biri size geri ödeyene kadar takip edin.',
      payer_label: 'Geri ödeyen',
      payer_placeholder: 'İş yeri, bir müşteri, bir sigorta',
      claim_amount_label: 'Talep tutarı',
      claim_all_label: 'Tutarın tamamını talep et',
      claim_all_hint: 'Harcamanın yalnızca bir kısmını talep etmek için kapatın.',
      save_claim: 'Talebi kaydet',
      remove_claim: 'Talebi kaldır',
      ...
      open_days_other: '{{count}} gündür açık',
    },
    settleUp: {
  ...
  pro: {
    ...
    limit_reimbursements:
      "Ücretsiz planda en fazla {{count}} açık masraf talebiniz olabilir. Birini kapatın veya sınırsız için Pro'ya geçin.",
