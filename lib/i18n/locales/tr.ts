const tr = {
  ...
  add_action: {
    ...
    manual_title: 'Manuel giriş',
    manual_subtitle: 'Kendin yaz',
  },
  receiptScan: {
    reading: 'Fiş okunuyor…',
    source_title: 'Fiş tara',
    source_camera: 'Fotoğraf çek',
    source_library: 'Galeriden seç',
    review_title: '{{count}} işlemi gözden geçir',
    save_all: 'Tümünü kaydet ({{count}})',
    remove: 'Kaldır',
    all_removed: 'Kaydedilecek işlem kalmadı.',
    note_placeholder: 'Not',
    empty_title: 'İşlem bulunamadı',
    empty_body: 'O fişten herhangi bir işlem okuyamadık. Başka bir fotoğraf deneyin.',
    busy_title: 'Tarayıcı meşgul',
    busy_body: 'Tarayıcı şu anda meşgul. Lütfen birazdan tekrar deneyin.',
  ...
  pro: {
    limit_receipt_scans:
      'Ücretsiz plan ayda {{count}} fiş taramasını içerir. Sınırsız tarama için Pro’ya yükseltin.',
