const tr = {
  ...
  pro: {
    ...
    hero_subtitle:
      'Sınırsıza geç ve fiş taramadan uzun vadeli eğilimlere kadar her Pro aracının kilidini aç.',
    ...
    testimonial_meta: 'Pro üye',
    showcase_title: 'Kilidini açtığın her şey',
    showcase_subtitle: "Pro'nun gününe kattıklarına kısa bir bakış.",
    feature_receipt_title: 'Her fişi tara ve böl',
    feature_receipt_desc:
      'Bir fotoğraf çek, biz onu kalem kalem ayıralım, sonra saniyeler içinde arkadaşlarınla bölüş.',
    feature_trends_title: 'Uzun vadeli eğilimleri gör',
    feature_trends_desc:
      'Harcamalarını, gelirini, ruh halini, net değerini ve saatlik ücretini zaman içinde takip et.',
    feature_albums_title: 'Gezileri albümlerde grupla',
    feature_albums_desc:
      'Bir geziyi kapak fotoğrafı, harita ve harcama dökümüyle tek bir albümde topla.',
    feature_currency_title: 'Her para birimini takip et',
    feature_currency_desc:
      'Harcamalarını istediğin para biriminde kaydet, döviz kuru ödeme yaptığın anda sabitlenir.',
    feature_budgets_title: 'Aylık bütçeleri planla',
    feature_budgets_desc:
      'Yeniden kullanılabilir şablonlardan kategori bütçeleri belirle ve gerçek zamanlı olarak azalmalarını izle.',
    feature_widgets_title: "Widget'lar, ses ve daha fazlası",
    feature_widgets_desc: "Sekiz ana ekran widget'ı, sesli giriş, App Lock ve her şeyde sınırsız.",
    ...
    exit_maybe_later: 'Hayır, teşekkürler',
    exit_cta: 'Devam et',
