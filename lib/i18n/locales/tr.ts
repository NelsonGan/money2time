const tr = {
  ...
  review: {
    ...
    date_range: '{{start}} ile {{end}} arası',
    week_tick: 'H{{index}}',
    ...
    previous_period: {
      ...
      year: 'önceki yıla göre',
    },
    delta_flat: 'Sabit',
    delta_note_up: '{{previous}} daha yüksek',
    delta_note_down: '{{previous}} daha düşük',
    delta_note_flat: '{{previous}} aynı seviyede',
    ...
    trend_average: 'ort. {{amount}}',
    pace_label: 'Tempo',
    pace_budget_label: 'Bütçe',
    pace_budget_title: 'Bütçenize göre',
    pace_title: {
      week: 'Her zamanki haftanıza göre',
      month: 'Her zamanki ayınıza göre',
      year: 'Her zamanki yılınıza göre',
    },
    pace_of_budget: '{{target}} üzerinden {{spent}}',
    pace_average: {
      week: 'Son {{count}} haftanızın ortalaması: {{amount}}',
      month: 'Son {{count}} ayınızın ortalaması: {{amount}}',
      year: 'Son {{count}} yılınızın ortalaması: {{amount}}',
    },
    pace_left: '{{amount}} kaldı',
    pace_over: '{{amount}} aşıldı',
    categories_title: {
      week: 'O haftanın en büyük kategorileri',
      month: 'O ayın en büyük kategorileri',
      year: 'O yılın en büyük kategorileri',
    },
    uncategorized: 'Kategorisiz',
    other_entries: '{{count}} tane daha',
    mood_title: {
      week: 'Hafta nasıl hissettirdi',
      month: 'Ay nasıl hissettirdi',
      year: 'Yıl nasıl hissettirdi',
    },
    mood_happy: 'İyi hissettirdi',
    mood_neutral: 'Ne iyi ne kötü',
    mood_regret: 'Keşke yapmasaydım',
    standouts_title: {
      week: 'O haftanın öne çıkanları',
      month: 'O ayın öne çıkanları',
      year: 'O yılın öne çıkanları',
    },
    biggest_expense: 'En büyük gider',
    busiest_day: 'En yoğun gün',
    entries_count: '{{count}} kayıt',
    quiet_days: 'Sakin günler',
    quiet_days_sub: 'Hiçbir şey kaydedilmedi',
