const de = {
  ...
  reimbursements: {
    ...
    empty_message: 'Setze bei einer Ausgabe den Haken "Wird erstattet", dann steht sie hier.',
    ...
    editor_hint: 'Später zurückfordern.',
    editor_reimbursed_hint: 'Bereits zurückgezahlt.',
