const de = {
  ...
  pro: {
    ...
    trial_hero_title: 'Money2Time Pro {{duration}} kostenlos testen',
    ...
    trial_terms:
      '{{duration}} kostenlos, danach {{price}}. Verlängert sich automatisch bis zur Kündigung.',
    plans_heading: 'Wähle deinen Tarif',
    save_percent: 'Spare {{percent}}%',
    per_month_short: '/Mon.',
    no_commitment: 'Verlängert sich automatisch bis zur Kündigung.',
