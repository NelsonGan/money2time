const de = {
  ...
  accounts: {
    ...
    loan: {
      principal_label: 'Aufgenommener Betrag',
      principal_hint: 'Die ursprüngliche Kreditsumme. Zeigt, wie viel du bereits getilgt hast.',
      balance_owed_label: 'Offener Betrag',
      balance_owed_hint: 'Was du heute noch schuldest. Rückzahlungen senken diesen Betrag.',
      monthly_payment_label: 'Monatliche Rate',
      payment_day_label: 'Zahltag',
      interest_rate_label: 'Zinssatz (% pro Jahr)',
      interest_rate_hint:
        'Optional, dient der Schätzung des Tilgungsdatums. Zinsen werden nicht automatisch gebucht.',
      payment_below_interest_warning:
        'Diese Rate ist kleiner als die monatlichen Zinsen, der Saldo wächst also, statt zu sinken.',
      ...
      projection_remaining: '{{amount}} offen',
      projection_interest: 'Noch etwa {{amount}} Zinsen zu zahlen',
      ...
      archive_hint:
        'Blendet ihn aus deinen Konten aus. Verlauf und Summen bleiben erhalten, und du kannst ihn in den Kontoeinstellungen zurückholen.',
