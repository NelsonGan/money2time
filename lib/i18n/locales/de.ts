const de = {
  ...
  pro: {
    ...
    trial_spotlight_title: 'Alles testen, bevor du bezahlst',
    trial_spotlight_body: 'Schalte heute alle Pro-Funktionen frei.',
    ...
    trial_cta: 'Meine kostenlose {{duration}}-Testphase starten',
    trial_terms:
