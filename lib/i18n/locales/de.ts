const de = {
  ...
  transactions: {
    ...
    reimbursements: {
      ...
      recovered_label: 'Zurückgezahlt',
      empty_title: 'Nichts einzureichen',
      empty_subtitle:
        'Markiere eine Ausgabe als erstattungsfähig, dann wartet sie hier, bis du dein Geld bekommst.',
      empty_reimbursed_title: 'Noch nichts abgeschlossen',
      empty_reimbursed_subtitle:
        'Als bezahlt markierte Forderungen landen hier, falls du sie rückgängig machen musst.',
      claims_one: '1 Forderung',
      claims_other: '{{count}} Forderungen',
      unassigned_payer: 'Nicht zugeordnet',
      claim_button: 'Erstattung',
      claim_sheet_title: 'Diese Ausgabe einreichen',
      claim_sheet_subtitle: 'Behalte sie im Blick, bis dir jemand das Geld zurückzahlt.',
      payer_label: 'Zurückgezahlt von',
      payer_placeholder: 'Arbeit, ein Kunde, eine Versicherung',
      claim_amount_label: 'Forderungsbetrag',
      claim_all_label: 'Gesamten Betrag einreichen',
      claim_all_hint: 'Schalte das aus, um nur einen Teil der Ausgabe einzureichen.',
      save_claim: 'Forderung speichern',
      remove_claim: 'Forderung entfernen',
      ...
      open_days_other: 'Seit {{count}} Tagen offen',
    },
    settleUp: {
  ...
  pro: {
    ...
    limit_reimbursements:
      'Im kostenlosen Plan kannst du bis zu {{count}} offene Erstattungsforderungen haben. Schließe eine ab oder wechsle zu Pro für unbegrenzt viele.',
  ...
  notifications: {
    ...
    content: {
      ...
      weekly_body: 'Sieh, wohin dein Geld und deine Zeit diese Woche geflossen sind.',
      weekly_body_spend:
        'Du hast in den letzten 7 Tagen {{amount}} ausgegeben. Tippe, um zu sehen, wohin es ging.',
      weekly_body_spend_hours:
        'Du hast in den letzten 7 Tagen {{amount}} ausgegeben, das entspricht {{hours}} deiner Arbeit. Tippe, um zu sehen, wohin es ging.',
    },
  },
  auto_backup: {
    title: 'Auto-Backup',
