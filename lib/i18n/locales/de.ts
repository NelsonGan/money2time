const de = {
  ...
  news: {
    ...
    showcase: {
      ricecal_kcal_left: 'kcal übrig',
      ricecal_carbs: 'Kohlenhydrate',
      ricecal_protein: 'Eiweiß',
      ricecal_fat: 'Fett',
  ...
  widgets: {
    ...
    live: {
      ...
      headline: 'So viel hast du heute verdient',
      badge_on: 'Aktiv',
      rate: '{{amount}}/Std.',
      ends_at: 'Endet {{time}}',
      ...
      start: 'Manuell starten',
      start_sheet_title: 'Uhr starten',
      start_confirm: 'Starten',
      stop: 'Uhr stoppen',
  ...
  transactions: {
    ...
    settleUp: {
      ...
      history_empty_title: 'Noch keine Rückzahlungen',
      history_empty_subtitle: 'Von Freunden und Familie zurückgezahlte Rechnungen erscheinen hier.',
    ...
    selection: {
      ...
      duplicate_title: 'Auf Datum duplizieren',
  ...
  accounts: {
    ...
    loan: {
      ...
      paid_periods_error: 'Muss kleiner als die Laufzeit sein.',
      start_date_label: 'Startdatum',
      start_date_info:
        'Wann der Kredit aufgenommen wurde. Die erste Rate folgt einen Monat später, ihr Tag wird dein Zahltag.',
      collect_account_label: 'Abbuchen von',
      ...
      payment_category_label: 'Kategorie der Zahlung',
      ...
      first_instalment_label: 'Erste Rate',
      instalments_left_label: 'Verbleibende Raten',
      projection_with_date_one: 'Abbezahlt etwa {{date}}, noch {{count}} Rate',
      projection_with_date_other: 'Abbezahlt etwa {{date}}, noch {{count}} Raten',
      ...
      next_due_chip: 'Nächste Fälligkeit {{date}}',
      overdue_chip: 'Überfällig seit {{date}}',
      make_payment: 'Rate zahlen',
      payment_note: 'Kreditrückzahlung',
      due_amount: 'Fälliger Betrag',
      archive_action: 'Kredit archivieren',
      unarchive_action: 'Archivierung aufheben',
      archive_hint:
        'Blendet ihn aus deiner Kontenliste aus. Verlauf und Summen bleiben, und "Archivierte anzeigen" holt ihn zurück.',
      celebration_title: 'Kredit abbezahlt',
      celebration_message: '{{name}} ist vollständig getilgt. Diese Schuld liegt hinter dir.',
      celebration_message_with_amount: '{{name}} ist vollständig getilgt, alle {{amount}}.',
      celebration_archive_cta: 'Archivieren',
      celebration_keep_cta: 'Sichtbar lassen',
    },
    ...
    archived_section: 'Archiviert',
    show_archived_action: 'Archivierte anzeigen ({{count}})',
    hide_archived_action: 'Archivierte ausblenden',
  ...
  pro: {
    ...
    trial_duration_day_few: '{{count}} Tage',
    trial_duration_day_many: '{{count}} Tage',
    trial_duration_week_one: '{{count}} Woche',
    trial_duration_week_other: '{{count}} Wochen',
    trial_duration_week_few: '{{count}} Wochen',
    trial_duration_week_many: '{{count}} Wochen',
    trial_duration_month_one: '{{count}} Monat',
    trial_duration_month_other: '{{count}} Monate',
    trial_duration_month_few: '{{count}} Monate',
    trial_duration_month_many: '{{count}} Monate',
    trial_duration_year_one: '{{count}} Jahr',
    trial_duration_year_other: '{{count}} Jahre',
    trial_duration_year_few: '{{count}} Jahre',
    trial_duration_year_many: '{{count}} Jahre',
    trial_free: '{{duration}} kostenlos',
    trial_cta: 'Kostenlose Testphase starten',
    subscribe: 'Abonnieren',
    buy_lifetime: 'Lifetime kaufen',
    maybe_later: 'Vielleicht später',
    trial_terms: '{{duration}} kostenlos, danach {{price}}.',
    ...
    limit_loans:
      'Im kostenlosen Plan kannst du {{count}} Kredit verfolgen. Upgrade auf Pro für unbegrenzt.',
    badge: 'PRO',
