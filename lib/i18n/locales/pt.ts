const pt = {
  ...
  accounts: {
    ...
    loan: {
      principal_label: 'Valor emprestado',
      principal_hint: 'O valor original do empréstimo. Serve para mostrar quanto já pagou.',
      balance_owed_label: 'Saldo devedor',
      balance_owed_hint: 'O que ainda deve hoje. Os pagamentos reduzem este valor.',
      monthly_payment_label: 'Prestação mensal',
      payment_day_label: 'Dia de pagamento',
      interest_rate_label: 'Taxa de juro (% ao ano)',
      interest_rate_hint:
        'Opcional, usado para estimar a data de quitação. Os juros não são lançados automaticamente.',
      payment_below_interest_warning:
        'Esta prestação é menor do que os juros mensais, por isso o saldo vai crescer em vez de diminuir.',
      ...
      projection_remaining: '{{amount}} em falta',
      projection_interest: 'Cerca de {{amount}} de juros ainda por pagar',
      ...
      archive_hint:
        'Oculta-o das suas contas. O histórico e os totais são mantidos, e pode recuperá-lo nas definições de Contas.',
