const pt = {
  ...
  accounts: {
    ...
    loan: {
      ...
      principal_hint: 'Define o seu progresso de pagamento.',
      balance_owed_label: 'Saldo devedor',
      balance_owed_hint: 'O que ainda deve hoje.',
      ...
      archive_hint: 'Oculta-o das suas contas. O histórico e os totais são mantidos.',
