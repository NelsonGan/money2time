const pt = {
  ...
  add_action: {
    ...
    over_account_limit_message:
      'Você tem {{active}} contas ativas. Para adicionar transações gratuitamente, mantenha no máximo {{count}} contas ativas. Remova as extras, ou assine o Pro. As outras ações continuam disponíveis.',
  ...
  news: {
    pro_trial_accounts: {
      title: 'Teste grátis e mais contas gratuitas',
      trial: {
        title: 'O teste grátis chegou',
        body: 'Se sua conta na loja for elegível, você pode testar o Pro antes de pagar. Abra a página de planos para ver a duração do teste e o valor exato depois dele.',
      },
      accounts: {
        title: 'Mais contas no plano Grátis',
        body: 'O plano Grátis agora inclui {{count}} contas de débito ou crédito, antes eram cinco. Metas e empréstimos continuam com limites próprios. Suas transações existentes e outras ações seguem disponíveis.',
      },
    },
    badge: { ad: 'ANÚNCIO' },
    ricecal: {
    ...
    automations_update: {
      ...
      auto: {
        ...
        body: 'Três novas automações para iOS: aproxime o cartão e o pagamento com Apple Pay se registra sozinho, o Log Screenshot transforma a captura de tela de um pagamento em uma transação escaneada, e o Back Tap abre a entrada rápida com um toque na parte de trás do telefone. Configure na página Automação.',
      },
    },
    ...
    cta: {
      open_accounts: 'Ver contas',
      open_hourly_value_settings: 'Definir horas de trabalho',
      open_add_transaction: 'Adicionar uma transação',
      ...
      open_ricecal: 'Experimentar o RiceCal',
      open_pro_paywall: 'Ver planos Pro',
    ...
    showcase: {
      ...
      item_jacket: 'Casaco',
      goal_trip: 'Viagem ao Japão',
      goal_emergency: 'Fundo de emergência',
      this_month: 'Este mês',
  ...
  widgets: {
    ...
    live: {
      ...
      headline: 'Foi isso que você ganhou hoje',
      badge_on: 'Ativo',
      rate: '{{amount}}/h',
      ...
      start: 'Iniciar manualmente',
      start_sheet_title: 'Ligar o relógio',
      start_confirm: 'Iniciar',
      ...
      schedule_section: 'Programação',
      schedule_tooltip:
        'No iOS 17.2 ou posterior, o Money2Time inicia o relógio para você nesse horário, mesmo com o app fechado. Em versões anteriores, ele envia uma notificação e tocar nela inicia o relógio.',
      schedule_title: 'Iniciar automaticamente',
  ...
  transactions: {
    ...
    settleUp: {
      ...
      history_empty_title: 'Ainda não há reembolsos',
      history_empty_subtitle: 'As contas reembolsadas por amigos e familiares aparecerão aqui.',
  ...
  settings: {
    ...
    auto_log: {
      ...
      auto_categorize_hint:
        'Escolhe uma categoria pelo nome do comerciante, para não perguntar ao pagar.',
      auto_categorize_mapping_link: 'Editar mapeamento de palavras-chave',
      ...
      log_payment_step_create_shortcut: 'Em Get Started, toque em Create New Shortcut.',
      log_payment_step_5: 'Toque em Buscar, digite Money2Time e adicione Log Card Payment.',
      log_payment_step_6:
        'Toque no campo Amount, escolha Select Variable, depois Shortcut Input e selecione Amount. Isso vincula o valor ao cartão tocado.',
      log_payment_step_merchant:
        'Agora toque no campo Merchant e faça o mesmo: Select Variable, Shortcut Input e selecione Merchant.',
      log_payment_step_7: 'Toque em › para expandir a ação e defina o Account deste cartão.',
      log_payment_step_8:
      ...
      new_transaction_step_3: 'Role até a seção Shortcuts e escolha New Transaction.',
  ...
  data_management: {
    ...
    export_excel_title: 'Exportar para Excel',
    export_excel_description:
      'Guarde as suas transações, contas e categorias como uma folha de cálculo .xlsx que pode abrir no Excel, Numbers ou Google Sheets.',
    exporting_excel: 'A criar folha de cálculo...',
    export_excel_error_title: 'Falha ao exportar para Excel',
    export_excel_error_message: 'Não foi possível criar a folha de cálculo. Tente novamente.',
    excel: {
      sheet_transactions: 'Transações',
      sheet_accounts: 'Contas',
      sheet_categories: 'Categorias',
      sheet_recurring: 'Recorrentes',
      column_date: 'Data',
      column_type: 'Tipo',
      column_amount: 'Valor',
      column_currency: 'Moeda',
      column_reporting_amount: 'Valor de referência',
      column_reporting_currency: 'Moeda de referência',
      column_account: 'Conta',
      column_from_account: 'Conta de origem',
      column_to_account: 'Conta de destino',
      column_category: 'Categoria',
      column_subcategory: 'Subcategoria',
      column_note: 'Nota',
      column_sentiment: 'Sentimento',
      column_recurring: 'Recorrente',
      column_name: 'Nome',
      column_group: 'Grupo',
      column_starting_balance: 'Saldo inicial',
      column_include_in_totals: 'Incluir nos totais',
      column_parent: 'Categoria principal',
      column_icon: 'Ícone',
      column_pattern: 'Padrão',
      column_interval: 'Intervalo',
      column_next_run: 'Próxima execução',
      column_end_date: 'Data de fim',
      column_active: 'Ativa',
      value_yes: 'Sim',
      value_no: 'Não',
    },
  ...
  category_icon: {
    ...
    upload_pro_hint: 'Envie a sua própria imagem com o Pro.',
    group_money: 'Dinheiro',
    group_food: 'Comida e bebida',
    group_transport: 'Transporte',
    group_travel: 'Viagens',
    group_home: 'Casa',
    group_bills: 'Contas',
    ...
    group_leisure: 'Lazer',
    group_work: 'Trabalho',
    group_family: 'Família',
    group_other: 'Outros',
    group_smileys: 'Carinhas',
    group_people: 'Pessoas',
    group_animals: 'Animais e natureza',
    group_activities: 'Atividades',
    group_objects: 'Objetos',
    group_symbols: 'Símbolos',
    group_flags: 'Bandeiras',
  },
  categories: {
    title: 'Categorias',
  ...
  accounts: {
    ...
    loan: {
      ...
      effective_rate_hint:
        'Taxa efetiva {{rate}}%. É o que esta taxa fixa custa sobre saldo decrescente.',
      rate_change_title: 'A partir de quando se aplica a nova taxa?',
      rate_change_message:
        'A taxa muda de {{from}}% para {{to}}%. Aplique a partir de hoje para manter os juros já cobrados, ou desde o início se estiver a corrigir um erro.',
      rate_change_from_today: 'A partir de hoje',
      rate_change_from_start: 'Desde o início',
      ...
      paid_periods_error: 'Tem de ser inferior ao prazo.',
      start_date_label: 'Data de início',
      start_date_info:
        'Quando o empréstimo foi contratado. A primeira prestação cai um mês depois e o seu dia passa a ser o dia de pagamento.',
      collect_account_label: 'Debitar de',
      ...
      collect_account_external: 'Este pagamento está configurado em Recorrentes. Edite-o lá.',
      ...
      first_instalment_label: 'Primeira prestação',
      instalments_left_label: 'Prestações restantes',
      projection_with_date_one: 'Quitado por volta de {{date}}, falta {{count}} prestação',
      projection_with_date_other: 'Quitado por volta de {{date}}, faltam {{count}} prestações',
      ...
      next_due_chip: 'Próximo vencimento {{date}}',
      overdue_chip: 'Em atraso desde {{date}}',
      make_payment: 'Fazer um pagamento',
      payment_note: 'Pagamento de empréstimo',
      due_amount: 'Valor a pagar',
      archive_action: 'Arquivar empréstimo',
      unarchive_action: 'Desarquivar empréstimo',
      archive_hint:
        'Oculta-o da lista de contas. O histórico e os totais são mantidos, e "Ver arquivados" traz de volta.',
      celebration_title: 'Empréstimo quitado',
      celebration_message: '{{name}} está totalmente pago. Essa dívida ficou para trás.',
      celebration_message_with_amount: '{{name}} está totalmente pago, os {{amount}} todos.',
      celebration_archive_cta: 'Arquivar',
      celebration_keep_cta: 'Manter visível',
    },
    ...
    archived_section: 'Arquivados',
    show_archived_action: 'Ver arquivados ({{count}})',
    hide_archived_action: 'Ocultar arquivados',
  ...
  pro: {
    ...
    trial_duration_day_many: '{{count}} dias',
    trial_duration_week_one: '{{count}} semana',
    trial_duration_week_other: '{{count}} semanas',
    trial_duration_week_few: '{{count}} semanas',
    trial_duration_week_many: '{{count}} semanas',
    trial_duration_month_one: '{{count}} mês',
    trial_duration_month_other: '{{count}} meses',
    trial_duration_month_few: '{{count}} meses',
    trial_duration_month_many: '{{count}} meses',
    trial_duration_year_one: '{{count}} ano',
    trial_duration_year_other: '{{count}} anos',
    trial_duration_year_few: '{{count}} anos',
    trial_duration_year_many: '{{count}} anos',
    trial_free: '{{duration}} grátis',
    trial_cta: 'Iniciar teste grátis',
    subscribe: 'Assinar',
    buy_lifetime: 'Comprar acesso vitalício',
    maybe_later: 'Talvez mais tarde',
    trial_terms: 'Grátis por {{duration}}, depois {{price}}.',
    plans_heading: 'Escolha seu plano',
    save_percent: 'Economize {{percent}}%',
    per_month_short: '/mês',
    no_commitment: 'Sem compromisso. Cancele quando quiser.',
    ...
    limit_goals:
      'Você pode ter até {{count}} metas de poupança no plano gratuito. Assine o Pro para ilimitado.',
    limit_loans:
      'Pode acompanhar {{count}} empréstimo no plano gratuito. Atualize para Pro para ter ilimitados.',
    badge: 'PRO',
  ...
  goals: {
    ...
    deposit_outside_hint: 'Um presente ou dinheiro de fora, registrado como receita.',
    withdraw_to_account: 'Para uma conta',
    withdraw_to_account_hint: 'Mova o dinheiro de volta para uma das suas contas.',
    withdraw_spend: 'Gastar',
    withdraw_spend_hint: 'Pague algo diretamente desta meta, registrado como despesa.',
    ...
    hide_archived: 'Ocultar arquivadas',
    saved_of_target: '{{saved}} de {{target}}',
    pace_achieved: 'Alcançada',
    pace_on_track: 'No ritmo',
    pace_behind: 'Atrasada',
    name_label: 'Nome da meta',
    name_placeholder: 'ex.: viagem ao Japão',
    add_cover: 'Adicionar foto de capa',
    change_cover: 'Alterar capa',
    remove_cover: 'Remover foto',
    ...
    target_label: 'Valor da meta',
    target_date_toggle: 'Data alvo',
    target_date_hint: 'Opcional. Adiciona à sua meta um ritmo a seguir.',
    target_date_past_error: 'Escolha uma data no futuro.',
    starting_amount_label: 'Já poupado (opcional)',
    auto_save_toggle: 'Poupança automática',
    auto_save_hint: 'Transfira dinheiro automaticamente conforme um cronograma.',
    auto_save_amount_label: 'Valor',
    auto_save_cadence_label: 'Repete',
    cadence_monthly: 'Mensal',
    cadence_weekly: 'Semanal',
    auto_save_source_label: 'Da conta',
    auto_save_source_placeholder: 'Escolha uma conta',
    auto_save_no_source:
    ...
    archive_title: 'Arquivar meta?',
    archive_message:
      'A meta sai da sua lista de metas e qualquer poupança automática para ela é pausada.',
    archive_balance_hint:
      'Ela ainda guarda dinheiro. Você pode sacar primeiro ou mantê-lo guardado aqui.',
    archive_confirm: 'Arquivar',
    unarchive: 'Restaurar meta',
    archived_banner: 'Esta meta está arquivada. Restaure-a para continuar poupando.',
    detail_achieved: 'Meta alcançada! 🎉',
    detail_on_track: 'No ritmo para {{date}}',
    detail_behind: 'Atrasada para {{date}}',
    detail_required_monthly: 'Poupe {{amount}} por mês para recuperar o ritmo.',
    detail_projection: 'Com {{amount}} por mês, você chega lá por volta de {{date}}.',
    deposit: 'Depositar',
    withdraw: 'Sacar',
    activity_title: 'Atividade',
    view_all_activity: 'Ver tudo',
    activity_empty: 'Ainda sem atividade. Faça seu primeiro depósito para começar.',
    activity_transfer: 'Transferência',
    celebration_title: 'Meta alcançada!',
    celebration_message:
      'Você alcançou sua meta {{name}}. Esse é dinheiro de verdade que você guardou.',
    celebration_cta: 'Boa!',
  },
  shareEarn: {
  ...
  notifications: {
    ...
    channel_name: 'Lembretes e atividade',
    content: {
      autolog_title: 'Registrado automaticamente',
      autolog_failure_title: 'Não foi possível registrar um pagamento',
      autolog_failure_body: 'Toque para adicioná-lo manualmente.',
      daily_title: 'Como foi o seu dia?',
      daily_body: 'Reserve 30 segundos para registrar os gastos de hoje enquanto estão frescos.',
      ...
      live_earnings_title: 'Pronto para começar?',
      live_earnings_body: 'Toque para iniciar seu relógio de ganhos ao vivo.',
      live_earnings_started_title: 'Ganhos ao vivo iniciados',
      live_earnings_started_body: 'Seu relógio está contando.',
  ...
  review: {
    ...
    pace_usual: 'Seu normal é {{amount}}',
  ...
  tutorials: {
    title: 'Tutoriais',
    search_placeholder: 'Buscar tutoriais',
    empty_title: 'Nada encontrado',
    empty_description: 'Tente uma palavra mais curta ou o nome da tela que você procura.',
    step_count: '%{count} passos',
    step_counter: '%{current} de %{total}',
    share: 'Compartilhar',
    badge_pro: 'PRO',
    badge_ios: 'iPhone',
