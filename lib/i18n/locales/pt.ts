const pt = {
  ...
  pro: {
    ...
    trial_spotlight_title: 'Experimente tudo antes de pagar',
    trial_spotlight_body: 'Desbloqueie todos os recursos Pro hoje.',
    ...
    trial_cta: 'Iniciar meu teste grátis de {{duration}}',
    trial_terms:
