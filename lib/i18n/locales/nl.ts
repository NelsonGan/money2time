const nl = {
  ...
  pro: {
    ...
    trial_spotlight_title: 'Probeer alles voordat je betaalt',
    trial_spotlight_body: 'Ontgrendel vandaag alle Pro-functies.',
    ...
    trial_cta: 'Start mijn gratis proefperiode van {{duration}}',
