const nl = {
  ...
  accounts: {
    ...
    loan: {
      principal_label: 'Geleend bedrag',
      principal_hint: 'Bepaalt je aflossingsvoortgang.',
      balance_owed_label: 'Openstaand saldo',
      balance_owed_hint: 'Wat je vandaag nog schuldig bent.',
      monthly_payment_label: 'Maandelijkse aflossing',
      payment_day_label: 'Betaaldag',
      interest_rate_label: 'Rente (% per jaar)',
      interest_rate_hint: 'Optioneel. Schat je afloopdatum; rente wordt niet automatisch geboekt.',
      partly_paid_toggle: 'Ik heb hier al iets van afgelost',
      autopay_toggle: 'Automatisch betalen',
      autopay_hint: 'Zet een maandelijkse overboeking op je betaaldag klaar.',
      autopay_source_label: 'Betalen vanaf',
      autopay_source_placeholder: 'Kies een rekening',
      autopay_no_source: 'Nog geen {{currency}}-rekening om vanaf te betalen.',
      autopay_rule_name: 'Aflossing {{name}}',
      payment_below_interest_short: 'Aflossing dekt de rente niet',
      payoff_by_label: 'Afgelost in',
      payments_left_label: 'Termijnen over',
      est_interest_label: 'Gesch. rente',
      ...
      archive_hint: 'Verbergt hem uit je rekeningen. Geschiedenis en totalen blijven bewaard.',
