const nl = {
  ...
  accounts: {
    ...
    loan: {
      ...
      principal_hint: 'Het oorspronkelijke leenbedrag. Laat zien hoeveel je al hebt afgelost.',
      balance_owed_label: 'Openstaand saldo',
      balance_owed_hint: 'Wat je vandaag nog schuldig bent. Aflossingen verlagen dit.',
      monthly_payment_label: 'Maandelijkse aflossing',
      payment_day_label: 'Betaaldag',
      interest_rate_label: 'Rente (% per jaar)',
      interest_rate_hint:
        'Optioneel, gebruikt om je afloopdatum te schatten. Rente wordt niet automatisch geboekt.',
      payment_below_interest_warning:
        'Deze aflossing is lager dan de maandelijkse rente, dus het saldo groeit in plaats van te dalen.',
      ...
      projection_remaining: '{{amount}} resterend',
      projection_interest: 'Nog ongeveer {{amount}} rente te betalen',
      ...
      archive_hint:
        'Verbergt hem uit je rekeningen. Geschiedenis en totalen blijven bewaard, en je haalt hem terug via Rekeningen-instellingen.',
