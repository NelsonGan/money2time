const nl = {
  ...
  add_action: {
    ...
    manual_title: 'Handmatige invoer',
    manual_subtitle: 'Typ het zelf in',
  },
  receiptScan: {
    reading: 'Bon lezen…',
    source_title: 'Bon scannen',
    source_camera: 'Foto maken',
    source_library: 'Kies uit bibliotheek',
    review_title: '{{count}} transacties controleren',
    save_all: 'Alles opslaan ({{count}})',
    remove: 'Verwijderen',
    all_removed: 'Geen transacties meer om op te slaan.',
    note_placeholder: 'Notitie',
    empty_title: 'Geen transacties gevonden',
    empty_body: 'We konden geen transacties van die bon lezen. Probeer een andere foto.',
    busy_title: 'Scanner bezig',
    busy_body: 'De scanner is momenteel bezig. Probeer het zo meteen opnieuw.',
  ...
  settings: {
    ...
    quick_entry: {
      ...
      add_button: {
        ...
        action_manual: 'Handmatige invoer',
  ...
  pro: {
    limit_receipt_scans:
      'Het gratis abonnement bevat {{count}} bonscans per maand. Upgrade naar Pro voor onbeperkt scannen.',
