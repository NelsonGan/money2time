const nl = {
  ...
  transactions: {
    ...
    reimbursements: {
      ...
      recovered_label: 'Terugbetaald',
      empty_title: 'Niets te declareren',
      empty_subtitle:
        'Markeer een uitgave als declarabel, dan wacht die hier tot je je geld terugkrijgt.',
      empty_reimbursed_title: 'Nog niets afgerond',
      empty_reimbursed_subtitle:
        'Declaraties die je als betaald markeert komen hier, mocht je iets ongedaan willen maken.',
      claims_one: '1 declaratie',
      claims_other: '{{count}} declaraties',
      unassigned_payer: 'Niet toegewezen',
      claim_button: 'Declareren',
      claim_sheet_title: 'Deze uitgave declareren',
      claim_sheet_subtitle: 'Houd hem bij tot iemand je terugbetaalt.',
      payer_label: 'Terugbetaald door',
      payer_placeholder: 'Werk, een klant, een verzekeraar',
      claim_amount_label: 'Declaratiebedrag',
      claim_all_label: 'Het hele bedrag declareren',
      claim_all_hint: 'Zet dit uit om maar een deel van de uitgave te declareren.',
      save_claim: 'Declaratie opslaan',
      remove_claim: 'Declaratie verwijderen',
      remove_claim_title: 'Deze declaratie verwijderen?',
      ...
      open_days_other: '{{count}} dagen open',
    },
    settleUp: {
  ...
  pro: {
    ...
    limit_reimbursements:
      'Met het gratis abonnement kun je maximaal {{count}} openstaande declaraties hebben. Rond er een af of ga naar Pro voor onbeperkt.',
    limit_goals:
