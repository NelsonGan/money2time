const nl = {
  ...
  add_action: {
    ...
    over_account_limit_message:
      'Je hebt {{active}} actieve accounts. Om gratis transacties toe te voegen, houd je maximaal {{count}} actieve accounts. Verwijder de extra accounts, of abonneer je op Pro. Andere acties blijven beschikbaar.',
  ...
  receiptScan: {
    ...
    logged_title: 'Uitgave opgeslagen',
    logged_hint: 'Tik om te bekijken of bewerken',
  ...
  widgets: {
    ...
    live: {
      ...
      start: 'Handmatig starten',
      start_sheet_title: 'Klok starten',
  ...
  settings: {
    ...
    workday_display_help:
      'Reken tijdwaarden om op basis van je gebruikelijke werkdag. Alles onder een hele dag blijft in uren staan.',
  ...
  pro: {
    ...
    trial_duration_day_many: '{{count}} dagen',
    trial_duration_week_one: '{{count}} week',
    trial_duration_week_other: '{{count}} weken',
    trial_duration_week_few: '{{count}} weken',
    trial_duration_week_many: '{{count}} weken',
    trial_duration_month_one: '{{count}} maand',
    trial_duration_month_other: '{{count}} maanden',
    trial_duration_month_few: '{{count}} maanden',
    trial_duration_month_many: '{{count}} maanden',
    trial_duration_year_one: '{{count}} jaar',
    trial_duration_year_other: '{{count}} jaar',
    trial_duration_year_few: '{{count}} jaar',
    trial_duration_year_many: '{{count}} jaar',
    trial_free: '{{duration}} gratis',
    trial_cta: 'Start gratis proefperiode',
    subscribe: 'Abonneren',
    buy_lifetime: 'Levenslang kopen',
    maybe_later: 'Misschien later',
    trial_terms: '{{duration}} gratis, daarna {{price}}.',
