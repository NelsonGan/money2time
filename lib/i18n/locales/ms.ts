const ms = {
  ...
  pro: {
    ...
    trial_terms:
      'Percuma selama {{duration}}, kemudian {{price}}. Diperbaharui secara automatik sehingga dibatalkan.',
    plans_heading: 'Pilih pelan anda',
    save_percent: 'Jimat {{percent}}%',
    per_month_short: '/bln',
    no_commitment: 'Diperbaharui secara automatik sehingga dibatalkan.',
