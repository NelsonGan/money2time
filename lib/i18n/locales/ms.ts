const ms = {
  ...
  accounts: {
    ...
    loan: {
      ...
      principal_hint: 'Menetapkan kemajuan bayaran anda.',
      balance_owed_label: 'Baki hutang',
      balance_owed_hint: 'Yang masih anda hutang hari ini.',
      monthly_payment_label: 'Bayaran bulanan',
      payment_day_label: 'Hari bayaran',
      interest_rate_label: 'Kadar faedah (% setahun)',
      interest_rate_hint: 'Pilihan. Menganggar tarikh selesai; faedah tidak direkod automatik.',
      partly_paid_toggle: 'Saya sudah bayar sebahagian',
      autopay_toggle: 'Bayar automatik',
      autopay_hint: 'Mewujudkan pemindahan bulanan pada hari bayaran anda.',
      autopay_source_label: 'Bayar dari',
      autopay_source_placeholder: 'Pilih akaun',
      autopay_no_source: 'Belum ada akaun {{currency}} untuk membayar.',
      autopay_rule_name: 'Bayaran {{name}}',
      payment_below_interest_short: 'Bayaran tidak menampung faedah',
      payoff_by_label: 'Selesai pada',
      payments_left_label: 'Baki bayaran',
      est_interest_label: 'Anggaran faedah',
      ...
      archive_hint: 'Menyembunyikannya daripada senarai akaun. Sejarah dan jumlah kekal.',
