const ms = {
  ...
  review: {
    ...
    delta_flat: 'Sama',
    delta_note_up: 'lebih berat daripada {{previous}}',
    delta_note_down: 'lebih ringan daripada {{previous}}',
    delta_note_flat: 'sama seperti {{previous}}',
    ...
    trend_average: 'purata {{amount}}',
    pace_label: 'Rentak',
    pace_budget_label: 'Bajet',
    pace_budget_title: 'Berbanding bajet anda',
    pace_title: {
      week: 'vs minggu biasa anda',
      month: 'vs bulan biasa anda',
      year: 'vs tahun biasa anda',
    },
    pace_of_budget: '{{spent}} daripada {{target}}',
    pace_average: {
      week: 'Purata {{count}} minggu terakhir anda: {{amount}}',
      month: 'Purata {{count}} bulan terakhir anda: {{amount}}',
      year: 'Purata {{count}} tahun terakhir anda: {{amount}}',
    },
