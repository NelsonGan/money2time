const ms = {
  ...
  transactions: {
    ...
    reimbursements: {
      ...
      recovered_label: 'Dibayar balik',
      empty_title: 'Tiada tuntutan',
      empty_subtitle:
        'Tandakan perbelanjaan sebagai boleh dituntut dan ia menunggu di sini sehingga anda dibayar balik.',
      empty_reimbursed_title: 'Belum ada yang selesai',
      empty_reimbursed_subtitle:
        'Tuntutan yang ditanda telah dibayar akan muncul di sini, kalau anda perlu batalkan.',
      claims_one: '1 tuntutan',
      claims_other: '{{count}} tuntutan',
      unassigned_payer: 'Belum ditetapkan',
      claim_button: 'Tuntut',
      claim_sheet_title: 'Tuntut perbelanjaan ini',
      claim_sheet_subtitle: 'Jejak sehingga seseorang bayar balik kepada anda.',
      payer_label: 'Dibayar balik oleh',
      payer_placeholder: 'Kerja, pelanggan, insurans',
      claim_amount_label: 'Jumlah tuntutan',
      claim_all_label: 'Tuntut jumlah penuh',
      claim_all_hint: 'Matikan untuk menuntut sebahagian perbelanjaan sahaja.',
      save_claim: 'Simpan tuntutan',
      remove_claim: 'Buang tuntutan',
      remove_claim_title: 'Buang tuntutan ini?',
  ...
  pro: {
    ...
    limit_reimbursements:
      'Anda boleh mempunyai sehingga {{count}} tuntutan terbuka pada pelan percuma. Selesaikan satu atau naik taraf ke Pro untuk tanpa had.',
    limit_goals:
  ...
  notifications: {
    ...
    content: {
      ...
      weekly_body: 'Lihat ke mana wang dan masa anda pergi minggu ini.',
      weekly_body_spend:
        'Anda belanja {{amount}} dalam 7 hari lepas. Ketik untuk lihat ke mana ia pergi.',
      weekly_body_spend_hours:
        'Anda belanja {{amount}} dalam 7 hari lepas, bersamaan {{hours}} kerja anda. Ketik untuk lihat ke mana ia pergi.',
    },
  },
  auto_backup: {
