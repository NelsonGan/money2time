const ms = {
  ...
  accounts: {
    ...
    loan: {
      ...
      principal_hint:
        'Jumlah pinjaman asal, digunakan untuk menunjukkan berapa yang anda sudah bayar.',
      balance_owed_label: 'Baki hutang',
      balance_owed_hint: 'Yang masih anda hutang hari ini. Bayaran balik akan mengurangkannya.',
      monthly_payment_label: 'Bayaran bulanan',
      payment_day_label: 'Hari bayaran',
      interest_rate_label: 'Kadar faedah (% setahun)',
      interest_rate_hint:
        'Pilihan, digunakan untuk menganggar tarikh selesai. Faedah tidak direkod secara automatik.',
      payment_below_interest_warning:
        'Bayaran ini lebih kecil daripada faedah bulanan, jadi baki akan bertambah dan bukannya berkurang.',
      ...
      projection_remaining: 'Baki {{amount}}',
      projection_interest: 'Kira-kira {{amount}} faedah masih perlu dibayar',
      ...
      archive_hint:
        'Menyembunyikannya daripada senarai akaun. Sejarah dan jumlah kekal, dan anda boleh dapatkan semula dalam tetapan Akaun.',
