const ms = {
  ...
  add_action: {
    ...
    scan_split_title: 'Kongsi resit',
    scan_split_subtitle: 'Imbas item dan kongsi dengan rakan',
  ...
  transactions: {
    ...
    editor: {
      ...
      split: {
        ...
        method_even: 'Sama rata',
        method_custom: 'Tersuai',
        method_items: 'Item',
        total_label: 'Jumlah',
  ...
  settings: {
    ...
    quick_entry: {
      ...
      add_button: {
        ...
        action_scan_split: 'Imbas resit untuk dibahagi',
        action_none: 'Tiada',
      },
    },
