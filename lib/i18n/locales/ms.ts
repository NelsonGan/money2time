const ms = {
  ...
  add_action: {
    ...
    manual_title: 'Kemasukan manual',
    manual_subtitle: 'Taip sendiri',
  },
  receiptScan: {
    reading: 'Membaca resit…',
    source_title: 'Imbas resit',
    source_camera: 'Ambil foto',
    source_library: 'Pilih dari pustaka',
    review_title: 'Semak {{count}} transaksi',
    save_all: 'Simpan semua ({{count}})',
    remove: 'Buang',
    all_removed: 'Tiada transaksi lagi untuk disimpan.',
    note_placeholder: 'Nota',
    empty_title: 'Tiada transaksi dijumpai',
    empty_body: 'Kami tidak dapat membaca sebarang transaksi daripada resit itu. Cuba foto lain.',
    busy_title: 'Pengimbas sibuk',
    busy_body: 'Pengimbas sedang sibuk sekarang. Sila cuba lagi sebentar.',
  ...
  settings: {
    ...
    quick_entry: {
      ...
      add_button: {
        ...
        action_manual: 'Kemasukan manual',
  ...
  pro: {
    limit_receipt_scans:
      'Pelan percuma termasuk {{count}} imbasan resit sebulan. Naik taraf ke Pro untuk imbasan tanpa had.',
