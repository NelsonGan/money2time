const ms = {
  ...
  add_action: {
    ...
    over_account_limit_message:
      'Anda mempunyai {{active}} akaun aktif. Untuk menambah transaksi secara percuma, kekalkan paling banyak {{count}} akaun aktif. Buang yang berlebihan, atau langgan Pro. Tindakan lain masih tersedia.',
  ...
  receiptScan: {
    ...
    logged_title: 'Perbelanjaan direkodkan',
    logged_hint: 'Ketik untuk semak atau edit',
  ...
  widgets: {
    ...
    live: {
      ...
      headline: 'Sebanyak ini pendapatan anda hari ini',
      badge_on: 'Aktif',
      rate: '{{amount}}/jam',
      ends_at: 'Tamat {{time}}',
      ...
      start: 'Mula secara manual',
      start_sheet_title: 'Mula mengira',
      start_confirm: 'Mula',
  ...
  transactions: {
    ...
    editor: {
      ...
      receipt: {
        ...
        save_success: 'Resit disimpan ke Foto.',
        save_failed: 'Resit tidak dapat disimpan. Semak akses foto dan cuba lagi.',
        crop: 'Crop',
  ...
  settings: {
    ...
    month_cycle: {
      ...
      reset_confirm_message: 'Semua bulan akan bermula semula pada hari {{day}}.',
    },
  ...
  accounts: {
    ...
    loan: {
      ...
      collect_account_external: 'Bayaran ini ditetapkan dalam Berulang. Edit di sana.',
  ...
  pro: {
    ...
    trial_free: 'Percuma {{duration}}',
    trial_cta: 'Mulakan percubaan percuma',
    subscribe: 'Langgan',
    buy_lifetime: 'Beli Lifetime',
    maybe_later: 'Mungkin nanti',
    trial_terms: 'Percuma selama {{duration}}, kemudian {{price}}.',
