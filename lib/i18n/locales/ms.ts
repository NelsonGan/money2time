const ms = {
  ...
  reimbursements: {
    ...
    empty_message: 'Tandakan "Akan dibayar balik" pada satu perbelanjaan untuk melihatnya di sini.',
    ...
    editor_hint: 'Tuntut kemudian.',
    editor_reimbursed_hint: 'Sudah dibayar balik.',
