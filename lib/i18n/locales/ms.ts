const ms = {
  ...
  settings: {
    ...
    auto_log: {
      ...
      usage_unlimited: 'Tanpa had',
      usage_exhausted: 'Log automatik percuma telah habis. Naik taraf ke Pro untuk tanpa had.',
      setup_title: 'Persediaan',
      automation_row: 'Log automatik Apple Pay',
