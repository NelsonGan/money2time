const pl = {
  ...
  add_action: {
    ...
    scan_split_title: 'Podziel rachunek',
    scan_split_subtitle: 'Zeskanuj pozycje i podziel ze znajomymi',
  ...
  transactions: {
    ...
    editor: {
      ...
      split: {
        ...
        add_person: 'Dodaj pozycję/osobę',
        me_label: 'Ja',
        ...
        method_even: 'Równo',
        method_custom: 'Własne',
        method_items: 'Pozycje',
        total_label: 'Razem',
  ...
  settings: {
    ...
    quick_entry: {
      ...
      add_button: {
        ...
        action_scan_split: 'Zeskanuj paragon, aby podzielić',
        action_none: 'Nic',
      },
    },
