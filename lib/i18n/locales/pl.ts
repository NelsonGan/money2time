const pl = {
  ...
  news: {
    ...
    cta: {
      open_accounts: 'Otwórz konta',
      open_hourly_value_settings: 'Ustaw godziny pracy',
      open_add_transaction: 'Dodaj transakcję',
  ...
  widgets: {
    ...
    live: {
      ...
      headline: 'Tyle zarobiłeś dzisiaj',
      badge_on: 'Włączone',
      rate: '{{amount}}/godz.',
      ...
      start: 'Uruchom ręcznie',
      start_sheet_title: 'Włącz licznik',
      start_confirm: 'Uruchom',
  ...
  transactions: {
    ...
    settleUp: {
      ...
      history_empty_title: 'Brak spłat',
      history_empty_subtitle: 'Rachunki spłacone przez znajomych i rodzinę pojawią się tutaj.',
    ...
    selection: {
      duplicate: 'Duplikuj',
      duplicate_title: 'Duplikuj na datę',
    ...
    editor: {
      ...
      receipt: {
        ...
        save_success: 'Paragon zapisano w Zdjęciach.',
        save_failed: 'Nie udało się zapisać paragonu. Sprawdź dostęp do zdjęć i spróbuj ponownie.',
        crop: 'Crop',
  ...
  accounts: {
    ...
    loan: {
      ...
      paid_periods_error: 'Musi być mniejsza niż okres kredytu.',
      start_date_label: 'Data rozpoczęcia',
      start_date_info:
        'Kiedy kredyt został zaciągnięty. Pierwsza rata wypada miesiąc później, a jej dzień staje się dniem płatności.',
      collect_account_label: 'Pobieraj z',
      ...
      collect_account_external: 'Ta spłata jest ustawiona w Cyklicznych. Edytuj ją tam.',
      ...
      balance_owed_label: 'Pozostało do spłaty',
      interest_rate_label: 'Oprocentowanie',
      autopay_rule_name: 'Rata {{name}}',
      payment_below_interest_short: 'Rata nie pokrywa odsetek',
      payoff_by_label: 'Spłata do',
      first_instalment_label: 'Pierwsza rata',
      instalments_left_label: 'Pozostałe raty',
      projection_with_date_one: 'Spłata około {{date}}, została {{count}} rata',
      projection_with_date_other: 'Spłata około {{date}}, zostało rat: {{count}}',
      ...
      next_due_chip: 'Następna rata {{date}}',
      overdue_chip: 'Zaległa od {{date}}',
      make_payment: 'Zrób wpłatę',
      payment_note: 'Spłata kredytu',
      due_amount: 'Kwota do zapłaty',
      archive_action: 'Archiwizuj kredyt',
      unarchive_action: 'Przywróć z archiwum',
      archive_hint:
        'Ukrywa go na liście kont. Historia i sumy zostają, a "Pokaż zarchiwizowane" przywraca go.',
      celebration_title: 'Kredyt spłacony',
      celebration_message: '{{name}} jest w pełni spłacony. Ten dług masz już za sobą.',
      celebration_message_with_amount: '{{name}} jest w pełni spłacony, całe {{amount}}.',
      celebration_archive_cta: 'Archiwizuj',
      celebration_keep_cta: 'Zostaw widoczny',
    },
    ...
    archived_section: 'Zarchiwizowane',
    show_archived_action: 'Pokaż zarchiwizowane ({{count}})',
    hide_archived_action: 'Ukryj zarchiwizowane',
  ...
  pro: {
    ...
    trial_duration_day_few: '{{count}} dni',
    trial_duration_day_many: '{{count}} dni',
    trial_duration_week_one: '{{count}} tydzień',
    trial_duration_week_other: '{{count}} tygodnie',
    trial_duration_week_few: '{{count}} tygodnie',
    trial_duration_week_many: '{{count}} tygodni',
    trial_duration_month_one: '{{count}} miesiąc',
    trial_duration_month_other: '{{count}} miesiące',
    trial_duration_month_few: '{{count}} miesiące',
    trial_duration_month_many: '{{count}} miesięcy',
    trial_duration_year_one: '{{count}} rok',
    trial_duration_year_other: '{{count}} lata',
    trial_duration_year_few: '{{count}} lata',
    trial_duration_year_many: '{{count}} lat',
    trial_free: '{{duration}} bezpłatnie',
    trial_cta: 'Rozpocznij bezpłatny okres próbny',
    subscribe: 'Subskrybuj',
    buy_lifetime: 'Kup dostęp dożywotni',
    maybe_later: 'Może później',
    trial_terms: 'Bezpłatnie przez {{duration}}, potem {{price}}.',
    ...
    limit_loans:
      'W planie darmowym możesz śledzić {{count}} kredyt. Przejdź na Pro, aby mieć bez limitu.',
    badge: 'PRO',
  ...
  reimbursements: {
    ...
    subtitle: 'Wydatki, które ktoś inny odda.',
    count_as_expense_label: 'Licz jako wydatek',
    count_as_expense_hint: 'Wyłączone: wydatki do zwrotu i ich zwroty nie wchodzą do sum wydatków.',
    ...
    editor_label: 'Zwrot oczekujący',
    editor_tooltip: 'Wydatek, który ktoś ci odda. Odzyskaj go na stronie Zwroty kosztów.',
    editor_reimbursed_label: 'Już zwrócone',
