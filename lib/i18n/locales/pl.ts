const pl = {
  ...
  review: {
    ...
    spent_label: {
      week: 'Wydatki tego tygodnia',
      month: 'Wydatki tego miesiąca',
      year: 'Wydatki tego roku',
    },
    previous_period: {
    ...
    delta_note_up: 'więcej niż {{previous}}',
    delta_note_down: 'mniej niż {{previous}}',
    delta_note_flat: 'podobnie jak {{previous}}',
    ...
    trend_title: {
      week: 'Dzień po dniu',
      month: 'Tydzień po tygodniu',
      year: 'Miesiąc po miesiącu',
    },
    trend_average: 'śr. {{amount}}',
    pace_label: 'Tempo',
    pace_budget_label: 'Budżet',
    pace_budget_title: 'Na tle budżetu',
    pace_title: {
      week: 'vs twój zwykły tydzień',
      month: 'vs twój zwykły miesiąc',
      year: 'vs twój zwykły rok',
    },
    pace_of_budget: '{{spent}} z {{target}}',
    pace_average: {
      week: 'Średnia z ostatnich {{count}} tygodni: {{amount}}',
      month: 'Średnia z ostatnich {{count}} miesięcy: {{amount}}',
      year: 'Średnia z ostatnich {{count}} lat: {{amount}}',
    },
    pace_left: 'Pozostało {{amount}}',
    pace_over: '{{amount}} ponad limit',
    categories_title: {
      week: 'Największe kategorie tego tygodnia',
      month: 'Największe kategorie tego miesiąca',
      year: 'Największe kategorie tego roku',
    },
    uncategorized: 'Bez kategorii',
    other_entries: 'jeszcze {{count}}',
    mood_title: {
      week: 'Jak minął tydzień',
      month: 'Jak minął miesiąc',
      year: 'Jak minął rok',
    },
    ...
    standouts_title: {
      week: 'Wyróżniki tego tygodnia',
      month: 'Wyróżniki tego miesiąca',
      year: 'Wyróżniki tego roku',
    },
    ...
    quiet_days_sub: 'Nic nie zapisano',
    of_total: '{{count}} z {{total}}',
    entries_logged: 'Zapisane wpisy',
    entries_logged_sub: {
      week: 'W całym tygodniu',
      month: 'W całym miesiącu',
      year: 'W całym roku',
    },
  },
  budget: {
