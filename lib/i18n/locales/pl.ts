const pl = {
  ...
  accounts: {
    ...
    loan: {
      principal_label: 'Kwota pożyczki',
      principal_hint: 'Pierwotna kwota kredytu. Służy do pokazania, ile już spłaciłeś.',
      balance_owed_label: 'Pozostało do spłaty',
      balance_owed_hint: 'Ile wciąż jesteś winien. Raty obniżają tę kwotę.',
      monthly_payment_label: 'Rata miesięczna',
      payment_day_label: 'Dzień płatności',
      interest_rate_label: 'Oprocentowanie (% w skali roku)',
      interest_rate_hint:
        'Opcjonalne, służy do oszacowania daty spłaty. Odsetki nie są księgowane automatycznie.',
      payment_below_interest_warning:
        'Ta rata jest niższa niż miesięczne odsetki, więc saldo będzie rosło zamiast maleć.',
      ...
      projection_remaining: 'Pozostało {{amount}}',
      projection_interest: 'Około {{amount}} odsetek do zapłaty',
      ...
      archive_hint:
        'Ukrywa go na liście kont. Historia i sumy zostają zachowane, a przywrócisz go w ustawieniach Kont.',
