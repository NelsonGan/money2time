const pl = {
  ...
  pro: {
    ...
    trial_spotlight_title: 'Wypróbuj wszystko, zanim zapłacisz',
    trial_spotlight_body: 'Odblokuj dziś wszystkie funkcje Pro.',
    ...
    trial_cta: 'Rozpocznij bezpłatny okres próbny: {{duration}}',
    trial_terms:
