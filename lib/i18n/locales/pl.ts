const pl = {
  ...
  transactions: {
    ...
    reimbursements: {
      ...
      recovered_label: 'Zwrócono',
      empty_title: 'Nie ma czego rozliczać',
      empty_subtitle: 'Oznacz wydatek jako do zwrotu, a poczeka tutaj, aż dostaniesz pieniądze.',
      empty_reimbursed_title: 'Nic jeszcze nie zamknięte',
      empty_reimbursed_subtitle:
        'Wnioski oznaczone jako opłacone trafiają tutaj, na wypadek gdybyś chciał je cofnąć.',
      claims_one: '1 wniosek',
      claims_other: 'Wnioski: {{count}}',
      unassigned_payer: 'Nieprzypisane',
      claim_button: 'Zwrot',
      claim_sheet_title: 'Zgłoś ten wydatek do zwrotu',
      claim_sheet_subtitle: 'Śledź go, dopóki ktoś Ci nie odda pieniędzy.',
      payer_label: 'Zwraca',
      payer_placeholder: 'Praca, klient, ubezpieczyciel',
      claim_amount_label: 'Kwota wniosku',
      claim_all_label: 'Zgłoś całą kwotę',
      claim_all_hint: 'Wyłącz, aby zgłosić tylko część wydatku.',
      save_claim: 'Zapisz wniosek',
      remove_claim: 'Usuń wniosek',
      remove_claim_title: 'Usunąć ten wniosek?',
      ...
      open_days_other: 'Otwarte od {{count}} dni',
    },
    settleUp: {
  ...
  pro: {
    ...
    limit_reimbursements:
      'W planie darmowym możesz mieć maksymalnie {{count}} otwartych wniosków o zwrot. Zamknij jeden lub przejdź na Pro, aby mieć ich bez limitu.',
    limit_goals:
  ...
  notifications: {
    ...
    content: {
      ...
      weekly_body: 'Zobacz, gdzie w tym tygodniu trafiły twoje pieniądze i czas.',
      weekly_body_spend: 'W ostatnich 7 dniach wydano {{amount}}. Dotknij, by zobaczyć, na co.',
      weekly_body_spend_hours:
        'W ostatnich 7 dniach wydano {{amount}}, czyli {{hours}} twojej pracy. Dotknij, by zobaczyć, na co.',
    },
  },
  auto_backup: {
