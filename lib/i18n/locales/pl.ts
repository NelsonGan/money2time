const pl = {
  ...
  add_action: {
    ...
    manual_title: 'Wpis ręczny',
    manual_subtitle: 'Wpisz samodzielnie',
  },
  receiptScan: {
    reading: 'Odczytywanie paragonu…',
    source_title: 'Skanuj paragon',
    source_camera: 'Zrób zdjęcie',
    source_library: 'Wybierz z biblioteki',
    review_title: 'Sprawdź {{count}} transakcji',
    save_all: 'Zapisz wszystko ({{count}})',
    remove: 'Usuń',
    all_removed: 'Brak transakcji do zapisania.',
    note_placeholder: 'Notatka',
    empty_title: 'Nie znaleziono transakcji',
    empty_body:
      'Nie udało się odczytać żadnych transakcji z tego paragonu. Spróbuj innego zdjęcia.',
    busy_title: 'Skaner zajęty',
    busy_body: 'Skaner jest teraz zajęty. Spróbuj ponownie za chwilę.',
  ...
  pro: {
    limit_receipt_scans:
      'Plan darmowy obejmuje {{count}} skanów paragonów miesięcznie. Przejdź na Pro, aby skanować bez ograniczeń.',
