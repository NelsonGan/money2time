const pl = {
  ...
  pro: {
    ...
    trial_hero_title: 'Wypróbuj Money2Time Pro bezpłatnie przez {{duration}}',
    ...
    trial_terms:
      'Bezpłatnie przez {{duration}}, potem {{price}}. Odnawia się automatycznie do momentu anulowania.',
    plans_heading: 'Wybierz swój plan',
    save_percent: 'Oszczędź {{percent}}%',
    per_month_short: '/mies.',
    no_commitment: 'Odnawia się automatycznie do momentu anulowania.',
