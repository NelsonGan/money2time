const nb = {
  ...
  accounts: {
    ...
    loan: {
      principal_label: 'Lånt beløp',
      principal_hint: 'Angir nedbetalingsstatusen din.',
      balance_owed_label: 'Restgjeld',
      balance_owed_hint: 'Det du fortsatt skylder i dag.',
      monthly_payment_label: 'Månedlig nedbetaling',
      payment_day_label: 'Betalingsdag',
      interest_rate_label: 'Rente (% per år)',
      interest_rate_hint: 'Valgfritt. Anslår sluttdatoen; renter føres ikke automatisk.',
      partly_paid_toggle: 'Jeg har allerede betalt ned noe',
      autopay_toggle: 'Betal automatisk',
      autopay_hint: 'Setter opp en månedlig overføring på betalingsdagen din.',
      autopay_source_label: 'Betal fra',
      autopay_source_placeholder: 'Velg en konto',
      autopay_no_source: 'Ingen {{currency}}-konto å betale fra ennå.',
      autopay_rule_name: 'Nedbetaling {{name}}',
      payment_below_interest_short: 'Innbetalingen dekker ikke renten',
      payoff_by_label: 'Nedbetalt',
      payments_left_label: 'Innbetalinger igjen',
      est_interest_label: 'Anslått rente',
      ...
      archive_hint: 'Skjuler det fra kontoene dine. Historikk og totaler beholdes.',
