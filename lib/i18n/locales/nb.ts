const nb = {
  ...
  reimbursements: {
    ...
    count_as_expense_hint:
      'Av: refunderbare utgifter og tilbakebetalingene deres holdes utenfor forbrukstallene.',
    ...
    empty_message: 'Kryss av for "Skal refunderes" på en utgift for å se den her.',
    ...
    editor_hint: 'Krev den tilbake senere.',
    editor_reimbursed_hint: 'Allerede betalt tilbake.',
