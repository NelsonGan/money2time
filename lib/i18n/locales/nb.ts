const nb = {
  ...
  review: {
    ...
    delta_flat: 'Uendret',
    delta_note_up: 'tyngre enn {{previous}}',
    delta_note_down: 'lettere enn {{previous}}',
    delta_note_flat: 'på linje med {{previous}}',
    ...
    trend_average: 'snitt {{amount}}',
    pace_label: 'Tempo',
    pace_budget_label: 'Budsjett',
    pace_budget_title: 'Mot budsjettet ditt',
    pace_title: {
      week: 'mot en vanlig uke',
      month: 'mot en vanlig måned',
      year: 'mot et vanlig år',
    },
    pace_of_budget: '{{spent}} av {{target}}',
    pace_average: {
      week: 'Snitt for de siste {{count}} ukene: {{amount}}',
      month: 'Snitt for de siste {{count}} månedene: {{amount}}',
      year: 'Snitt for de siste {{count}} årene: {{amount}}',
    },
    pace_left: '{{amount}} igjen',
    pace_over: '{{amount}} over',
    categories_title: {
      week: 'Største kategorier den uken',
      month: 'Største kategorier den måneden',
      year: 'Største kategorier det året',
    },
    uncategorized: 'Uten kategori',
    other_entries: '{{count}} til',
    mood_title: {
      week: 'Hvordan uken føltes',
      month: 'Hvordan måneden føltes',
      year: 'Hvordan året føltes',
    },
    mood_happy: 'Føltes bra',
    mood_neutral: 'Verken eller',
    mood_regret: 'Skulle ikke gjort det',
    standouts_title: {
      week: 'Det som skilte seg ut den uken',
      month: 'Det som skilte seg ut den måneden',
      year: 'Det som skilte seg ut det året',
    },
    biggest_expense: 'Største utgift',
    busiest_day: 'Travleste dag',
    entries_count: '{{count}} oppføringer',
    quiet_days: 'Rolige dager',
    quiet_days_sub: 'Ingenting registrert',
    of_total: '{{count}} av {{total}}',
    entries_logged: 'Registrerte oppføringer',
    entries_logged_sub: {
      week: 'Gjennom uken',
      month: 'Gjennom måneden',
      year: 'Gjennom året',
    },
  },
  budget: {
