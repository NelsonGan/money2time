const nb = {
  ...
  accounts: {
    ...
    loan: {
      ...
      principal_hint: 'Det opprinnelige lånebeløpet. Brukes til å vise hvor mye du har nedbetalt.',
      balance_owed_label: 'Restgjeld',
      balance_owed_hint: 'Det du fortsatt skylder i dag. Innbetalinger reduserer beløpet.',
      monthly_payment_label: 'Månedlig nedbetaling',
      payment_day_label: 'Betalingsdag',
      interest_rate_label: 'Rente (% per år)',
      interest_rate_hint:
        'Valgfritt, brukes til å anslå sluttdatoen. Renter føres ikke automatisk.',
      payment_below_interest_warning:
        'Denne innbetalingen er mindre enn månedsrenten, så gjelden vokser i stedet for å synke.',
      ...
      projection_remaining: '{{amount}} igjen',
      projection_interest: 'Rundt {{amount}} i renter igjen å betale',
      ...
      archive_hint:
        'Skjuler det fra kontoene dine. Historikk og totaler beholdes, og du kan hente det tilbake under Kontoer.',
