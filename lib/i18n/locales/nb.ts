const nb = {
  ...
  add_action: {
    ...
    over_account_limit_message:
      'Du har {{active}} aktive kontoer. For å legge til transaksjoner gratis må du ha høyst {{count}} aktive kontoer. Fjern de ekstra, eller abonner på Pro. Andre handlinger er fortsatt tilgjengelige.',
  ...
  news: {
    pro_trial_accounts: {
      title: 'Gratis prøveperiode og flere gratiskontoer',
      trial: {
        title: 'Gratis prøveperiode er her',
        body: 'Hvis butikkontoen din er kvalifisert, kan du prøve Pro før du betaler. Åpne plansiden for å se hvor lenge prøven varer og nøyaktig pris etterpå.',
      },
      accounts: {
        title: 'Flere kontoer på Gratis',
        body: 'Gratisplanen omfatter nå {{count}} debet- eller kredittkontoer, opp fra fem. Mål og lån har fortsatt egne grenser. Eksisterende transaksjoner og andre handlinger er fortsatt tilgjengelige.',
      },
    },
    badge: { ad: 'ANNONSE' },
    ricecal: {
    ...
    cta: {
      open_accounts: 'Se kontoene',
      open_hourly_value_settings: 'Angi arbeidstimer',
      open_add_transaction: 'Legg til transaksjon',
  ...
  widgets: {
    ...
    live: {
      ...
      headline: 'Så mye har du tjent i dag',
      badge_on: 'På',
      rate: '{{amount}}/t',
      ...
      start: 'Start manuelt',
      start_sheet_title: 'Start klokken',
      start_confirm: 'Start',
      stop: 'Stopp klokken',
  ...
  transactions: {
    ...
    settleUp: {
      ...
      history_empty_title: 'Ingen tilbakebetalinger ennå',
      history_empty_subtitle: 'Regninger som venner og familie betaler tilbake, vises her.',
    ...
    editor: {
      ...
      receipt: {
        ...
        replace: 'Erstatt',
        save_to_photos: 'Lagre i Bilder',
        save_success: 'Kvitteringen er lagret i Bilder.',
        save_failed: 'Kvitteringen kunne ikke lagres. Kontroller bildetilgangen og prøv igjen.',
        crop: 'Crop',
  ...
  insights: {
    ...
    review: 'Gjennomgang av forbruk',
    review_description:
      'Se tilbake på en avsluttet uke, måned eller år: hva som gikk ut, hva du beholdt, og hvordan det føltes.',
  ...
  settings: {
    ...
    month_cycle: {
      ...
      reset_confirm_message: 'Alle måneder starter igjen på dag {{day}}.',
    },
    workday_display: 'Vis tid som arbeidsdager',
    workday_display_help:
      'Regn om tidsverdier ut fra den vanlige arbeidsdagen din. Alt under en hel dag vises fortsatt i timer.',
  ...
  accounts: {
    ...
    loan: {
      ...
      paid_periods_error: 'Må være mindre enn nedbetalingstiden.',
      start_date_label: 'Startdato',
      start_date_info:
        'Da lånet ble tatt opp. Første termin faller en måned senere, og datoen blir betalingsdagen din.',
      collect_account_label: 'Trekk fra',
      ...
      payment_category_label: 'Kategori for innbetaling',
      ...
      payment_below_interest_short: 'Innbetalingen dekker ikke renten',
      payoff_by_label: 'Nedbetalt',
      first_instalment_label: 'Første termin',
      instalments_left_label: 'Terminer igjen',
      projection_with_date_one: 'Nedbetalt rundt {{date}}, {{count}} innbetaling igjen',
      projection_with_date_other: 'Nedbetalt rundt {{date}}, {{count}} innbetalinger igjen',
      ...
      next_due_chip: 'Neste forfall {{date}}',
      overdue_chip: 'Forfalt siden {{date}}',
      make_payment: 'Gjør en innbetaling',
      payment_note: 'Nedbetaling av lån',
      due_amount: 'Beløp til betaling',
      archive_action: 'Arkiver lån',
      unarchive_action: 'Hent ut av arkivet',
      archive_hint:
        'Skjuler det fra kontolisten din. Historikk og totaler beholdes, og "Vis arkiverte" henter det tilbake.',
      celebration_title: 'Lånet er nedbetalt',
      celebration_message: '{{name}} er fullt innfridd. Den gjelden er bak deg.',
      celebration_message_with_amount: '{{name}} er fullt innfridd, alle {{amount}}.',
      celebration_archive_cta: 'Arkiver',
    ...
    archived_section: 'Arkiverte',
    show_archived_action: 'Vis arkiverte ({{count}})',
    hide_archived_action: 'Skjul arkiverte',
  ...
  pro: {
    ...
    trial_duration_day_few: '{{count}} dager',
    trial_duration_day_many: '{{count}} dager',
    trial_duration_week_one: '{{count}} uke',
    trial_duration_week_other: '{{count}} uker',
    trial_duration_week_few: '{{count}} uker',
    trial_duration_week_many: '{{count}} uker',
    ...
    subscribe: 'Abonner',
    buy_lifetime: 'Kjøp livstidsadgang',
    maybe_later: 'Kanskje senere',
    trial_terms: 'Gratis i {{duration}}, deretter {{price}}.',
    ...
    limit_loans: 'Du kan følge {{count}} lån i gratisplanen. Oppgrader til Pro for ubegrenset.',
    badge: 'PRO',
  ...
  notifications: {
    ...
    weekly_review: {
      ...
      description: 'Et sammendrag av uken som nettopp ble avsluttet, på dagen den avsluttes.',
    },
    monthly_review: {
      title: 'Månedlig gjennomgang',
      label: 'Månedlig gjennomgang',
      description: 'Et sammendrag av måneden som nettopp ble avsluttet, på dagen den avsluttes.',
    },
    review: {
      fires_on: 'Kommer',
      fires_on_hint: 'Bestemmes av uke- og månedsstart i Visning-innstillingene.',
  ...
  auto_backup: {
    ...
    google_drive_not_connected_short: 'Ikke tilkoblet',
  ...
  review: {
    ...
    pace_usual: 'Du bruker vanligvis {{amount}}',
    pace_left: '{{amount}} igjen',
    pace_over: '{{amount}} over',
    goals: 'Mål',
    goal_of_target: '{{saved}} av {{target}}',
    categories: 'Kategorier',
    uncategorized: 'Uten kategori',
    other_entries: '{{count}} til',
    mood: 'Hvordan det føltes',
    mood_happy: 'Føltes bra',
    mood_neutral: 'Verken eller',
    mood_regret: 'Skulle ikke gjort det',
    standouts: 'Det som skilte seg ut',
    biggest_expense: 'Største utgift',
    busiest_day: 'Travleste dag',
    entries_count: '{{count}} oppføringer',
    quiet_days: 'Rolige dager',
    of_total: '{{count}} av {{total}}',
    entries_logged: 'Registrerte oppføringer',
  },
  budget: {
    title: 'Budsjett',
  ...
  tutorials: {
    title: 'Veiledninger',
    search_placeholder: 'Søk i veiledninger',
    empty_title: 'Ingen treff',
    empty_description: 'Prøv et kortere ord, eller navnet på skjermen du leter etter.',
    step_count: '%{count} trinn',
    step_counter: '%{current} av %{total}',
    share: 'Del',
    badge_pro: 'PRO',
    badge_ios: 'iPhone',
