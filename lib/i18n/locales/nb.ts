const nb = {
  ...
  pro: {
    ...
    hero_subtitle:
      'Bli ubegrenset og lås opp alle Pro-verktøy, fra kvitteringsskanning til langsiktige trender.',
    ...
    showcase_title: 'Alt du låser opp',
    showcase_subtitle: 'En rask omvisning i hva Pro tilfører hverdagen din.',
    feature_receipt_title: 'Skann og del enhver kvittering',
    feature_receipt_desc:
      'Ta et bilde, så spesifiserer vi den, og deretter deler du den med venner på sekunder.',
    feature_trends_title: 'Se langsiktige trender',
    feature_trends_desc: 'Følg forbruk, inntekt, humør, formue og timelønnen din over tid.',
    feature_albums_title: 'Samle reiser i album',
    feature_albums_desc:
      'Samle en reise i ett album med et forsidebilde, kart og forbruksoversikt.',
    feature_currency_title: 'Følg alle valutaer',
    feature_currency_desc:
      'Registrer forbruk i enhver valuta, med valutakursen frosset i øyeblikket du betalte.',
    feature_budgets_title: 'Planlegg månedlige budsjetter',
    feature_budgets_desc:
      'Sett kategoribudsjetter fra gjenbrukbare maler, og se dem bli brukt opp i sanntid.',
    feature_widgets_title: 'Widgets, tale og mer',
    feature_widgets_desc:
      'Åtte widgets for startskjermen, taleinntasting, App-lås og ubegrenset alt.',
