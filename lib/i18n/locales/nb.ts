const nb = {
  ...
  transactions: {
    ...
    reimbursements: {
      ...
      recovered_label: 'Betalt tilbake',
      empty_title: 'Ingenting å kreve',
      empty_subtitle: 'Merk en utgift som refunderbar, så venter den her til du får pengene.',
      empty_reimbursed_title: 'Ingenting fullført ennå',
      empty_reimbursed_subtitle: 'Krav du merker som betalt havner her, i tilfelle du må angre.',
      claims_one: '1 krav',
      claims_other: '{{count}} krav',
      unassigned_payer: 'Ikke tildelt',
      claim_button: 'Krav',
      claim_sheet_title: 'Krev denne utgiften',
      claim_sheet_subtitle: 'Følg den til noen betaler deg tilbake.',
      payer_label: 'Betales tilbake av',
      payer_placeholder: 'Jobben, en kunde, et forsikringsselskap',
      claim_amount_label: 'Kravbeløp',
      claim_all_label: 'Krev hele beløpet',
      claim_all_hint: 'Slå av for å kreve bare en del av utgiften.',
      save_claim: 'Lagre krav',
      ...
      open_days_other: 'Åpen i {{count}} dager',
    },
    settleUp: {
  ...
  pro: {
    ...
    limit_reimbursements:
      'Du kan ha opptil {{count}} åpne refusjonskrav på gratisplanen. Fullfør ett, eller oppgrader til Pro for ubegrenset.',
    limit_goals:
