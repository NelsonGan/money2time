const es = {
  ...
  review: {
    ...
    spent_label: {
      week: 'Gastado esa semana',
      month: 'Gastado ese mes',
      year: 'Gastado ese año',
    },
    previous_period: {
    ...
    delta_flat: 'Igual',
    delta_note_up: 'más que {{previous}}',
    delta_note_down: 'menos que {{previous}}',
    delta_note_flat: 'en línea con {{previous}}',
    ...
    trend_average: 'prom. {{amount}}',
    pace_label: 'Ritmo',
    pace_budget_label: 'Presupuesto',
    pace_budget_title: 'Frente a tu presupuesto',
    pace_title: {
      week: 'vs. tu semana habitual',
      month: 'vs. tu mes habitual',
      year: 'vs. tu año habitual',
    },
    pace_of_budget: '{{spent}} de {{target}}',
    pace_average: {
      week: 'Promedio de tus últimas {{count}} semanas: {{amount}}',
      month: 'Promedio de tus últimos {{count}} meses: {{amount}}',
      year: 'Promedio de tus últimos {{count}} años: {{amount}}',
    },
    pace_left: '{{amount}} restante',
    pace_over: '{{amount}} de más',
    categories_title: {
      week: 'Categorías más grandes de esa semana',
      month: 'Categorías más grandes de ese mes',
      year: 'Categorías más grandes de ese año',
    },
    uncategorized: 'Sin categoría',
    other_entries: '{{count}} más',
    mood_title: {
      week: 'Cómo se sintió la semana',
      month: 'Cómo se sintió el mes',
      year: 'Cómo se sintió el año',
    },
    mood_happy: 'Se sintió bien',
    mood_neutral: 'Ni bien ni mal',
    mood_regret: 'Ojalá no lo hubieras hecho',
    standouts_title: {
      week: 'Lo que destacó esa semana',
      month: 'Lo que destacó ese mes',
      year: 'Lo que destacó ese año',
    },
    ...
    entries_logged_sub: {
      week: 'A lo largo de la semana',
      month: 'A lo largo del mes',
      year: 'A lo largo del año',
    },
  },
  budget: {
    title: 'Presupuesto',
