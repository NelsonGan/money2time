const es = {
  ...
  transactions: {
    ...
    reimbursements: {
      ...
      owed_label: 'Te deben',
      recovered_label: 'Devuelto',
      empty_title: 'Nada que reclamar',
      empty_subtitle:
        'Marca un gasto como reembolsable y esperará aquí hasta que te devuelvan el dinero.',
      empty_reimbursed_title: 'Aún no hay nada cerrado',
      empty_reimbursed_subtitle:
        'Las reclamaciones que marques como cobradas aparecen aquí, por si necesitas deshacerlas.',
      claims_one: '1 reclamación',
      claims_other: '{{count}} reclamaciones',
      unassigned_payer: 'Sin asignar',
      claim_button: 'Reclamar',
      claim_sheet_title: 'Reclamar este gasto',
      claim_sheet_subtitle: 'Haz seguimiento hasta que alguien te devuelva el dinero.',
      payer_label: 'Te lo devuelve',
      payer_placeholder: 'Trabajo, un cliente, una aseguradora',
      claim_amount_label: 'Importe reclamado',
      claim_all_label: 'Reclamar el importe completo',
      claim_all_hint: 'Desactívalo para reclamar solo una parte del gasto.',
      save_claim: 'Guardar reclamación',
      ...
      open_days_other: 'Abierto {{count}} días',
    },
    settleUp: {
      title: 'Quién te debe',
  ...
  pro: {
    ...
    limit_reimbursements:
      'Puedes tener hasta {{count}} reclamaciones de reembolso abiertas en el plan gratuito. Cierra una o pásate a Pro para tenerlas ilimitadas.',
    limit_goals:
  ...
  notifications: {
    ...
    content: {
      ...
      weekly_body: 'Mira a dónde fueron tu dinero y tu tiempo esta semana.',
      weekly_body_spend: 'Gastaste {{amount}} en los últimos 7 días. Toca para ver a dónde fue.',
      weekly_body_spend_hours:
        'Gastaste {{amount}} en los últimos 7 días, eso equivale a {{hours}} de tu trabajo. Toca para ver a dónde fue.',
    },
  },
  auto_backup: {
