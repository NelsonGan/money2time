const es = {
  ...
  add_action: {
    ...
    over_account_limit_message:
      'Tienes {{active}} cuentas activas. Para añadir transacciones gratis, mantén {{count}} cuentas activas o menos. Elimina las demás, o suscríbete a Pro. Las demás acciones siguen disponibles.',
  ...
  news: {
    pro_trial_accounts: {
      title: 'Prueba gratis y más cuentas gratuitas',
      trial: {
        title: 'Ya hay prueba gratis',
        body: 'Si tu cuenta de la tienda cumple los requisitos, puedes probar Pro antes de pagar. Abre la página de planes para ver cuánto dura la prueba y el importe exacto después.',
      },
      accounts: {
        title: 'Más cuentas en el plan Gratis',
        body: 'El plan Gratis ahora incluye {{count}} cuentas de débito o crédito, antes eran cinco. Las metas y los préstamos mantienen sus propios límites. Tus transacciones y las demás acciones siguen disponibles.',
      },
    },
    badge: { ad: 'ANUNCIO' },
    ricecal: {
    ...
    cta: {
      ...
      open_ricecal: 'Probar RiceCal',
      open_pro_paywall: 'Ver planes Pro',
  ...
  widgets: {
    ...
    live: {
      ...
      headline: 'Esto es lo que has ganado hoy',
      badge_on: 'Activo',
      rate: '{{amount}}/h',
      ...
      start_sheet_title: 'Poner el reloj en marcha',
      ...
      offset_title: 'Empecé a las',
      summary_ends: 'Termina',
      summary_total: 'Total del turno',
      of_total: 'de {{total}}',
      refresh: 'Actualizar',
  ...
  transactions: {
    ...
    settleUp: {
      ...
      history_empty_title: 'Aún no hay reembolsos',
      history_empty_subtitle: 'Las cuentas que paguen tus amigos y familiares aparecerán aquí.',
    ...
    editor: {
      ...
      receipt: {
        ...
        save_success: 'Recibo guardado en Fotos.',
        save_failed:
          'No se pudo guardar el recibo. Comprueba el acceso a Fotos e inténtalo de nuevo.',
        crop: 'Crop',
  ...
  settings: {
    ...
    workday_display_help:
      'Convierte los valores de tiempo según tu jornada laboral habitual. Todo lo que sea menos de una jornada completa se sigue mostrando en horas.',
  ...
  recurring: {
    ...
    due_tomorrow: 'Mañana',
    week_strip_label: 'Próximos 7 días',
    left_this_month: 'Restante este mes',
    paused_section: 'Pausados',
    overdue: 'Vencido',
    show_all_days: 'Todos los días',
    day_due_count: '{{count}} vencen',
  ...
  accounts: {
    ...
    loan: {
      ...
      payment_category_label: 'Categoría del pago',
  ...
  pro: {
    ...
    trial_duration_day_many: '{{count}} días',
    ...
    trial_duration_month_one: '{{count}} mes',
    trial_duration_month_other: '{{count}} meses',
    trial_duration_month_few: '{{count}} meses',
    trial_duration_month_many: '{{count}} meses',
    trial_duration_year_one: '{{count}} año',
    trial_duration_year_other: '{{count}} años',
    trial_duration_year_few: '{{count}} años',
    trial_duration_year_many: '{{count}} años',
    ...
    trial_terms: 'Gratis durante {{duration}}; después, {{price}}.',
