const es = {
  ...
  pro: {
    ...
    trial_spotlight_title: 'Pruébalo todo antes de pagar',
    trial_spotlight_body: 'Desbloquea hoy todas las funciones Pro.',
    ...
    trial_cta: 'Iniciar mi prueba gratis de {{duration}}',
    trial_terms:
