const es = {
  ...
  accounts: {
    ...
    loan: {
      principal_label: 'Importe prestado',
      principal_hint: 'El importe original del préstamo. Sirve para mostrar cuánto has pagado ya.',
      balance_owed_label: 'Saldo pendiente',
      balance_owed_hint: 'Lo que aún debes hoy. Los pagos lo reducen.',
      monthly_payment_label: 'Cuota mensual',
      payment_day_label: 'Día de pago',
      interest_rate_label: 'Tipo de interés (% anual)',
      interest_rate_hint:
        'Opcional, se usa para estimar la fecha de liquidación. Los intereses no se registran automáticamente.',
      payment_below_interest_warning:
        'Esta cuota es menor que el interés mensual, así que el saldo crecerá en lugar de bajar.',
      ...
      projection_remaining: '{{amount}} pendiente',
      projection_interest: 'Quedan unos {{amount}} de intereses por pagar',
      ...
      archive_hint:
        'Lo oculta de tus cuentas. Se conservan el historial y los totales, y puedes recuperarlo en los ajustes de Cuentas.',
