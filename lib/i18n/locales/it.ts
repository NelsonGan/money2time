const it = {
  ...
  pro: {
    ...
    trial_spotlight_title: 'Prova tutto prima di pagare',
    trial_spotlight_body: 'Sblocca oggi tutte le funzioni Pro.',
    ...
    trial_cta: 'Inizia la prova gratuita di {{duration}}',
    trial_terms:
