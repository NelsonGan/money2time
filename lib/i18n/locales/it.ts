const it = {
  ...
  add_action: {
    ...
    over_account_limit_message:
      'Hai {{active}} conti attivi. Per aggiungere transazioni gratis, mantieni al massimo {{count}} conti attivi. Rimuovi quelli in eccesso, oppure abbonati a Pro. Le altre azioni restano disponibili.',
  ...
  news: {
    ...
    cta: {
      open_accounts: 'Vedi i conti',
      open_hourly_value_settings: 'Imposta le ore lavorative',
      open_add_transaction: 'Aggiungi una transazione',
    ...
    showcase: {
      ricecal_kcal_left: 'kcal rimanenti',
      ricecal_carbs: 'Carboidrati',
      ricecal_protein: 'Proteine',
      ricecal_fat: 'Grassi',
      ricecal_nasi_lemak: 'Nasi lemak',
      ricecal_char_kuey_teow: 'Char kuey teow',
      ricecal_chicken_rice: 'Chicken rice',
      ricecal_one_plate: '1 porzione',
      ricecal_kcal: 'kcal',
  ...
  widgets: {
    ...
    live: {
      ...
      headline: 'Ecco quanto hai guadagnato oggi',
      badge_on: 'Attivo',
      rate: '{{amount}}/h',
      ...
      start: 'Avvia manualmente',
      start_sheet_title: 'Avvia il conteggio',
      start_confirm: 'Avvia',
  ...
  transactions: {
    ...
    settleUp: {
      ...
      history_empty_title: 'Ancora nessun rimborso',
      history_empty_subtitle: 'Le spese rimborsate da amici e familiari appariranno qui.',
    ...
    editor: {
      ...
      fx_converted: 'Importo convertito',
      fx_edit: 'Modifica conversione',
      ...
      receipt: {
        ...
        replace: 'Sostituisci',
        save_to_photos: 'Salva in Foto',
        save_success: 'Ricevuta salvata in Foto.',
        save_failed: 'Impossibile salvare la ricevuta. Controlla l’accesso alle foto e riprova.',
        crop: 'Crop',
      ...
      error: {
        ...
        fx_values_invalid: 'Inserisci un tasso di cambio e un importo convertito validi',
  ...
  accounts: {
    ...
    loan: {
      ...
      payment_category_label: 'Categoria del rimborso',
  ...
  pro: {
    ...
    trial_duration_day_few: '{{count}} giorni',
    trial_duration_day_many: '{{count}} giorni',
    trial_duration_week_one: '{{count}} settimana',
    trial_duration_week_other: '{{count}} settimane',
    trial_duration_week_few: '{{count}} settimane',
    trial_duration_week_many: '{{count}} settimane',
    trial_duration_month_one: '{{count}} mese',
    trial_duration_month_other: '{{count}} mesi',
    trial_duration_month_few: '{{count}} mesi',
    trial_duration_month_many: '{{count}} mesi',
    trial_duration_year_one: '{{count}} anno',
    trial_duration_year_other: '{{count}} anni',
    trial_duration_year_few: '{{count}} anni',
    trial_duration_year_many: '{{count}} anni',
    trial_free: '{{duration}} gratis',
    trial_cta: 'Inizia la prova gratuita',
    subscribe: 'Abbonati',
    buy_lifetime: 'Acquista Lifetime',
    maybe_later: 'Magari più tardi',
    trial_terms: 'Gratis per {{duration}}, poi {{price}}.',
  ...
  tutorials: {
    title: 'Tutorial',
    search_placeholder: 'Cerca tutorial',
    empty_title: 'Nessun risultato',
    empty_description: 'Prova con una parola più corta o con il nome della schermata che cerchi.',
    step_count: '%{count} passaggi',
    step_counter: '%{current} di %{total}',
    share: 'Condividi',
    badge_pro: 'PRO',
    badge_ios: 'iPhone',
