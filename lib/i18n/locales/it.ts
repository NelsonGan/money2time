const it = {
  ...
  accounts: {
    ...
    loan: {
      principal_label: 'Importo richiesto',
      principal_hint:
        "L'importo originale del prestito. Serve a mostrare quanto hai già rimborsato.",
      balance_owed_label: 'Debito residuo',
      balance_owed_hint: 'Quanto devi ancora oggi. I rimborsi lo riducono.',
      monthly_payment_label: 'Rata mensile',
      payment_day_label: 'Giorno di pagamento',
      interest_rate_label: 'Tasso di interesse (% annuo)',
      interest_rate_hint:
        'Facoltativo, serve a stimare la data di estinzione. Gli interessi non vengono registrati automaticamente.',
      payment_below_interest_warning:
        'Questa rata è inferiore agli interessi mensili, quindi il debito crescerà invece di diminuire.',
      ...
      projection_remaining: '{{amount}} residui',
      projection_interest: 'Circa {{amount}} di interessi ancora da pagare',
      ...
      archive_hint:
        'Lo nasconde dai tuoi conti. Cronologia e totali restano, e puoi recuperarlo dalle impostazioni Conti.',
