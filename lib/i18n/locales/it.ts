const it = {
  ...
  transactions: {
    ...
    reimbursements: {
      ...
      recovered_label: 'Restituito',
      empty_title: 'Niente da richiedere',
      empty_subtitle:
        'Segna una spesa come rimborsabile e resterà qui finché non ti restituiscono i soldi.',
      empty_reimbursed_title: 'Ancora nulla di chiuso',
      empty_reimbursed_subtitle:
        'Le richieste segnate come pagate finiscono qui, nel caso tu debba annullarle.',
      claims_one: '1 richiesta',
      claims_other: '{{count}} richieste',
      unassigned_payer: 'Non assegnato',
      claim_button: 'Rimborso',
      claim_sheet_title: 'Richiedi il rimborso',
      claim_sheet_subtitle: "Tienila d'occhio finché non ti restituiscono i soldi.",
      payer_label: 'Rimborsato da',
      payer_placeholder: "Lavoro, un cliente, un'assicurazione",
      claim_amount_label: 'Importo richiesto',
      claim_all_label: "Richiedi l'intero importo",
      claim_all_hint: 'Disattiva per richiedere solo una parte della spesa.',
      save_claim: 'Salva richiesta',
      remove_claim: 'Rimuovi richiesta',
      ...
      open_days_other: 'Aperta da {{count}} giorni',
    },
    settleUp: {
  ...
  pro: {
    ...
    limit_reimbursements:
      'Con il piano gratuito puoi avere fino a {{count}} richieste di rimborso aperte. Chiudine una o passa a Pro per averne illimitate.',
    limit_goals:
