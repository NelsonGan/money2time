const it = {
  ...
  pro: {
    ...
    trial_hero_title: 'Prova Money2Time Pro gratis per {{duration}}',
    ...
    trial_terms:
      'Gratis per {{duration}}, poi {{price}}. Si rinnova automaticamente fino alla disdetta.',
    plans_heading: 'Scegli il tuo piano',
    save_percent: 'Risparmia {{percent}}%',
    per_month_short: '/mese',
    no_commitment: 'Si rinnova automaticamente fino alla disdetta.',
