const fr = {
  ...
  add_action: {
    ...
    manual_subtitle: 'Saisissez-la vous-même',
  },
  receiptScan: {
    reading: 'Lecture du reçu…',
    source_title: 'Scanner un reçu',
    source_camera: 'Prendre une photo',
    source_library: 'Choisir dans la galerie',
    review_title: 'Vérifier {{count}} transactions',
    save_all: 'Tout enregistrer ({{count}})',
    remove: 'Retirer',
    all_removed: 'Aucune transaction à enregistrer.',
    note_placeholder: 'Note',
    empty_title: 'Aucune transaction trouvée',
    empty_body: 'Nous n’avons pu lire aucune transaction sur ce reçu. Essayez une autre photo.',
    busy_title: 'Scanner occupé',
    busy_body: 'Le scanner est occupé pour le moment. Veuillez réessayer dans un instant.',
  ...
  pro: {
    limit_receipt_scans:
      'Le forfait gratuit inclut {{count}} scans de reçus par mois. Passez à Pro pour un scan illimité.',
