const fr = {
  ...
  pro: {
    ...
    trial_spotlight_title: 'Essayez tout avant de payer',
    trial_spotlight_body: 'Débloquez toutes les fonctionnalités Pro dès maintenant.',
    ...
    trial_free: '{{duration}} gratuit',
    trial_cta: 'Commencer mon essai gratuit de {{duration}}',
    trial_terms:
