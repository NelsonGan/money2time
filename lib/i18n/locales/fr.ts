const fr = {
  ...
  pro: {
    ...
    trial_hero_title: 'Essayez Money2Time Pro gratuitement pendant {{duration}}',
    ...
    trial_terms:
      'Gratuit pendant {{duration}}, puis {{price}}. Renouvellement automatique jusqu’à résiliation.',
    plans_heading: 'Choisissez votre formule',
    save_percent: 'Économisez {{percent}}%',
    per_month_short: '/mois',
    no_commitment: 'Renouvellement automatique jusqu’à résiliation.',
