const fr = {
  ...
  add_action: {
    ...
    over_account_limit_message:
      'Vous avez {{active}} comptes actifs. Pour ajouter des transactions gratuitement, gardez au plus {{count}} comptes actifs. Supprimez les comptes en trop, ou abonnez-vous à Pro. Les autres actions restent disponibles.',
  ...
  widgets: {
    ...
    live: {
      ...
      start: 'Démarrer manuellement',
      start_sheet_title: 'Lancer le compteur',
      start_confirm: 'Démarrer',
  ...
  transactions: {
    ...
    settleUp: {
      ...
      history_empty_title: 'Aucun remboursement',
      history_empty_subtitle: 'Les factures remboursées par vos proches apparaîtront ici.',
    ...
    editor: {
      ...
      receipt: {
        ...
        save_success: 'Reçu enregistré dans Photos.',
        save_failed: 'Impossible d’enregistrer ce reçu. Vérifiez l’accès aux photos et réessayez.',
        crop: 'Crop',
  ...
  pro: {
    ...
    trial_duration_day_few: '{{count}} jours',
    trial_duration_day_many: '{{count}} jours',
    trial_duration_week_one: '{{count}} semaine',
    trial_duration_week_other: '{{count}} semaines',
    trial_duration_week_few: '{{count}} semaines',
    trial_duration_week_many: '{{count}} semaines',
    trial_duration_month_one: '{{count}} mois',
    trial_duration_month_other: '{{count}} mois',
    trial_duration_month_few: '{{count}} mois',
    trial_duration_month_many: '{{count}} mois',
    trial_duration_year_one: '{{count}} an',
    trial_duration_year_other: '{{count}} ans',
    trial_duration_year_few: '{{count}} ans',
    trial_duration_year_many: '{{count}} ans',
    trial_free: 'Gratuit pendant {{duration}}',
    trial_cta: 'Commencer l’essai gratuit',
    subscribe: 'S’abonner',
    buy_lifetime: 'Acheter l’accès à vie',
    maybe_later: 'Peut-être plus tard',
    trial_terms: 'Gratuit pendant {{duration}}, puis {{price}}.',
  ...
  goals: {
    ...
    remove_cover: 'Supprimer la photo',
