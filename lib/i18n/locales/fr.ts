const fr = {
  ...
  transactions: {
    ...
    reimbursements: {
      ...
      recovered_label: 'Remboursé',
      empty_title: 'Rien à réclamer',
      empty_subtitle:
        "Marquez une dépense comme remboursable et elle vous attend ici jusqu'au versement.",
      empty_reimbursed_title: "Rien de clôturé pour l'instant",
      empty_reimbursed_subtitle:
        'Les demandes marquées comme remboursées arrivent ici, au cas où vous voudriez annuler.',
      claims_one: '1 demande',
      claims_other: '{{count}} demandes',
      unassigned_payer: 'Non attribué',
      claim_button: 'Réclamer',
      claim_sheet_title: 'Réclamer cette dépense',
      claim_sheet_subtitle: "Suivez-la jusqu'à ce qu'on vous rembourse.",
      payer_label: 'Remboursé par',
      payer_placeholder: 'Le travail, un client, une assurance',
      claim_amount_label: 'Montant réclamé',
      claim_all_label: 'Réclamer le montant total',
      claim_all_hint: "Désactivez pour ne réclamer qu'une partie de la dépense.",
      save_claim: 'Enregistrer la demande',
      remove_claim: 'Retirer la demande',
      remove_claim_title: 'Retirer cette demande ?',
      ...
      open_days_other: 'En attente depuis {{count}} jours',
    },
    settleUp: {
  ...
  pro: {
    ...
    limit_reimbursements:
      "Vous pouvez avoir jusqu'à {{count}} demandes de remboursement ouvertes avec l'offre gratuite. Clôturez-en une ou passez à Pro pour un nombre illimité.",
    limit_goals:
