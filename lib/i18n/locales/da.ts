const da = {
  ...
  reimbursements: {
    ...
    count_as_expense_hint:
      'Fra: refunderbare udgifter og deres tilbagebetalinger holdes ude af forbrugstallene.',
    ...
    empty_message: 'Sæt flueben ved "Skal refunderes" på en udgift for at se den her.',
    ...
    editor_hint: 'Kræv den tilbage senere.',
    editor_reimbursed_hint: 'Allerede betalt tilbage.',
