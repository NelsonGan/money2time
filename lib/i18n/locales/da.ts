const da = {
  ...
  transactions: {
    ...
    settleUp: {
      ...
      history_empty_title: 'Ingen tilbagebetalinger endnu',
      history_empty_subtitle: 'Regninger, som venner og familie betaler tilbage, vises her.',
    ...
    editor: {
      ...
      receipt: {
        ...
        replace: 'Erstat',
        save_to_photos: 'Gem i Fotos',
        save_success: 'Kvitteringen er gemt i Fotos.',
        save_failed: 'Kvitteringen kunne ikke gemmes. Kontrollér fotoadgang, og prøv igen.',
        crop: 'Crop',
  ...
  pro: {
    ...
    trial_duration_day_many: '{{count}} dage',
    trial_duration_week_one: '{{count}} uge',
    trial_duration_week_other: '{{count}} uger',
    trial_duration_week_few: '{{count}} uger',
    trial_duration_week_many: '{{count}} uger',
    trial_duration_month_one: '{{count}} måned',
    trial_duration_month_other: '{{count}} måneder',
    trial_duration_month_few: '{{count}} måneder',
    trial_duration_month_many: '{{count}} måneder',
    trial_duration_year_one: '{{count}} år',
    trial_duration_year_other: '{{count}} år',
    trial_duration_year_few: '{{count}} år',
    trial_duration_year_many: '{{count}} år',
    trial_free: '{{duration}} gratis',
    trial_cta: 'Start gratis prøveperiode',
    subscribe: 'Abonnér',
    buy_lifetime: 'Køb livstidsadgang',
    maybe_later: 'Måske senere',
    trial_terms: 'Gratis i {{duration}}, derefter {{price}}.',
