const da = {
  ...
  pro: {
    ...
    trial_spotlight_title: 'Prøv alt, før du betaler',
    trial_spotlight_body: 'Lås op for alle Pro-funktioner i dag.',
    ...
    trial_cta: 'Start min gratis prøveperiode på {{duration}}',
    trial_terms:
