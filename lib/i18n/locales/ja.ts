const ja = {
  ...
  transactions: {
    ...
    reimbursements: {
      title: '立替精算',
      subtitle: '誰かがあとで払い戻してくれる支出です。',
      tile_subtitle: '払い戻し待ち',
      tab_pending: '未精算',
      tab_reimbursed: '精算済み',
      owed_label: '受け取り予定',
      recovered_label: '受け取り済み',
      empty_title: '申請するものはありません',
      empty_subtitle: '支出を精算対象にすると、払い戻されるまでここに残ります。',
      empty_reimbursed_title: 'まだ完了した申請はありません',
      empty_reimbursed_subtitle: '精算済みにした申請はここに入ります。取り消したいときに使えます。',
      claims_one: '1 件',
      claims_other: '{{count}} 件',
      unassigned_payer: '未設定',
      claim_button: '精算',
      claim_sheet_title: 'この支出を精算対象にする',
      claim_sheet_subtitle: '払い戻されるまで記録しておきます。',
      payer_label: '払い戻す相手',
      payer_placeholder: '勤務先、取引先、保険会社',
      claim_amount_label: '申請金額',
      claim_all_label: '全額を申請する',
      claim_all_hint: 'オフにすると支出の一部だけを申請できます。',
      save_claim: '申請を保存',
      remove_claim: '申請を削除',
      remove_claim_title: 'この申請を削除しますか？',
      remove_claim_message: '支出は再び自分の支出として集計されます。お金は動きません。',
      mark_reimbursed: '精算済みにする',
      mark_reimbursed_title: '払い戻されましたか？',
      mark_reimbursed_message: '申請した金額が支出から差し引かれ、支出として集計されなくなります。',
      received_into_label: '入金先',
      received_on_label: '入金日',
      confirm_reimbursed: '確定',
      undo_title: 'この精算を取り消しますか？',
      undo_message: '金額が支出に戻り、入金の振替は削除されます。',
      undo_action: '取り消す',
      pending_badge: '精算',
      reimbursed_badge: '精算済み',
      partial_claim: '{{total}} のうち {{amount}}',
      reimbursed_on: '{{date}} に受け取り',
      select_all: 'すべて選択',
      selected_one: '1 件選択中',
      selected_other: '{{count}} 件選択中',
      mark_claimable: '精算対象にする',
      untitled_expense: '支出',
      open_days_one: '1 日経過',
      open_days_other: '{{count}} 日経過',
    },
    settleUp: {
      title: '未精算の相手',
  ...
  pro: {
    ...
    limit_reimbursements:
      '無料プランでは未精算の申請を {{count}} 件まで登録できます。1 件精算するか、Pro にアップグレードすると無制限になります。',
