const ja = {
  ...
  pro: {
    ...
    hero_subtitle:
      '無制限にアップグレードして、レシートのスキャンから長期トレンドまで、すべてのProツールを解放しましょう。',
    ...
    testimonial_meta: 'Proメンバー',
    showcase_title: '解放されるすべての機能',
    showcase_subtitle: 'Proが毎日にもたらすものをさっとご紹介します。',
    feature_receipt_title: 'あらゆるレシートをスキャンして分割',
    feature_receipt_desc: '写真を撮るだけで明細化し、数秒で友だちと割り勘できます。',
    feature_trends_title: '長期的なトレンドを確認',
    feature_trends_desc: '支出、収入、気分、純資産、そして時給の推移を時系列で追えます。',
    feature_albums_title: '旅行をアルバムにまとめる',
    feature_albums_desc:
      '旅行をカバー写真、地図、支出の内訳とともに1つのアルバムにまとめられます。',
    feature_currency_title: 'あらゆる通貨を管理',
    feature_currency_desc: '支払った瞬間の為替レートを固定して、どんな通貨でも支出を記録できます。',
    feature_budgets_title: '毎月の予算を立てる',
    feature_budgets_desc:
      '再利用できるテンプレートからカテゴリ別の予算を設定し、消化状況をリアルタイムで確認できます。',
    feature_widgets_title: 'ウィジェット、音声入力、その他いろいろ',
    feature_widgets_desc:
      'ホーム画面ウィジェット8種、音声入力、アプリロック、そしてすべてが無制限に。',
