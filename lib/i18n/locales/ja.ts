const ja = {
  ...
  transactions: {
    ...
    settleUp: {
      ...
      history_empty_title: '返済履歴はまだありません',
      history_empty_subtitle: '友人や家族が返済した請求がここに表示されます。',
  ...
  accounts: {
    ...
    loan: {
      ...
      interest_model_reducing: '残高逓減',
      interest_model_flat: '元金定額',
      interest_model_info:
        '残高逓減: 利息は毎月の残債に対してかかるため、多めに払ったり早く払ったりすると利息が減ります。多くの住宅ローンはこの方式です。元金定額: 利息は借入額全体に対して一度だけ計算されて最初に上乗せされるため、早く払うと完済は早まりますが利息は減りません。多くの自動車ローンや個人ローンはこの方式です。',
  ...
  pro: {
    ...
    trial_duration_day_many: '{{count}}日間',
    trial_duration_week_one: '{{count}}週間',
    trial_duration_week_other: '{{count}}週間',
    trial_duration_week_few: '{{count}}週間',
    trial_duration_week_many: '{{count}}週間',
    trial_duration_month_one: '{{count}}か月',
    trial_duration_month_other: '{{count}}か月',
    trial_duration_month_few: '{{count}}か月',
    trial_duration_month_many: '{{count}}か月',
    trial_duration_year_one: '{{count}}年間',
    trial_duration_year_other: '{{count}}年間',
    trial_duration_year_few: '{{count}}年間',
    trial_duration_year_many: '{{count}}年間',
    trial_free: '{{duration}}無料',
    trial_cta: '無料トライアルを開始',
    subscribe: '購読する',
    buy_lifetime: '生涯プランを購入',
    maybe_later: 'あとで',
    trial_terms: '{{duration}}無料、その後{{price}}。',
