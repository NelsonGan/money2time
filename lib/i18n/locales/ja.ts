const ja = {
  ...
  review: {
    ...
    delta_flat: '横ばい',
    delta_note_up: '{{previous}}より多め',
    delta_note_down: '{{previous}}より少なめ',
    delta_note_flat: '{{previous}}とほぼ同じ',
    ...
    trend_average: '平均 {{amount}}',
    pace_label: 'ペース',
    pace_budget_label: '予算',
    pace_budget_title: '予算との比較',
    pace_title: {
      week: 'いつもの週との比較',
      month: 'いつもの月との比較',
      year: 'いつもの年との比較',
    ...
    pace_average: {
      week: '直近 {{count}} 週間の平均: {{amount}}',
      month: '直近 {{count}} か月の平均: {{amount}}',
      year: '直近 {{count}} 年の平均: {{amount}}',
    },
    pace_left: '残り {{amount}}',
    pace_over: '{{amount}} 超過',
    categories_title: {
