const ja = {
  ...
  accounts: {
    ...
    loan: {
      principal_label: '借入額',
      principal_hint: '返済の進捗を計算します。',
      balance_owed_label: '残高',
      balance_owed_hint: '現在の残債です。',
      monthly_payment_label: '毎月の返済額',
      payment_day_label: '返済日',
      interest_rate_label: '金利（年率 %）',
      interest_rate_hint: '任意。完済時期の目安に使います。利息は自動計上されません。',
      partly_paid_toggle: 'すでに一部返済している',
      autopay_toggle: '自動で返済',
      autopay_hint: '返済日に毎月の振替を作成します。',
      autopay_source_label: '引き落とし口座',
      autopay_source_placeholder: '口座を選択',
      autopay_no_source: '返済に使える {{currency}} の口座がありません。',
      autopay_rule_name: '{{name}} の返済',
      payment_below_interest_short: '返済額が利息に届いていません',
      payoff_by_label: '完済時期',
      payments_left_label: '残り回数',
      est_interest_label: '利息（概算）',
      ...
      archive_hint: '口座一覧から隠します。履歴と合計は残ります。',
