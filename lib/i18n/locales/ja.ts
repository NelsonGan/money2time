const ja = {
  ...
  accounts: {
    ...
    loan: {
      principal_label: '借入額',
      principal_hint: '当初の借入額です。返済がどこまで進んだかを示すのに使います。',
      balance_owed_label: '残高',
      balance_owed_hint: '現在の残債です。返済すると減っていきます。',
      monthly_payment_label: '毎月の返済額',
      payment_day_label: '返済日',
      interest_rate_label: '金利（年率 %）',
      interest_rate_hint: '任意です。完済時期の目安に使います。利息は自動では計上されません。',
      payment_below_interest_warning:
        'この返済額は毎月の利息より少ないため、残高は減らずに増えていきます。',
      ...
      projection_remaining: '残り {{amount}}',
      projection_interest: '利息は残り約 {{amount}}',
      ...
      archive_hint: '口座一覧から隠します。履歴と合計は残り、口座設定から戻せます。',
