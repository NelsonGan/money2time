const vi = {
  ...
  add_action: {
    ...
    manual_subtitle: 'Tự bạn nhập vào',
  },
  receiptScan: {
    reading: 'Đang đọc hóa đơn…',
    source_title: 'Quét hóa đơn',
    source_camera: 'Chụp ảnh',
    source_library: 'Chọn từ thư viện',
    review_title: 'Xem lại {{count}} giao dịch',
    save_all: 'Lưu tất cả ({{count}})',
    remove: 'Xóa',
    all_removed: 'Không còn giao dịch nào để lưu.',
    note_placeholder: 'Ghi chú',
    empty_title: 'Không tìm thấy giao dịch',
    empty_body: 'Chúng tôi không thể đọc được giao dịch nào từ hóa đơn đó. Hãy thử ảnh khác.',
    busy_title: 'Máy quét đang bận',
    busy_body: 'Máy quét hiện đang bận. Vui lòng thử lại sau giây lát.',
  ...
  pro: {
    limit_receipt_scans:
      'Gói miễn phí bao gồm {{count}} lần quét hóa đơn mỗi tháng. Nâng cấp lên Pro để quét không giới hạn.',
