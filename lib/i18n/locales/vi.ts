const vi = {
  ...
  accounts: {
    ...
    loan: {
      ...
      principal_hint: 'Dùng để tính tiến độ trả nợ.',
      balance_owed_label: 'Dư nợ',
      balance_owed_hint: 'Số tiền bạn còn nợ hôm nay.',
      monthly_payment_label: 'Trả góp hằng tháng',
      payment_day_label: 'Ngày thanh toán',
      interest_rate_label: 'Lãi suất (% mỗi năm)',
      interest_rate_hint: 'Tùy chọn. Ước tính ngày tất toán; lãi không được ghi nhận tự động.',
      partly_paid_toggle: 'Tôi đã trả được một phần',
      autopay_toggle: 'Trả tự động',
      autopay_hint: 'Tạo lệnh chuyển tiền hằng tháng vào ngày thanh toán.',
      autopay_source_label: 'Trả từ',
      autopay_source_placeholder: 'Chọn tài khoản',
      autopay_no_source: 'Chưa có tài khoản {{currency}} để trả.',
      autopay_rule_name: 'Trả nợ {{name}}',
      payment_below_interest_short: 'Khoản trả không đủ bù lãi',
      payoff_by_label: 'Tất toán vào',
      payments_left_label: 'Kỳ còn lại',
      est_interest_label: 'Lãi ước tính',
      ...
      archive_hint: 'Ẩn khỏi danh sách tài khoản. Lịch sử và tổng số vẫn được giữ.',
