const vi = {
  ...
  pro: {
    ...
    trial_spotlight_title: 'Dùng thử mọi tính năng trước khi trả phí',
    trial_spotlight_body: 'Mở khóa mọi tính năng Pro ngay hôm nay.',
    ...
    trial_cta: 'Bắt đầu dùng thử miễn phí {{duration}}',
    trial_terms:
