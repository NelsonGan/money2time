const vi = {
  ...
  accounts: {
    ...
    loan: {
      ...
      principal_hint: 'Số tiền vay ban đầu, dùng để hiển thị bạn đã trả được bao nhiêu.',
      balance_owed_label: 'Dư nợ',
      balance_owed_hint: 'Số tiền bạn còn nợ hôm nay. Mỗi lần trả sẽ giảm số này.',
      monthly_payment_label: 'Trả góp hằng tháng',
      payment_day_label: 'Ngày thanh toán',
      interest_rate_label: 'Lãi suất (% mỗi năm)',
      interest_rate_hint:
        'Tùy chọn, dùng để ước tính ngày tất toán. Lãi không được ghi nhận tự động.',
      payment_below_interest_warning:
        'Khoản trả này nhỏ hơn lãi hằng tháng nên dư nợ sẽ tăng thay vì giảm.',
      ...
      projection_remaining: 'Còn {{amount}}',
      projection_interest: 'Còn khoảng {{amount}} tiền lãi phải trả',
      ...
      archive_hint:
        'Ẩn khỏi danh sách tài khoản. Lịch sử và tổng số vẫn được giữ, bạn có thể lấy lại trong cài đặt Tài khoản.',
