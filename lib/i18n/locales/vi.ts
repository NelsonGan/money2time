const vi = {
  ...
  settings: {
    ...
    auto_log: {
      ...
      backtap_action_label: 'Back Tap mở',
      step_counter: '%{current} trên %{total}',
      tutorial_step_1: 'Mở Phím tắt. Chuyển đến tab Tự động hóa.',
      tutorial_step_2: 'Chạm +, rồi chọn Transaction.',
      tutorial_step_3: 'Chọn thẻ của bạn. Chọn Run Immediately và tắt Notify When Run.',
      tutorial_step_4: 'Thêm hành động "Log Transaction" từ Money2Time.',
      tutorial_step_5: 'Đặt Amount và Merchant thành các biến Shortcut Input.',
      tutorial_step_6:
        'Chọn tài khoản của thẻ này. Để Category ở Ask Each Time để chọn khi thanh toán.',
      tutorial_step_7: 'Bỏ qua thông báo thì giao dịch vẫn được ghi với danh mục mặc định.',
      backtap_step_1:
