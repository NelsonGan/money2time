const vi = {
  ...
  transactions: {
    ...
    reimbursements: {
      ...
      recovered_label: 'Đã trả lại',
      empty_title: 'Không có gì để yêu cầu',
      empty_subtitle:
        'Đánh dấu một khoản chi là có thể hoàn ứng, nó sẽ chờ ở đây cho tới khi bạn nhận lại tiền.',
      empty_reimbursed_title: 'Chưa có khoản nào hoàn tất',
      empty_reimbursed_subtitle:
        'Những yêu cầu bạn đánh dấu đã trả sẽ nằm ở đây, phòng khi cần hoàn tác.',
      claims_one: '1 yêu cầu',
      claims_other: '{{count}} yêu cầu',
      unassigned_payer: 'Chưa chỉ định',
      claim_button: 'Hoàn ứng',
      claim_sheet_title: 'Yêu cầu hoàn khoản chi này',
      claim_sheet_subtitle: 'Theo dõi cho tới khi có người trả lại tiền cho bạn.',
      payer_label: 'Người hoàn trả',
      payer_placeholder: 'Công ty, khách hàng, bảo hiểm',
      claim_amount_label: 'Số tiền yêu cầu',
      claim_all_label: 'Yêu cầu toàn bộ số tiền',
      claim_all_hint: 'Tắt để chỉ yêu cầu một phần khoản chi.',
      save_claim: 'Lưu yêu cầu',
      remove_claim: 'Xóa yêu cầu',
      remove_claim_title: 'Xóa yêu cầu này?',
      ...
      open_days_other: 'Chờ {{count}} ngày',
    },
    settleUp: {
      title: 'Ai nợ bạn',
  ...
  pro: {
    ...
    limit_reimbursements:
      'Gói miễn phí cho phép tối đa {{count}} yêu cầu hoàn ứng đang mở. Hãy xử lý một yêu cầu hoặc nâng cấp lên Pro để dùng không giới hạn.',
    limit_goals:
  ...
  notifications: {
    ...
    content: {
      ...
      weekly_body: 'Xem tiền và thời gian của bạn đã đi đâu trong tuần này.',
      weekly_body_spend: 'Bạn đã chi {{amount}} trong 7 ngày qua. Nhấn để xem chi vào đâu.',
      weekly_body_spend_hours:
        'Bạn đã chi {{amount}} trong 7 ngày qua, tương đương {{hours}} làm việc của bạn. Nhấn để xem chi vào đâu.',
    },
  },
  auto_backup: {
