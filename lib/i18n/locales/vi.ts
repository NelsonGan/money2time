const vi = {
  ...
  add_action: {
    ...
    scan_split_title: 'Chia hóa đơn',
    scan_split_subtitle: 'Quét các món và chia với bạn bè',
  ...
  transactions: {
    ...
    editor: {
      ...
      split: {
        ...
        method_even: 'Chia đều',
        method_custom: 'Tùy chỉnh',
        method_items: 'Món',
        total_label: 'Tổng',
  ...
  settings: {
    ...
    quick_entry: {
      ...
      add_button: {
        ...
        action_scan_split: 'Quét hóa đơn để chia',
