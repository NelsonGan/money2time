const vi = {
  ...
  add_action: {
    ...
    over_account_limit_message:
      'Bạn có {{active}} tài khoản đang hoạt động. Để thêm giao dịch miễn phí, hãy giữ tối đa {{count}} tài khoản đang hoạt động. Xóa các tài khoản dư, hoặc đăng ký Pro. Các thao tác khác vẫn dùng được.',
  ...
  widgets: {
    ...
    live: {
      ...
      start: 'Bắt đầu thủ công',
      start_sheet_title: 'Bắt đầu đếm',
      start_confirm: 'Bắt đầu',
      stop: 'Dừng đếm',
      ...
      schedule_section: 'Lịch',
      schedule_tooltip:
        'Trên iOS 17.2 trở lên, Money2Time bắt đầu tính giờ giúp bạn vào lúc này, ngay cả khi ứng dụng đã đóng. Trên phiên bản cũ hơn, ứng dụng gửi một thông báo và chạm vào đó để bắt đầu tính giờ.',
      schedule_title: 'Tự động bắt đầu',
  ...
  transactions: {
    ...
    settleUp: {
      ...
      history_empty_title: 'Chưa có khoản hoàn trả',
      history_empty_subtitle: 'Các hóa đơn được bạn bè và gia đình hoàn trả sẽ xuất hiện ở đây.',
    ...
    editor: {
      ...
      receipt: {
        ...
        replace: 'Thay thế',
        save_to_photos: 'Lưu vào Ảnh',
        save_success: 'Đã lưu biên nhận vào Ảnh.',
        save_failed: 'Không thể lưu biên nhận. Hãy kiểm tra quyền truy cập ảnh rồi thử lại.',
        crop: 'Crop',
  ...
  pro: {
    ...
    trial_duration_day_many: '{{count}} ngày',
    trial_duration_week_one: '{{count}} tuần',
    trial_duration_week_other: '{{count}} tuần',
    trial_duration_week_few: '{{count}} tuần',
    trial_duration_week_many: '{{count}} tuần',
    trial_duration_month_one: '{{count}} tháng',
    trial_duration_month_other: '{{count}} tháng',
    trial_duration_month_few: '{{count}} tháng',
    trial_duration_month_many: '{{count}} tháng',
    trial_duration_year_one: '{{count}} năm',
    trial_duration_year_other: '{{count}} năm',
    trial_duration_year_few: '{{count}} năm',
    trial_duration_year_many: '{{count}} năm',
    trial_free: 'Miễn phí {{duration}}',
    trial_cta: 'Bắt đầu dùng thử miễn phí',
    subscribe: 'Đăng ký',
    buy_lifetime: 'Mua gói trọn đời',
    maybe_later: 'Có thể để sau',
    trial_terms: 'Miễn phí trong {{duration}}, sau đó {{price}}.',
  ...
  notifications: {
    ...
    content: {
      ...
      live_earnings_started_title: 'Đã bắt đầu thu nhập trực tiếp',
      live_earnings_started_body: 'Đồng hồ của bạn đang chạy.',
