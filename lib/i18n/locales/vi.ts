const vi = {
  ...
  reimbursements: {
    ...
    count_as_expense_hint: 'Tắt thì khoản chi được hoàn và tiền quay về không vào tổng chi tiêu.',
    pending_title: 'Đang chờ hoàn',
    settled_title: 'Đã hoàn',
    pending_total_label: 'Bạn sẽ nhận lại',
    empty_title: 'Không có gì để đòi lại',
    empty_message: 'Đánh dấu "Sẽ được hoàn" cho một khoản chi để thấy nó ở đây.',
    ...
    editor_hint: 'Đòi lại sau.',
    editor_reimbursed_hint: 'Đã hoàn rồi.',
