const vi = {
  ...
  review: {
    ...
    spent_label: {
      week: 'Đã chi trong tuần đó',
      month: 'Đã chi trong tháng đó',
      year: 'Đã chi trong năm đó',
    },
    previous_period: {
      week: 'tuần trước đó',
      month: 'tháng trước đó',
      year: 'năm trước đó',
    },
    delta_flat: 'Đi ngang',
    delta_note_up: 'nhiều hơn {{previous}}',
    delta_note_down: 'ít hơn {{previous}}',
    delta_note_flat: 'ngang với {{previous}}',
    ...
    trend_title: {
      week: 'Theo từng ngày',
      month: 'Theo từng tuần',
      year: 'Theo từng tháng',
    },
    trend_average: 'TB {{amount}}',
    pace_label: 'Nhịp chi',
    pace_budget_label: 'Ngân sách',
    pace_budget_title: 'So với ngân sách của bạn',
    pace_title: {
      week: 'So với tuần thường lệ',
      month: 'So với tháng thường lệ',
      year: 'So với năm thường lệ',
    },
    pace_of_budget: '{{spent}} trên {{target}}',
    pace_average: {
      week: 'Trung bình {{count}} tuần gần nhất: {{amount}}',
      month: 'Trung bình {{count}} tháng gần nhất: {{amount}}',
      year: 'Trung bình {{count}} năm gần nhất: {{amount}}',
    },
    pace_left: 'còn {{amount}}',
    pace_over: 'vượt {{amount}}',
    categories_title: {
      week: 'Danh mục lớn nhất tuần đó',
      month: 'Danh mục lớn nhất tháng đó',
      year: 'Danh mục lớn nhất năm đó',
    },
    uncategorized: 'Chưa phân loại',
    other_entries: 'thêm {{count}} mục',
    mood_title: {
      week: 'Cảm giác về tuần đó',
      month: 'Cảm giác về tháng đó',
      year: 'Cảm giác về năm đó',
    },
    mood_happy: 'Thấy đáng',
    mood_neutral: 'Bình thường',
    mood_regret: 'Giá như đừng chi',
    standouts_title: {
      week: 'Nổi bật trong tuần đó',
      month: 'Nổi bật trong tháng đó',
      year: 'Nổi bật trong năm đó',
    },
    biggest_expense: 'Khoản chi lớn nhất',
    busiest_day: 'Ngày bận rộn nhất',
    entries_count: '{{count}} mục',
    quiet_days: 'Ngày yên ắng',
    quiet_days_sub: 'Không ghi gì',
    of_total: '{{count}} trên {{total}}',
    entries_logged: 'Số mục đã ghi',
    entries_logged_sub: {
      week: 'Trong cả tuần',
      month: 'Trong cả tháng',
      year: 'Trong cả năm',
    },
  },
  budget: {
