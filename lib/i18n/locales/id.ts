const id = {
  ...
  add_action: {
    ...
    manual_title: 'Entri manual',
    manual_subtitle: 'Ketik sendiri',
  },
  receiptScan: {
    reading: 'Membaca struk…',
    source_title: 'Pindai struk',
    source_camera: 'Ambil foto',
    source_library: 'Pilih dari galeri',
    review_title: 'Tinjau {{count}} transaksi',
    save_all: 'Simpan semua ({{count}})',
    remove: 'Hapus',
    all_removed: 'Tidak ada transaksi tersisa untuk disimpan.',
    note_placeholder: 'Catatan',
    empty_title: 'Tidak ada transaksi ditemukan',
    empty_body: 'Kami tidak dapat membaca transaksi apa pun dari struk itu. Coba foto lain.',
    busy_title: 'Pemindai sibuk',
    busy_body: 'Pemindai sedang sibuk saat ini. Silakan coba lagi sebentar.',
  ...
  pro: {
    limit_receipt_scans:
      'Paket gratis mencakup {{count}} pemindaian struk per bulan. Tingkatkan ke Pro untuk pemindaian tanpa batas.',
