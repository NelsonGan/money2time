const id = {
  ...
  transactions: {
    ...
    reimbursements: {
      ...
      recovered_label: 'Sudah dikembalikan',
      empty_title: 'Tidak ada yang diklaim',
      empty_subtitle:
        'Tandai pengeluaran sebagai dapat diklaim, lalu menunggu di sini sampai uangnya kembali.',
      empty_reimbursed_title: 'Belum ada yang selesai',
      empty_reimbursed_subtitle:
        'Klaim yang Anda tandai sudah dibayar muncul di sini, kalau perlu dibatalkan.',
      claims_one: '1 klaim',
      claims_other: '{{count}} klaim',
      unassigned_payer: 'Belum ditentukan',
      claim_button: 'Klaim',
      claim_sheet_title: 'Klaim pengeluaran ini',
      claim_sheet_subtitle: 'Pantau sampai ada yang mengembalikan uangnya.',
      payer_label: 'Diganti oleh',
      payer_placeholder: 'Kantor, klien, asuransi',
      claim_amount_label: 'Jumlah klaim',
      claim_all_label: 'Klaim jumlah penuh',
      claim_all_hint: 'Matikan untuk mengklaim sebagian pengeluaran saja.',
      save_claim: 'Simpan klaim',
      remove_claim: 'Hapus klaim',
      remove_claim_title: 'Hapus klaim ini?',
      ...
      open_days_other: 'Terbuka {{count}} hari',
    },
    settleUp: {
  ...
  pro: {
    ...
    limit_reimbursements:
      'Anda bisa punya hingga {{count}} klaim penggantian terbuka di paket gratis. Selesaikan satu atau tingkatkan ke Pro untuk tanpa batas.',
    limit_goals:
  ...
  notifications: {
    ...
    content: {
      ...
      weekly_body: 'Lihat ke mana uang dan waktumu pergi minggu ini.',
      weekly_body_spend:
        'Kamu menghabiskan {{amount}} dalam 7 hari terakhir. Ketuk untuk melihat ke mana perginya.',
      weekly_body_spend_hours:
        'Kamu menghabiskan {{amount}} dalam 7 hari terakhir, setara dengan {{hours}} kerjamu. Ketuk untuk melihat ke mana perginya.',
    },
  },
  auto_backup: {
