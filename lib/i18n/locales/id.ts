const id = {
  ...
  add_action: {
    ...
    over_account_limit_message:
      'Anda memiliki {{active}} akun aktif. Untuk menambahkan transaksi secara gratis, pertahankan maksimal {{count}} akun aktif. Hapus yang berlebih, atau berlangganan Pro. Tindakan lain tetap tersedia.',
  ...
  widgets: {
    ...
    live: {
      ...
      headline: 'Segini penghasilan Anda hari ini',
      badge_on: 'Aktif',
      rate: '{{amount}}/jam',
      ...
      start: 'Mulai manual',
      start_sheet_title: 'Mulai hitung',
      start_confirm: 'Mulai',
  ...
  transactions: {
    ...
    editor: {
      ...
      receipt: {
        ...
        replace: 'Ganti',
        save_to_photos: 'Simpan ke Foto',
        save_success: 'Struk disimpan ke Foto.',
        save_failed: 'Struk tidak dapat disimpan. Periksa akses foto lalu coba lagi.',
        crop: 'Crop',
  ...
  recurring: {
    ...
    due_tomorrow: 'Besok',
    week_strip_label: '7 hari ke depan',
    left_this_month: 'Sisa bulan ini',
    paused_section: 'Dijeda',
    overdue: 'Terlambat',
    show_all_days: 'Semua hari',
    day_due_count: '{{count}} jatuh tempo',
    day_nothing_due: 'Tidak ada yang jatuh tempo',
  },
  app_icon: {
    title: 'Ikon aplikasi',
  ...
  accounts: {
    ...
    loan: {
      ...
      paid_periods_error: 'Harus lebih sedikit dari tenor.',
      start_date_label: 'Tanggal mulai',
      start_date_info:
        'Kapan pinjaman diambil. Angsuran pertama jatuh sebulan kemudian, dan tanggalnya menjadi tanggal bayarmu.',
      collect_account_label: 'Debit dari',
      ...
      collect_account_external: 'Pembayaran ini diatur di Berulang. Ubah di sana.',
      ...
      balance_owed_label: 'Sisa utang',
      interest_rate_label: 'Suku bunga',
      autopay_rule_name: 'Angsuran {{name}}',
      payment_below_interest_short: 'Angsuran tidak menutup bunga',
      payoff_by_label: 'Lunas pada',
      first_instalment_label: 'Angsuran pertama',
      instalments_left_label: 'Sisa angsuran',
      projection_with_date_one: 'Lunas sekitar {{date}}, sisa {{count}} angsuran',
      projection_with_date_other: 'Lunas sekitar {{date}}, sisa {{count}} angsuran',
      projection_payments_only_one: 'Sisa {{count}} angsuran',
      ...
      next_due_chip: 'Jatuh tempo {{date}}',
      overdue_chip: 'Telat sejak {{date}}',
      make_payment: 'Bayar angsuran',
      payment_note: 'Pembayaran pinjaman',
      due_amount: 'Jumlah tagihan',
      archive_action: 'Arsipkan pinjaman',
      unarchive_action: 'Keluarkan dari arsip',
      archive_hint:
        'Menyembunyikannya dari daftar akun. Riwayat dan total tetap tersimpan, dan "Tampilkan arsip" mengembalikannya.',
      celebration_title: 'Pinjaman lunas',
      celebration_message: '{{name}} sudah lunas. Utang itu kini di belakangmu.',
      celebration_message_with_amount: '{{name}} sudah lunas, seluruh {{amount}}.',
      celebration_archive_cta: 'Arsipkan',
      celebration_keep_cta: 'Biarkan tampil',
    },
    ...
    show_archived_action: 'Tampilkan arsip ({{count}})',
    hide_archived_action: 'Sembunyikan arsip',
  ...
  pro: {
    ...
    trial_duration_day_many: '{{count}} hari',
    trial_duration_week_one: '{{count}} minggu',
    trial_duration_week_other: '{{count}} minggu',
    trial_duration_week_few: '{{count}} minggu',
    trial_duration_week_many: '{{count}} minggu',
    trial_duration_month_one: '{{count}} bulan',
    trial_duration_month_other: '{{count}} bulan',
    trial_duration_month_few: '{{count}} bulan',
    trial_duration_month_many: '{{count}} bulan',
    trial_duration_year_one: '{{count}} tahun',
    trial_duration_year_other: '{{count}} tahun',
    trial_duration_year_few: '{{count}} tahun',
    trial_duration_year_many: '{{count}} tahun',
    trial_free: 'Gratis {{duration}}',
    trial_cta: 'Mulai uji coba gratis',
    subscribe: 'Berlangganan',
    buy_lifetime: 'Beli Lifetime',
    maybe_later: 'Mungkin nanti',
    trial_terms: 'Gratis selama {{duration}}, lalu {{price}}.',
    ...
    limit_loans:
      'Paket gratis bisa melacak {{count}} pinjaman. Tingkatkan ke Pro untuk tanpa batas.',
    badge: 'PRO',
  ...
  review: {
    ...
    goals: 'Target',
    goal_of_target: '{{saved}} dari {{target}}',
    categories: 'Kategori',
    uncategorized: 'Tanpa kategori',
