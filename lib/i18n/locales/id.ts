const id = {
  ...
  accounts: {
    ...
    loan: {
      ...
      interest_rate_info:
        'Suku bunga efektif per tahun, yang dihitung dari sisa pokok. Kalau bank menyebut bunga flat, bunga efektifnya lebih tinggi, jadi tanyakan.',
      ...
      balance_owed_info:
        'Yang masih kamu tanggung hari ini. Perbaiki di sini kalau rekening koran bank berbeda.',
