const id = {
  ...
  accounts: {
    ...
    loan: {
      ...
      principal_hint: 'Menentukan progres pelunasan.',
      balance_owed_label: 'Sisa utang',
      balance_owed_hint: 'Yang masih kamu tanggung hari ini.',
      monthly_payment_label: 'Angsuran bulanan',
      payment_day_label: 'Tanggal bayar',
      interest_rate_label: 'Suku bunga (% per tahun)',
      interest_rate_hint: 'Opsional. Memperkirakan tanggal lunas; bunga tidak dicatat otomatis.',
      partly_paid_toggle: 'Saya sudah membayar sebagian',
      autopay_toggle: 'Bayar otomatis',
      autopay_hint: 'Membuat transfer bulanan pada tanggal bayarmu.',
      autopay_source_label: 'Bayar dari',
      autopay_source_placeholder: 'Pilih akun',
      autopay_no_source: 'Belum ada akun {{currency}} untuk membayar.',
      autopay_rule_name: 'Angsuran {{name}}',
      payment_below_interest_short: 'Angsuran tidak menutup bunga',
      payoff_by_label: 'Lunas pada',
      payments_left_label: 'Sisa angsuran',
      est_interest_label: 'Perkiraan bunga',
      ...
      archive_hint: 'Menyembunyikannya dari daftar akun. Riwayat dan total tetap tersimpan.',
