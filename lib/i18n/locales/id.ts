const id = {
  ...
  settings: {
    ...
    auto_log: {
      ...
      usage_unlimited: 'Tanpa batas',
      usage_exhausted: 'Jatah catat otomatis gratis habis. Upgrade ke Pro untuk tanpa batas.',
      setup_title: 'Penyiapan',
      automation_row: 'Catat otomatis Apple Pay',
