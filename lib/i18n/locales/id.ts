const id = {
  ...
  accounts: {
    ...
    loan: {
      ...
      principal_hint:
        'Jumlah pinjaman awal, dipakai untuk menunjukkan berapa yang sudah kamu lunasi.',
      balance_owed_label: 'Sisa utang',
      balance_owed_hint: 'Yang masih kamu tanggung hari ini. Angsuran akan menguranginya.',
      monthly_payment_label: 'Angsuran bulanan',
      payment_day_label: 'Tanggal bayar',
      interest_rate_label: 'Suku bunga (% per tahun)',
      interest_rate_hint:
        'Opsional, dipakai untuk memperkirakan tanggal lunas. Bunga tidak dicatat otomatis.',
      payment_below_interest_warning:
        'Angsuran ini lebih kecil daripada bunga bulanan, jadi utang akan bertambah, bukan berkurang.',
      ...
      projection_remaining: 'Sisa {{amount}}',
      projection_interest: 'Sekitar {{amount}} bunga masih harus dibayar',
      ...
      archive_hint:
        'Menyembunyikannya dari daftar akun. Riwayat dan total tetap tersimpan, dan bisa dikembalikan lewat pengaturan Akun.',
