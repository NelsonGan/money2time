const sv = {
  ...
  settings: {
    ...
    auto_log: {
      ...
      usage_unlimited: 'Obegränsat',
      usage_exhausted:
        'Dina gratis autoregistreringar är slut. Uppgradera till Pro för obegränsat.',
      setup_title: 'Konfiguration',
      automation_row: 'Apple Pay-autoregistrering',
      automation_row_hint: 'En automation per kort',
      backtap_row: 'Tryck på baksidan',
      backtap_row_hint: 'Tryck två gånger på baksidan av din iPhone',
      backtap_action_label: 'Tryck på baksidan öppnar',
      step_counter: '%{current} av %{total}',
      tutorial_step_1: 'Öppna Genvägar. Gå till fliken Automation.',
      tutorial_step_2: 'Tryck på + och välj Transaktion.',
      tutorial_step_3: 'Välj ditt kort. Välj Run Immediately och stäng av Notify When Run.',
      tutorial_step_4: 'Lägg till åtgärden "Log Transaction" från Money2Time.',
      tutorial_step_5: 'Ställ in Amount och Merchant på Shortcut Input-variablerna.',
      tutorial_step_6:
        'Välj kortets konto. Låt Category stå på Fråga varje gång för att välja när du betalar.',
      tutorial_step_7: 'Ignorera aviseringen så registreras den ändå, med din standardkategori.',
      backtap_step_1:
        'Skapa en genväg i Genvägar med en enda åtgärd: "Add Transaction" från Money2Time.',
      backtap_step_2: 'Öppna Inställningar > Tillgänglighet > Touch > Tryck på baksidan.',
      backtap_step_3: 'Välj Dubbeltryck eller Trippeltryck och välj sedan din genväg.',
      defaults_title: 'Standardval',
