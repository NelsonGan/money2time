const sv = {
  ...
  pro: {
    ...
    trial_spotlight_title: 'Prova allt innan du betalar',
    trial_spotlight_body: 'Lås upp alla Pro-funktioner i dag.',
    ...
    trial_cta: 'Starta min gratis provperiod på {{duration}}',
    trial_terms:
