const sv = {
  ...
  accounts: {
    ...
    loan: {
      ...
      principal_hint:
        'Det ursprungliga lånebeloppet. Används för att visa hur mycket du har betalat av.',
      balance_owed_label: 'Kvarvarande skuld',
      balance_owed_hint: 'Vad du fortfarande är skyldig i dag. Amorteringar minskar beloppet.',
      monthly_payment_label: 'Månadsbetalning',
      payment_day_label: 'Betalningsdag',
      interest_rate_label: 'Ränta (% per år)',
      interest_rate_hint:
        'Valfritt, används för att uppskatta ditt slutdatum. Räntor bokförs inte automatiskt.',
      payment_below_interest_warning:
        'Den här betalningen är mindre än månadsräntan, så skulden växer i stället för att minska.',
      ...
      projection_remaining: '{{amount}} kvar',
      projection_interest: 'Cirka {{amount}} i ränta kvar att betala',
      ...
      archive_hint:
        'Döljer det från dina konton. Historik och summor behålls, och du kan ta fram det igen under Kontoinställningar.',
