const sv = {
  ...
  transactions: {
    ...
    reimbursements: {
      ...
      recovered_label: 'Återbetalt',
      empty_title: 'Inget att begära',
      empty_subtitle:
        'Markera en utgift som ersättningsbar, så väntar den här tills du får pengarna.',
      empty_reimbursed_title: 'Inget avslutat än',
      empty_reimbursed_subtitle:
        'Krav du markerar som betalda hamnar här, om du skulle behöva ångra.',
      claims_one: '1 krav',
      claims_other: '{{count}} krav',
      unassigned_payer: 'Ej tilldelad',
      claim_button: 'Utlägg',
      claim_sheet_title: 'Begär ersättning för utgiften',
      claim_sheet_subtitle: 'Följ den tills någon betalar tillbaka.',
      payer_label: 'Betalas tillbaka av',
      payer_placeholder: 'Jobbet, en kund, ett försäkringsbolag',
      claim_amount_label: 'Begärt belopp',
      claim_all_label: 'Begär hela beloppet',
      claim_all_hint: 'Stäng av för att bara begära en del av utgiften.',
      save_claim: 'Spara krav',
      remove_claim: 'Ta bort krav',
      ...
      open_days_other: 'Öppen i {{count}} dagar',
    },
    settleUp: {
  ...
  pro: {
    ...
    limit_reimbursements:
      'Du kan ha upp till {{count}} öppna utläggskrav i gratisversionen. Avsluta ett eller uppgradera till Pro för obegränsat antal.',
    limit_goals:
  ...
  notifications: {
    ...
    content: {
      ...
      weekly_body: 'Se vart dina pengar och din tid tog vägen den här veckan.',
      weekly_body_spend:
        'Du spenderade {{amount}} de senaste 7 dagarna. Tryck för att se vart de tog vägen.',
      weekly_body_spend_hours:
        'Du spenderade {{amount}} de senaste 7 dagarna, det motsvarar {{hours}} av ditt arbete. Tryck för att se vart de tog vägen.',
    },
  },
  auto_backup: {
