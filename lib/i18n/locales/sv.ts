const sv = {
  ...
  add_action: {
    ...
    scan_split_title: 'Dela ett kvitto',
    scan_split_subtitle: 'Skanna varor och dela med vänner',
  ...
  transactions: {
    ...
    editor: {
      ...
      split: {
        ...
        add_person: 'Lägg till post/person',
        me_label: 'Jag',
  ...
  settings: {
    ...
    quick_entry: {
      ...
      add_button: {
        ...
        action_scan_split: 'Skanna ett kvitto för att dela',
        action_none: 'Inget',
      },
    },
