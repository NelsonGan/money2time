const sv = {
  ...
  pro: {
    ...
    hero_subtitle:
      'Bli obegränsad och lås upp alla Pro-verktyg, från kvittoskanning till långsiktiga trender.',
    social_rating_value: '4.9',
    social_rating_label: 'App Store-betyg',
    social_downloads_value: '20k+',
    social_downloads_label: 'Nedladdningar',
    testimonial_quote:
      'Money2Time förändrade helt hur jag ser på mina utgifter. Att omvandla priser till timmar av mitt liv är det enda som någonsin fått mig att sluta slösa pengar.',
    testimonial_author: 'Alex R.',
    testimonial_meta: 'Pro-medlem',
    showcase_title: 'Allt du låser upp',
    showcase_subtitle: 'En snabb rundtur i vad Pro tillför din dag.',
    feature_receipt_title: 'Skanna och dela vilket kvitto som helst',
    feature_receipt_desc:
      'Ta ett foto, så specificerar vi det, och sedan delar du det med vänner på några sekunder.',
    feature_trends_title: 'Se långsiktiga trender',
    feature_trends_desc: 'Följ utgifter, inkomst, humör, förmögenhet och din timlön över tid.',
    feature_albums_title: 'Gruppera resor i album',
    feature_albums_desc: 'Samla en resa i ett album med omslagsbild, karta och utgiftsöversikt.',
    feature_currency_title: 'Följ varje valuta',
    feature_currency_desc:
      'Registrera utgifter i vilken valuta som helst, med växelkursen fryst i det ögonblick du betalade.',
    feature_budgets_title: 'Planera månadsbudgetar',
    feature_budgets_desc:
      'Ställ in kategoribudgetar från återanvändbara mallar och se dem tömmas i realtid.',
    feature_widgets_title: 'Widgetar, röst och mer',
    feature_widgets_desc:
      'Åtta widgetar för hemskärmen, röstinmatning, App-lås och obegränsat allt.',
