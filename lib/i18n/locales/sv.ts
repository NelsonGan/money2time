const sv = {
  ...
  accounts: {
    ...
    loan: {
      principal_label: 'Lånat belopp',
      principal_hint: 'Anger din avbetalningsstatus.',
      balance_owed_label: 'Kvarvarande skuld',
      balance_owed_hint: 'Vad du fortfarande är skyldig i dag.',
      monthly_payment_label: 'Månadsbetalning',
      payment_day_label: 'Betalningsdag',
      interest_rate_label: 'Ränta (% per år)',
      interest_rate_hint: 'Valfritt. Uppskattar ditt slutdatum; räntor bokförs inte automatiskt.',
      partly_paid_toggle: 'Jag har redan betalat av en del',
      autopay_toggle: 'Betala automatiskt',
      autopay_hint: 'Skapar en månatlig överföring på din betalningsdag.',
      autopay_source_label: 'Betala från',
      autopay_source_placeholder: 'Välj ett konto',
      autopay_no_source: 'Inget {{currency}}-konto att betala från ännu.',
      autopay_rule_name: 'Betalning {{name}}',
      payment_below_interest_short: 'Betalningen täcker inte räntan',
      payoff_by_label: 'Slutbetalt',
      payments_left_label: 'Betalningar kvar',
      est_interest_label: 'Uppsk. ränta',
      ...
      archive_hint: 'Döljer det från dina konton. Historik och summor behålls.',
