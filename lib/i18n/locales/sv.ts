const sv = {
  ...
  review: {
    ...
    spent_label: {
      week: 'Spenderat den veckan',
      month: 'Spenderat den månaden',
      year: 'Spenderat det året',
    },
    previous_period: {
      week: 'veckan innan',
      month: 'månaden innan',
    ...
    delta_note_up: 'tyngre än {{previous}}',
    delta_note_down: 'lättare än {{previous}}',
    delta_note_flat: 'i linje med {{previous}}',
    ...
    trend_title: {
      week: 'Dag för dag',
      month: 'Vecka för vecka',
      year: 'Månad för månad',
    },
    trend_average: 'snitt {{amount}}',
    pace_label: 'Takt',
    pace_budget_label: 'Budget',
    pace_budget_title: 'Mot din budget',
    pace_title: {
      week: 'mot din vanliga vecka',
      month: 'mot din vanliga månad',
      year: 'mot ditt vanliga år',
    },
    pace_of_budget: '{{spent}} av {{target}}',
    pace_average: {
      week: 'Snitt för dina senaste {{count}} veckor: {{amount}}',
      month: 'Snitt för dina senaste {{count}} månader: {{amount}}',
      year: 'Snitt för dina senaste {{count}} år: {{amount}}',
    },
    pace_left: '{{amount}} kvar',
    pace_over: '{{amount}} över',
    categories_title: {
      week: 'Största kategorierna den veckan',
      month: 'Största kategorierna den månaden',
      year: 'Största kategorierna det året',
    },
    uncategorized: 'Okategoriserat',
    other_entries: '{{count}} till',
    mood_title: {
      week: 'Hur veckan kändes',
      month: 'Hur månaden kändes',
      year: 'Hur året kändes',
    },
    mood_happy: 'Kändes bra',
    mood_neutral: 'Varken eller',
    mood_regret: 'Önskar du låtit bli',
    standouts_title: {
      week: 'Utmärkande den veckan',
      month: 'Utmärkande den månaden',
      year: 'Utmärkande det året',
    },
    biggest_expense: 'Största utgiften',
    busiest_day: 'Mest aktiva dagen',
    entries_count: '{{count}} poster',
    quiet_days: 'Lugna dagar',
    quiet_days_sub: 'Inget registrerat',
    of_total: '{{count}} av {{total}}',
    entries_logged: 'Registrerade poster',
    entries_logged_sub: {
      week: 'Under hela veckan',
      month: 'Under hela månaden',
      year: 'Under hela året',
    },
  },
  budget: {
    title: 'Budget',
