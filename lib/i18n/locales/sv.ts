const sv = {
  ...
  add_action: {
    ...
    manual_title: 'Manuell inmatning',
    manual_subtitle: 'Skriv in det själv',
  },
  receiptScan: {
    reading: 'Läser kvitto…',
    source_title: 'Skanna kvitto',
    source_camera: 'Ta foto',
    source_library: 'Välj från bibliotek',
    review_title: 'Granska {{count}} transaktioner',
    save_all: 'Spara alla ({{count}})',
    remove: 'Ta bort',
    all_removed: 'Inga transaktioner kvar att spara.',
    note_placeholder: 'Anteckning',
    empty_title: 'Inga transaktioner hittades',
    empty_body: 'Vi kunde inte läsa några transaktioner från det kvittot. Prova ett annat foto.',
    busy_title: 'Skannern upptagen',
    busy_body: 'Skannern är upptagen just nu. Försök igen om en stund.',
  ...
  settings: {
    ...
    quick_entry: {
      ...
      add_button: {
        ...
        tap_label: 'Vid tryck',
        hold_label: 'Vid håll',
        action_manual: 'Manuell inmatning',
  ...
  pro: {
    limit_receipt_scans:
      'Gratisplanen inkluderar {{count}} kvittoskanningar per månad. Uppgradera till Pro för obegränsad skanning.',
