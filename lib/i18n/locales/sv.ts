const sv = {
  ...
  add_action: {
    ...
    over_account_limit_message:
      'Du har {{active}} aktiva konton. För att lägga till transaktioner gratis behöver du högst {{count}} aktiva konton. Ta bort de extra, eller prenumerera på Pro. Andra åtgärder är fortfarande tillgängliga.',
  ...
  widgets: {
    ...
    live: {
      ...
      start: 'Starta manuellt',
      start_sheet_title: 'Starta klockan',
      start_confirm: 'Starta',
      stop: 'Stoppa klockan',
  ...
  transactions: {
    ...
    settleUp: {
      ...
      history_empty_title: 'Inga återbetalningar än',
      history_empty_subtitle: 'Notor som vänner och familj betalar tillbaka visas här.',
    ...
    editor: {
      ...
      receipt: {
        ...
        replace: 'Ersätt',
        save_to_photos: 'Spara i Bilder',
        save_success: 'Kvittot har sparats i Bilder.',
        save_failed: 'Kvittot kunde inte sparas. Kontrollera bildåtkomsten och försök igen.',
        crop: 'Crop',
  ...
  pro: {
    ...
    trial_duration_day_many: '{{count}} dagar',
    trial_duration_week_one: '{{count}} vecka',
    trial_duration_week_other: '{{count}} veckor',
    trial_duration_week_few: '{{count}} veckor',
    trial_duration_week_many: '{{count}} veckor',
    trial_duration_month_one: '{{count}} månad',
    trial_duration_month_other: '{{count}} månader',
    trial_duration_month_few: '{{count}} månader',
    trial_duration_month_many: '{{count}} månader',
    ...
    trial_cta: 'Starta gratis provperiod',
    subscribe: 'Prenumerera',
    buy_lifetime: 'Köp livstidsåtkomst',
    maybe_later: 'Kanske senare',
    trial_terms: 'Gratis i {{duration}}, därefter {{price}}.',
