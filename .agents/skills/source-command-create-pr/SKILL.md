...
description: "Create a pull request for the current changes, including branching, committing, and pushing as needed. Use when the user asks to create or open a PR."
---
