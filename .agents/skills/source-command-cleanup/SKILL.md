...
description: "Review and fix dead code, bugs, and convention violations in changed files before merging. Use when asked to run cleanup or a pre-merge cleanup pass."
---
