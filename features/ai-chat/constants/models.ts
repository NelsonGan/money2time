...
export const AVAILABLE_MODELS: ModelDefinition[] = [
  ...
  {
    id: 'lfm2.5-1.2b-official-q4km',
    displayName: 'LFM2.5 1.2B (Official)',
    fileName: 'LFM2.5-1.2B-Instruct-Q4_K_M.gguf',
    downloadUrl:
  ...
  {
    id: 'lfm2.5-350m-official-q4km',
    displayName: 'LFM2.5 350M (Official)',
  ...
  },
  {
    ...
    fileName: 'LFM2.5-350M.Q4_K_M.gguf',
    downloadUrl:
      'https://huggingface.co/NelsonGan/lfm2.5-finance-tracker-gguf/resolve/main/LFM2.5-350M.Q4_K_M.gguf',
    sizeLabel: '~222 MB',
  },
  {
