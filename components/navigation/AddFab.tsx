      ...
      >
        <Animated.View style={animatedStyle}>
          <Pressable
            ...
            // a solid circle underneath flattens it back into a plain icon.
            style={{
              width: FAB_SIZE,
              height: FAB_SIZE,
              alignItems: 'center',
          ...
          >
            {/* No shadow style here: iOS draws a view shadow from the layer's
                square bounds, not from the image's alpha, so a transparent PNG
                gets a grey rectangle behind it. The clay art already carries its
                own highlight and drop shadow. */}
