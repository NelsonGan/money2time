  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        'glow-xl': '0 12px 48px rgba(31,138,111,0.25)',
        warm: '0 4px 16px rgba(246,183,80,0.12)',
        'warm-lg': '0 8px 32px rgba(246,183,80,0.18)',
        float: '0 12px 40px rgba(0,0,0,0.08)',
        'float-lg': '0 20px 60px rgba(0,0,0,0.12)',
        'inner-glow': 'inset 0 1px 2px rgba(255,255,255,0.1)',
        'nav-float': '0 -4px 32px rgba(0,0,0,0.08), 0 -1px 8px rgba(0,0,0,0.04)',
      },
    },
  },
  plugins: [],
