...
export async function scanReceiptItems(
  ...
  const response = body as ReceiptScanItemsResponse;
...
/** Shared request pipeline for both scan modes: read the stored image, POST it
 *  with a timeout, and map failures onto ReceiptScanError codes. */
